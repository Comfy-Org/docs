...
- Access with `https` addresses. If you've deployed ComfyUI on a Linux server, you might need to bind a service domain name to the corresponding server and apply for an SSL certificate to ensure secure requests.
