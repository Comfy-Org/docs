...
<Tabs>
  ...
  <Tab title="For desktop users">
    The desktop is using auto-update, and it's always the latest version. So, if you find that any core node is missing, please wait for the next stable release.
  </Tab>
</Tabs>
</Tip>
