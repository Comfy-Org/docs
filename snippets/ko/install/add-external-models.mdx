...
<Tabs>
  ...
  [Comfy 데스크톱](/ko/installation/desktop/windows) 애플리케이션을 사용하는 경우, 데스크톱 앱 상단의 캡슐 메뉴를 클릭하고 **Storage** 탭을 열어 모델 디렉터리를 추가하세요. 캡슐 메뉴는 데스크톱 앱에만 있으며 브라우저에서 실행하는 ComfyUI에는 없습니다
