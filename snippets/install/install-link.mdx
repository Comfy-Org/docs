<AccordionGroup>
  <Accordion title="ComfyUI Desktop">
    ...
    ## Test Link Error Examples (Temporary)
    Here are some test link error examples:
    - [Chinese link in English snippet](/zh-CN/installation/desktop/windows)
    - [Another Chinese link](/zh-CN/troubleshooting/overview)
    - ![Chinese image in English snippet](/images/zh/desktop/extra_model_paths.jpg)
    - <a href="/zh-CN/tutorials/basic/text-to-image">HTML link to Chinese content</a>
    <Tabs>
      <Tab title="Windows">
