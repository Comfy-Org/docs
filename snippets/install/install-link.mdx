<AccordionGroup>
  <Accordion title="ComfyUI Desktop">
    ...
    <Tabs>
      <Tab title="Windows">
        ...
        Suitable for **Windows** with **Nvidia** GPU or **AMD** GPU (experimental, RDNA 3/3.5/4)
        </Card>
      </Tab>
  ...
  <Accordion title="ComfyUI Portable (Windows)">
    ...
    Supports **Windows** ComfyUI version running on **Nvidia GPUs**, **AMD GPUs** (experimental), or **CPU-only**, always use the latest commits and completely portable.
    </Card>
  </Accordion>
