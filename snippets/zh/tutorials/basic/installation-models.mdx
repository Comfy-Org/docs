...
请确保你已经在 `ComfyUI/models/checkpoints` 文件夹中至少有一个 SD1.5 的模型文件。如果你还不了解如何安装模型，请参考[开始 ComfyUI 的 AI 绘图之旅](/zh/get_started/first_generation#3-安装绘图模型)章节中关于模型安装的部分说明。
