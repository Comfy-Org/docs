<AccordionGroup>
  <Accordion title="ComfyUI 桌面版">
    ...
    ## 测试链接错误示例（临时）
    这里是一些测试链接错误的示例：
    - [English link in Chinese snippet](/installation/desktop/windows)
    - [Another English link](/troubleshooting/overview)
    - ![English image in Chinese snippet](/images/desktop/win-comfyui-desktop-1.jpg)
    <Tabs>
      <Tab title="Windows">
