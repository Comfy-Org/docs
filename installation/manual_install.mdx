...
<AccordionGroup>
  <Accordion title="GGUF format models are not supported">
  ...
  <Accordion title="Why can't I find my models?">
    If you can't find your models after installation, try these solutions:
    - Press the `r` key to refresh node definitions so ComfyUI can detect the models
    - Restart ComfyUI
