...
<Steps>
  ...
  Recommendations:
  - Please select a **solid-state drive** as the installation location, which will greatly benefit the software's operation and model reading in the future
...
- Or consider using [ComfyUI Portable](/get_started/comfyui_portable_windows) to use ComfyUI
