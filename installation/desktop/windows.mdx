...
![Uninstall Comfy Desktop on Windows](/images/desktop/installation/windows_2_uninstall.png)
...
2. **Delete individual installations** from within the app, or manually delete `%LOCALAPPDATA%\Comfy-Desktop\ComfyUI-Installs` (or `%USERPROFILE%\ComfyUI-Installs` if that is where they were created)
