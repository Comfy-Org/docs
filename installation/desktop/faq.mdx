...
This stops the ComfyUI Python process but leaves the desktop app window open so you can relaunch anytime. To fully quit the desktop app, close the window or right-click the system tray icon and select **Quit**.
