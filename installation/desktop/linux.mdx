...
description: "Install Comfy Desktop on Linux from the official .deb or AppImage packages, or build from source. Requires Ubuntu 22.04+, x64, and Node.js v22 LTS."
icon: "linux"
sidebarTitle: "Linux"
---
