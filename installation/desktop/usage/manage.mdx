...
You can export a snapshot as a file to share with others by right-clicking the installation card and selecting **Share**. This saves the latest snapshot as a `.json` file that can be imported by another Comfy Desktop user.
