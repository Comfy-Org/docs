...
| **Tracked** | 📁 | An existing ComfyUI installation (Git clone or portable) tracked by Comfy Desktop. You manage updates manually. See [Tracking an Existing Installation](#tracking-an-existing-installation). |
