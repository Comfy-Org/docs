...
Click **New Install** on the Dashboard, then select **Add Existing Install** from the installation options. This opens a dialog where you can point Comfy Desktop to an existing ComfyUI folder.

![Add Existing Install](/images/desktop/usage/track_instance_01.png)

### Detecting Your Installation

1. Click **Browse** to select a ComfyUI directory.
2. Comfy Desktop probes the folder and automatically detects the installation type.
