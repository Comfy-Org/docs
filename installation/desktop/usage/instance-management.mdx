...
Click **New Install** on the Chooser, then select **Track Existing Install** at the bottom of the installation options. Comfy Desktop will detect the installation type and configure it automatically.

### Detecting Your Installation

![Track an existing installation](/images/desktop/usage/track_instance_01.png)

1. Click **Browse** to select the ComfyUI directory.
2. Comfy Desktop probes the directory and detects the installation type.
...
The key difference between a **Tracked** installation and a **Standalone** installation is how updates are managed:
