...
Each numbered action is explained in detail below. Click a link to jump to the relevant section:

- **① New Install** → [Creating a New Instance](#creating-a-new-instance)
- **③ Manage** → [Manage](/installation/desktop/usage/manage)
- **④ Restore Snapshot** → [Snapshots](/installation/desktop/usage/snapshots)
- **⑥ Copy Installation** → [Copying an Installation](#copying-an-installation)
- **⑦ Forget / ⑧ Uninstall** → [Uninstalling an Instance](#uninstalling-an-instance)
