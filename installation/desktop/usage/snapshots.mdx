...
This creates a brand new standalone instance — the original instance is untouched. You'll see it appear in the Chooser view alongside your other instances.
