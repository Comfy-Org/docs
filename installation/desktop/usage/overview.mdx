...
- **Account chip** (top-right): sign in with your Comfy account to browse the ComfyUI Builds in your workspace. Once signed in, the chip becomes a workspace switcher.
- **Workspace Builds**: when signed in, ComfyUI Builds published to your workspace appear in the grid. Click a tile to install and launch it.
