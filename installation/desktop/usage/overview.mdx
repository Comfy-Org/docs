...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/installation/desktop">
    Learn how to download and install Comfy Desktop on your platform.
  </Card>
  <Card title="Usage Guide" icon="book-open" href="/installation/desktop/usage/overview">
    Explore how to manage instances, configure settings, and migrate from legacy.
  </Card>
</CardGroup>
