...
<Tab title="Portable">
 ...
 └─ 📂update
    ...
    └── update_comfyui_and_python_dependencies.bat   // ⚠️ Reinstalls all dependencies - backup before use
```
<Warning>Ensure a stable internet connection during updates.</Warning>

<Warning>
**Before running `update_comfyui_and_python_dependencies.bat`**: This script will reinstall all Python dependencies, which may cause conflicts with your existing setup. **Back up your installation** before running this script to avoid potential issues.
</Warning>
</Tab>
<Tab title="Desktop">
