...
description: "This article introduces some system requirements for ComfyUI, including hardware and software requirements"
sidebarTitle: "System Requirements"
---

import InstallLink from "/snippets/install/install-link.mdx"

In this article, we will introduce the system requirements for installing ComfyUI. Due to frequent updates of ComfyUI, this document may not be updated in a timely manner. Please refer to the relevant instructions in [ComfyUI](https://github.com/comfyanonymous/ComfyUI).

Regardless of which version of ComfyUI you use, it runs in a separate Python environment.

You can refer to the following sections to learn about the installation methods for different systems and versions of ComfyUI.
...
- Older torch 2.6 Windows package:
  [Click here to download the standalone ComfyUI package with cuda 12.8 torch build](https://github.com/comfyanonymous/ComfyUI/releases/download/latest/ComfyUI_cu128_50XX.7z)

**Notes:**
- When using it, please do not update it, as this might uninstall cu128 and install an incompatible version.
- Some custom nodes may not work properly because they might be incompatible with CUDA 12.8 or require specific dependencies.
