...
<Note>
PyTorch 2.7 and above is supported. Using a cu130 or above version of PyTorch is required on NVIDIA 20 series and above. Some features and optimizations might only work on newer versions. We generally recommend using the latest major version of PyTorch with the latest CUDA version unless it is less than 2 weeks old.
