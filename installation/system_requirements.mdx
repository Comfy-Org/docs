...
- **AMD GPU (Windows)** - ROCm 10.0 via AMD multi-architecture PyTorch packages. Supports RDNA 2, RDNA 3, RDNA 3.5, and RDNA 4; no separate HIP SDK installation needed
