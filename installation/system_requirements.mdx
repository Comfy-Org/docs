...
<Note>
**Docker:** ComfyUI does not currently provide an official Docker image. Community-maintained Docker images are available (e.g., [ai-dock/comfyui](https://github.com/ai-dock/comfyui)), but they are not officially supported by the ComfyUI team.
</Note>
