...
- [Kling 3.0 Turbo](/development/comfy-router/models/kling/kling-3-0-turbo/code): `kling/kling-3.0-turbo`, served as `higgsfield/higgsfield-kling-3-turbo` with `?model_provider=higgsfield`
- [Kling V3](/development/comfy-router/models/kling/kling-v3/code): `kling/kling-v3`, served as `higgsfield/higgsfield-kling-3-std` with `?model_provider=higgsfield`
- [Wan 3.0 Video](/development/comfy-router/models/wan/wan3-0-video/code): `wan/wan3.0-video`, served as `higgsfield/higgsfield-wan-3` with `?model_provider=higgsfield`

## Runware

- [Nano Banana 2](/development/comfy-router/models/google/nano-banana-2/code): `vertexai/gemini-3.1-flash-image`, served as `runware/runware-nano-banana-2` with `?model_provider=runware`
- [Nano Banana Pro](/development/comfy-router/models/google/nano-banana-pro/code): `vertexai/gemini-3-pro-image`, served as `runware/runware-nano-banana-pro` with `?model_provider=runware`
- [GPT Image 2](/development/comfy-router/models/openai/gpt-image-2/code): `openai/gpt-image-2`, served as `runware/runware-gpt-image-2` with `?model_provider=runware`
