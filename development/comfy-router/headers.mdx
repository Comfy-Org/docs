...
<ParamField header="Content-Type" type="string">
  `application/json`. Send the model's native JSON input. Fields and validation requirements vary by model; see [How to call a model](/development/comfy-router/api).
</ParamField>
