...
description: "Python, TypeScript, Swift and cURL snippets for calling wan/wan3.0-video-prime over HTTP through Comfy Router, plus the request fields and the result shape"
