...
description: "Python, TypeScript, Swift and cURL snippets for calling wan/happyhorse-1.0-t2v over HTTP through Comfy Router, plus the request fields and the result shape"
...
Generated from the schema Router serves at `GET /v2/models/wan/happyhorse-1.0-t2v/openapi.json`, the same document it validates a call against before the request reaches the provider.
