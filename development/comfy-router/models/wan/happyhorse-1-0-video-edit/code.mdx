...
description: "Python, TypeScript, Swift and cURL snippets for calling wan/happyhorse-1.0-video-edit through Comfy Router, plus request fields and result shape"
...
Generated from the schema Router serves at `GET /v2/models/wan/happyhorse-1.0-video-edit/openapi.json`, the same document it validates a call against before the request reaches the provider.
