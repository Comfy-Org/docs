---
title: "Use FLUX Pro 1.0 Fill with Comfy Router"
description: "Call bfl/flux-pro-1.0-fill through Comfy Router: endpoint, request shape and the response Router returns."
...
curl --max-time 660 https://api.comfy.org/v2/models/bfl/flux-pro-1.0-fill \
...
Generated from the schema Router serves at `GET /v2/models/bfl/flux-pro-1.0-fill/openapi.json`, the same document it validates a call against before the request reaches the provider.
