...
description: "Python, TypeScript, Swift and cURL snippets for calling FLUX.1 Kontext Pro and Kontext Max through Comfy Router, plus request fields and result shape"
