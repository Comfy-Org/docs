...
description: "Python, TypeScript, Swift and cURL snippets for generating video with audio from FLUX 3 through Comfy Router, plus request fields and result shape"
