...
curl --max-time 660 https://api.comfy.org/v2/models/bfl/erase-v1 \
...
Generated from the schema Router serves at `GET /v2/models/bfl/erase-v1/openapi.json`, the same document it validates a call against before the request reaches the provider.
