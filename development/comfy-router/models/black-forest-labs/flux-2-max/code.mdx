---
title: "Use FLUX 2 Max with Comfy Router"
description: "Call bfl/flux-2-max through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/bfl/flux-2-max`
...
curl --max-time 660 https://api.comfy.org/v2/models/bfl/flux-2-max \
...
Generated from the schema Router serves at `GET /v2/models/bfl/flux-2-max/openapi.json`, the same document it validates a call against before the request reaches the provider.
