---
title: "Use Recraft V4 Styles Vector with Comfy Router"
description: "Call recraft/recraftv4_styles_vector through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/recraft/recraftv4_styles_vector`
