---
title: "Use Recraft V4.1 Utility Vector with Comfy Router"
description: "Call recraft/recraftv4_1_utility_vector through Comfy Router: endpoint, request shape and the response Router returns."
