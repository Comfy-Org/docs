---
title: "Use Recraft V4 Styles with Comfy Router"
description: "Call recraft/recraftv4_styles through Comfy Router: endpoint, request shape and the response Router returns."
