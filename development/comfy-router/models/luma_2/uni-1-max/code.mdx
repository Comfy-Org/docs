...
curl --max-time 660 https://api.comfy.org/v2/models/luma_2/uni-1-max \
...
This provider example names `uni-1`, not `luma_2/uni-1-max`. Use it only for the response shape.
