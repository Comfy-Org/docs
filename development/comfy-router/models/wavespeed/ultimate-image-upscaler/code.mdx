...
Use `wavespeed/ultimate-image-upscaler` with the Comfy Router API. WaveSpeed provides the model; Router gives it the shared authentication and request route below.
...
curl --max-time 660 https://api.comfy.org/v2/models/wavespeed/ultimate-image-upscaler \
