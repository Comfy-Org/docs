...
<ParamField body="model" type="string">
  Model to be used. Supported: grok-imagine-video (default), grok-imagine-video-1.5-preview, grok-imagine-video-1.5. The deprecated grok-imagine-video-beta id is aliased to grok-imagine-video.
</ParamField>
...
Generated from the schema Router serves at `GET /v2/models/xai/grok-imagine-video-1.5/openapi.json`, the same document it validates a call against before the request reaches the provider.
