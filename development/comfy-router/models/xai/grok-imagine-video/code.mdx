---
title: "Use Grok Imagine Video with Comfy Router"
description: "Call xai/grok-imagine-video through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/xai/grok-imagine-video`
...
Generated from the schema Router serves at `GET /v2/models/xai/grok-imagine-video/openapi.json`, the same document it validates a call against before the request reaches the provider.
