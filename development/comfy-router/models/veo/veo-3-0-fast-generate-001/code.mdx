...
curl --max-time 660 https://api.comfy.org/v2/models/veo/veo-3.0-fast-generate-001 \
...
<ParamField body="instances[].image" type="any">
...
<ParamField body="instances[].lastFrame" type="any">
...
<ParamField body="instances[].mask" type="any">
...
<ParamField body="instances[].referenceImages[].image" type="any" required>
...
<ParamField body="instances[].video" type="any">
