---
title: "Use Veo 3.0 Generate 001 with Comfy Router"
description: "Call veo/veo-3.0-generate-001 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/veo/veo-3.0-generate-001`
...
curl --max-time 660 https://api.comfy.org/v2/models/veo/veo-3.0-generate-001 \
...
Generated from the schema Router serves at `GET /v2/models/veo/veo-3.0-generate-001/openapi.json`, the same document it validates a call against before the request reaches the provider.
