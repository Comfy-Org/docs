---
title: "Use Veo 3.1 Generate 001 with Comfy Router"
description: "Call veo/veo-3.1-generate-001 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/veo/veo-3.1-generate-001`
...
curl --max-time 660 https://api.comfy.org/v2/models/veo/veo-3.1-generate-001 \
