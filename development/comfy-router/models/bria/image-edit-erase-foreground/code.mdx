---
title: "Use Image Edit Erase Foreground with Comfy Router"
description: "Call bria/image-edit-erase-foreground through Comfy Router: endpoint, request shape and the response Router returns."
sidebarTitle: "Image Edit Erase Foreground"
---

{/* GENERATED FILE. Generated from router-schemas/bria/image-edit-erase-foreground.json by `pnpm code-pages:gen`. */}

import RouterCodeFooter from "/snippets/comfy-router/model-code-footer.mdx";

API Reference for `bria/image-edit-erase-foreground`, served by Comfy Router from Bria.
...
**Model ID:** `bria/image-edit-erase-foreground`

**Endpoint:** `POST https://api.comfy.org/v2/models/bria/image-edit-erase-foreground`
...
Generated from the schema Router serves at `GET /v2/models/bria/image-edit-erase-foreground/openapi.json`, the same document it validates a call against before the request reaches the provider.
