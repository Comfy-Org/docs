---
title: "Use Fal Seedance 2.5 with Comfy Router"
description: "Call fal/fal-seedance-2.5 through Comfy Router: endpoint, request shape and the response Router returns."
sidebarTitle: "Fal Seedance 2.5"
---

{/* GENERATED FILE. Generated from router-schemas/fal/fal-seedance-2.5.json by `pnpm code-pages:gen`. */}
