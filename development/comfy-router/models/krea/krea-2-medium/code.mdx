---
title: "Use Krea 2 Medium with Comfy Router"
description: "Call krea/krea-2-medium through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/krea/krea-2-medium`
...
curl --max-time 660 https://api.comfy.org/v2/models/krea/krea-2-medium \
...
Generated from the schema Router serves at `GET /v2/models/krea/krea-2-medium/openapi.json`, the same document it validates a call against before the request reaches the provider.
