...
description: "Python, TypeScript, Swift and cURL snippets for Nano Banana 2 (Gemini 3.1 Flash Image) image generation through Comfy Router, plus request fields"
...
- **Comfy** (default): `POST https://api.comfy.org/v2/models/vertexai/gemini-3.1-flash-image`
- **fal**, as `fal/fal-nano-banana-2`: `POST https://api.comfy.org/v2/models/vertexai/gemini-3.1-flash-image?model_provider=fal`
- **Runware**, as `runware/runware-nano-banana-2`: `POST https://api.comfy.org/v2/models/vertexai/gemini-3.1-flash-image?model_provider=runware`
- **WaveSpeed**, as `wavespeed/wavespeed-nano-banana-2`: `POST https://api.comfy.org/v2/models/vertexai/gemini-3.1-flash-image?model_provider=wavespeed`
...
Generated from the schema Router serves at `GET /v2/models/vertexai/gemini-3.1-flash-image/openapi.json`, the same document it validates a call against before the request reaches the provider.
