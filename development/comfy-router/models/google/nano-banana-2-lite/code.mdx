...
description: "Python, TypeScript and cURL snippets for Nano Banana 2 Lite (Gemini 3.1 Flash-Lite Image) image generation through Comfy Router, plus request fields"
