...
description: "Python, TypeScript, Swift and cURL snippets for Nano Banana 2 Lite (Gemini 3.1 Flash-Lite Image) image generation through Comfy Router, plus request fields"
...
Generated from the schema Router serves at `GET /v2/models/vertexai/gemini-3.1-flash-lite-image/openapi.json`, the same document it validates a call against before the request reaches the provider.
