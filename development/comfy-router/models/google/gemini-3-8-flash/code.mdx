---
title: "Use Gemini 3.8 Flash with Comfy Router"
description: "Call vertexai/gemini-3.8-flash through Comfy Router: endpoint, request shape and the response Router returns."
...
Use `vertexai/gemini-3.8-flash` with the Comfy Router API. Google provides the model; Router gives it the shared authentication and request route below.
...
curl --max-time 660 https://api.comfy.org/v2/models/vertexai/gemini-3.8-flash \
