...
Use `vertexai/imagen-3.0-generate-001` with the Comfy Router API. Google provides the model; Router gives it the shared authentication and request route below.
...
curl --max-time 660 https://api.comfy.org/v2/models/vertexai/imagen-3.0-generate-001 \
