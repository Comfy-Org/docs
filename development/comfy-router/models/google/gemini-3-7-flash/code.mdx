---
title: "Use Gemini 3.7 Flash with Comfy Router"
description: "Call vertexai/gemini-3.7-flash through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/vertexai/gemini-3.7-flash`
...
curl --max-time 660 https://api.comfy.org/v2/models/vertexai/gemini-3.7-flash \
...
Generated from the schema Router serves at `GET /v2/models/vertexai/gemini-3.7-flash/openapi.json`, the same document it validates a call against before the request reaches the provider.
