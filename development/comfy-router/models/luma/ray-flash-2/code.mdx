...
curl --max-time 660 https://api.comfy.org/v2/models/luma/ray-flash-2 \
...
This provider example names `ray-2`, not `luma/ray-flash-2`. Use it only for the response shape.
