...
curl --max-time 660 https://api.comfy.org/v2/models/luma/photon-flash-1 \
...
This provider example names `photon-1`, not `luma/photon-flash-1`. Use it only for the response shape.
