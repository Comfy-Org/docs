...
Use `moonvalley/text-to-image` with the Comfy Router API. Moonvalley provides the model; Router gives it the shared authentication and request route below.
...
curl --max-time 660 https://api.comfy.org/v2/models/moonvalley/text-to-image \
