---
title: "Use GPT 5.5 Pro with Comfy Router"
description: "Call openai/gpt-5.5-pro through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/openai/gpt-5.5-pro`
...
Generated from the schema Router serves at `GET /v2/models/openai/gpt-5.5-pro/openapi.json`, the same document it validates a call against before the request reaches the provider.
