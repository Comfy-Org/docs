...
curl --max-time 660 https://api.comfy.org/v2/models/openai/gpt-5-mini \
...
Generated from the schema Router serves at `GET /v2/models/openai/gpt-5-mini/openapi.json`, the same document it validates a call against before the request reaches the provider.
