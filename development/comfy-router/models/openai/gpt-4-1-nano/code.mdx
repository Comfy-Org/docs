---
title: "Use GPT 4.1 Nano with Comfy Router"
description: "Call openai/gpt-4.1-nano through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/openai/gpt-4.1-nano`
...
curl --max-time 660 https://api.comfy.org/v2/models/openai/gpt-4.1-nano \
...
Generated from the schema Router serves at `GET /v2/models/openai/gpt-4.1-nano/openapi.json`, the same document it validates a call against before the request reaches the provider.
