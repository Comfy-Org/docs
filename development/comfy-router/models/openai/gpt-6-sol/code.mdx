---
title: "Use GPT 6 Sol with Comfy Router"
description: "Call openai/gpt-6-sol through Comfy Router: endpoint, request shape and the response Router returns."
sidebarTitle: "GPT 6 Sol"
---

{/* GENERATED FILE. Generated from router-schemas/openai/gpt-6-sol.json by `pnpm code-pages:gen`. */}

import RouterCodeFooter from "/snippets/comfy-router/model-code-footer.mdx";

API Reference for `openai/gpt-6-sol`, served by Comfy Router from OpenAI.
...
**Endpoint:** `POST https://api.comfy.org/v2/models/openai/gpt-6-sol`
...
Generated from the schema Router serves at `GET /v2/models/openai/gpt-6-sol/openapi.json`, the same document it validates a call against before the request reaches the provider.
