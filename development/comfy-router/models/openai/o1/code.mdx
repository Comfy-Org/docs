---
title: "Use o1 with Comfy Router"
description: "Call openai/o1 through Comfy Router: endpoint, request shape and the response Router returns."
sidebarTitle: "o1"
---
...
**Endpoint:** `POST https://api.comfy.org/v2/models/openai/o1`
...
curl --max-time 660 https://api.comfy.org/v2/models/openai/o1 \
...
Generated from the schema Router serves at `GET /v2/models/openai/o1/openapi.json`, the same document it validates a call against before the request reaches the provider.
