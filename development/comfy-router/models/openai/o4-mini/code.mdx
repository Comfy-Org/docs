---
title: "Use o4-mini with Comfy Router"
description: "Call openai/o4-mini through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/openai/o4-mini`
...
curl --max-time 660 https://api.comfy.org/v2/models/openai/o4-mini \
...
Generated from the schema Router serves at `GET /v2/models/openai/o4-mini/openapi.json`, the same document it validates a call against before the request reaches the provider.
