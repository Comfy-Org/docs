---
title: "Use GPT 5.6 Sol with Comfy Router"
description: "Call openai/gpt-5.6-sol through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/openai/gpt-5.6-sol`
...
curl --max-time 660 https://api.comfy.org/v2/models/openai/gpt-5.6-sol \
...
Generated from the schema Router serves at `GET /v2/models/openai/gpt-5.6-sol/openapi.json`, the same document it validates a call against before the request reaches the provider.
