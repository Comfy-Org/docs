...
Use `openai/gpt-image-2.5-flare` with the Comfy Router API. OpenAI provides the model; Router gives it the shared authentication and request route below.
...
curl --max-time 660 https://api.comfy.org/v2/models/openai/gpt-image-2.5-flare \
