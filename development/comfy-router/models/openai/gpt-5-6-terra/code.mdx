---
title: "Use GPT 5.6 Terra with Comfy Router"
description: "Call openai/gpt-5.6-terra through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/openai/gpt-5.6-terra`
...
curl --max-time 660 https://api.comfy.org/v2/models/openai/gpt-5.6-terra \
...
<ParamField body="input" type="string | any[]" required>
...
<ParamField body="tools" type="any[]">
...
Generated from the schema Router serves at `GET /v2/models/openai/gpt-5.6-terra/openapi.json`, the same document it validates a call against before the request reaches the provider.
