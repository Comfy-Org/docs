...
Generated from the schema Router serves at `GET /v2/models/ltx/ltx-2-5-fast/openapi.json`, the same document it validates a call against before the request reaches the provider.
