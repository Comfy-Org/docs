...
curl --max-time 660 https://api.comfy.org/v2/models/meshy/meshy-6 \
...
<ParamField body="ai_model" type="string" default="&quot;latest&quot;">
  ID of the model to use.

  Possible values: `meshy-5`, `meshy-6`, `meshy-7`, `latest`
</ParamField>
