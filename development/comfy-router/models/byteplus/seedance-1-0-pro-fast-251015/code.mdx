---
title: "Use Seedance 1.0 Pro Fast 251015 with Comfy Router"
description: "Call byteplus/seedance-1-0-pro-fast-251015 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/byteplus/seedance-1-0-pro-fast-251015`
...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/seedance-1-0-pro-fast-251015 \
...
Generated from the schema Router serves at `GET /v2/models/byteplus/seedance-1-0-pro-fast-251015/openapi.json`, the same document it validates a call against before the request reaches the provider.
...
This provider example names `seedance-1-0-lite-t2v-250428`, not `byteplus/seedance-1-0-pro-fast-251015`. Use it only for the response shape.
