...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/dreamina-seedance-2-0-mini \
...
This provider example names `seedance-1-0-lite-t2v-250428`, not `byteplus/dreamina-seedance-2-0-mini`. Use it only for the response shape.
