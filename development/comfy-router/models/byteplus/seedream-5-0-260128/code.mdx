---
title: "Use Seedream 5.0 260128 with Comfy Router"
description: "Call byteplus/seedream-5-0-260128 through Comfy Router: endpoint, request shape and the response Router returns."
...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/seedream-5-0-260128 \
...
Generated from the schema Router serves at `GET /v2/models/byteplus/seedream-5-0-260128/openapi.json`, the same document it validates a call against before the request reaches the provider.
...
This provider example names `seedream-3-0-t2i-250415`, not `byteplus/seedream-5-0-260128`. Use it only for the response shape.
