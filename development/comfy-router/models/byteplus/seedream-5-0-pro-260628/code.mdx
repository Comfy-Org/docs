---
title: "Use Seedream 5.0 Pro 260628 with Comfy Router"
description: "Call byteplus/seedream-5-0-pro-260628 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/byteplus/seedream-5-0-pro-260628`
...
Generated from the schema Router serves at `GET /v2/models/byteplus/seedream-5-0-pro-260628/openapi.json`, the same document it validates a call against before the request reaches the provider.
