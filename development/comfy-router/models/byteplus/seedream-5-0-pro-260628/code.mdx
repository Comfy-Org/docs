...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/seedream-5-0-pro-260628 \
...
This provider example names `seedream-3-0-t2i-250415`, not `byteplus/seedream-5-0-pro-260628`. Use it only for the response shape.
