---
title: "Use Seedream 4.5 251128 with Comfy Router"
description: "Call byteplus/seedream-4-5-251128 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/byteplus/seedream-4-5-251128`
...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/seedream-4-5-251128 \
...
This provider example names `seedream-3-0-t2i-250415`, not `byteplus/seedream-4-5-251128`. Use it only for the response shape.
