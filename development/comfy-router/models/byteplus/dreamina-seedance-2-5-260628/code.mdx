...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/dreamina-seedance-2-5-260628 \
...
This provider example names `seedance-1-0-lite-t2v-250428`, not `byteplus/dreamina-seedance-2-5-260628`. Use it only for the response shape.
