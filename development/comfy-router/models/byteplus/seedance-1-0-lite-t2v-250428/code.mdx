---
title: "Use Seedance 1.0 Lite T2V 250428 with Comfy Router"
description: "Call byteplus/seedance-1-0-lite-t2v-250428 through Comfy Router: endpoint, request shape and the response Router returns."
...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/seedance-1-0-lite-t2v-250428 \
...
Generated from the schema Router serves at `GET /v2/models/byteplus/seedance-1-0-lite-t2v-250428/openapi.json`, the same document it validates a call against before the request reaches the provider.
