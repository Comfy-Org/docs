...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/seededit-3-0-i2i-250628 \
...
Generated from the schema Router serves at `GET /v2/models/byteplus/seededit-3-0-i2i-250628/openapi.json`, the same document it validates a call against before the request reaches the provider.
...
This provider example names `seedream-3-0-t2i-250415`, not `byteplus/seededit-3-0-i2i-250628`. Use it only for the response shape.
