---
title: "Use Seedance 1.0 Pro 250528 with Comfy Router"
description: "Call byteplus/seedance-1-0-pro-250528 through Comfy Router: endpoint, request shape and the response Router returns."
...
Generated from the schema Router serves at `GET /v2/models/byteplus/seedance-1-0-pro-250528/openapi.json`, the same document it validates a call against before the request reaches the provider.
