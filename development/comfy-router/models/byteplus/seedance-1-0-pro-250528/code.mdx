...
curl --max-time 660 https://api.comfy.org/v2/models/byteplus/seedance-1-0-pro-250528 \
...
This provider example names `seedance-1-0-lite-t2v-250428`, not `byteplus/seedance-1-0-pro-250528`. Use it only for the response shape.
