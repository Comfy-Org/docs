---
title: "Use Claude Opus 5 with Comfy Router"
description: "Call anthropic/claude-opus-5 through Comfy Router: endpoint, request shape and the response Router returns."
...
Generated from the schema Router serves at `GET /v2/models/anthropic/claude-opus-5/openapi.json`, the same document it validates a call against before the request reaches the provider.
