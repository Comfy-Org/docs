---
title: "Use Claude Opus 5.5 with Comfy Router"
description: "Call anthropic/claude-opus-5-5 through Comfy Router: endpoint, request shape and the response Router returns."
sidebarTitle: "Claude Opus 5.5"
---

{/* GENERATED FILE. Generated from router-schemas/anthropic/claude-opus-5-5.json by `pnpm code-pages:gen`. */}

import RouterCodeFooter from "/snippets/comfy-router/model-code-footer.mdx";

API Reference for `anthropic/claude-opus-5-5`, served by Comfy Router from Anthropic.
...
**Endpoint:** `POST https://api.comfy.org/v2/models/anthropic/claude-opus-5-5`
...
Generated from the schema Router serves at `GET /v2/models/anthropic/claude-opus-5-5/openapi.json`, the same document it validates a call against before the request reaches the provider.
