...
curl --max-time 660 https://api.comfy.org/v2/models/anthropic/claude-opus-4-8 \
...
This provider example names `claude-haiku-4-5-20251001`, not `anthropic/claude-opus-4-8`. Use it only for the response shape.
