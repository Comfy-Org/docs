---
title: "Use Claude Sonnet 4.5 20250929 with Comfy Router"
description: "Call anthropic/claude-sonnet-4-5-20250929 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/anthropic/claude-sonnet-4-5-20250929`
...
Generated from the schema Router serves at `GET /v2/models/anthropic/claude-sonnet-4-5-20250929/openapi.json`, the same document it validates a call against before the request reaches the provider.
