...
curl --max-time 660 https://api.comfy.org/v2/models/anthropic/claude-sonnet-4-5-20250929 \
...
<ParamField body="messages[].content" type="any" required>
...
<ParamField body="system" type="any">
...
This provider example names `claude-haiku-4-5-20251001`, not `anthropic/claude-sonnet-4-5-20250929`. Use it only for the response shape.
