---
title: "Use Claude Opus 4.7 with Comfy Router"
description: "Call anthropic/claude-opus-4-7 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/anthropic/claude-opus-4-7`
...
Generated from the schema Router serves at `GET /v2/models/anthropic/claude-opus-4-7/openapi.json`, the same document it validates a call against before the request reaches the provider.
