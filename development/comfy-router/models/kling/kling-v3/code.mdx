...
- **Comfy** (default): `POST https://api.comfy.org/v2/models/kling/kling-v3`
- **Higgsfield**, as `higgsfield/higgsfield-kling-3-std`: `POST https://api.comfy.org/v2/models/kling/kling-v3?model_provider=higgsfield`
