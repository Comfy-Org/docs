---
title: "Use Kling V2.1 Master with Comfy Router"
description: "Call kling/kling-v2-1-master through Comfy Router: endpoint, request shape and the response Router returns."
...
curl --max-time 660 https://api.comfy.org/v2/models/kling/kling-v2-1-master \
...
Generated from the schema Router serves at `GET /v2/models/kling/kling-v2-1-master/openapi.json`, the same document it validates a call against before the request reaches the provider.
