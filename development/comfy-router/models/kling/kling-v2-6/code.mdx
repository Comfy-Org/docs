---
title: "Use Kling V2.6 with Comfy Router"
description: "Call kling/kling-v2-6 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/kling/kling-v2-6`
...
curl --max-time 660 https://api.comfy.org/v2/models/kling/kling-v2-6 \
...
Generated from the schema Router serves at `GET /v2/models/kling/kling-v2-6/openapi.json`, the same document it validates a call against before the request reaches the provider.
