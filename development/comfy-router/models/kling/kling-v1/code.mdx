---
title: "Use Kling V1 with Comfy Router"
description: "Call kling/kling-v1 through Comfy Router: endpoint, request shape and the response Router returns."
...
curl --max-time 660 https://api.comfy.org/v2/models/kling/kling-v1 \
...
Generated from the schema Router serves at `GET /v2/models/kling/kling-v1/openapi.json`, the same document it validates a call against before the request reaches the provider.
