---
title: "Use Kling V2.1 with Comfy Router"
description: "Call kling/kling-v2-1 through Comfy Router: endpoint, request shape and the response Router returns."
...
**Endpoint:** `POST https://api.comfy.org/v2/models/kling/kling-v2-1`
...
curl --max-time 660 https://api.comfy.org/v2/models/kling/kling-v2-1 \
