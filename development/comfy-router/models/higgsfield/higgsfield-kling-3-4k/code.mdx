---
title: "Use Higgsfield Kling 3.4k with Comfy Router"
description: "Call higgsfield/higgsfield-kling-3-4k through Comfy Router: endpoint, request shape and the response Router returns."
...
API Reference for `higgsfield/higgsfield-kling-3-4k`, served by Comfy Router from Higgsfield.
...
Generated from the schema Router serves at `GET /v2/models/higgsfield/higgsfield-kling-3-4k/openapi.json`, the same document it validates a call against before the request reaches the provider.
