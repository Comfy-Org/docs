...
Some of these models can also be served by an aggregator on the same route and the same model ID. [Serving providers](/development/comfy-router/providers) lists which provider covers which model, and how to select one.
...
- [Claude Opus 5.5](/development/comfy-router/models/anthropic/claude-opus-5-5/code): `anthropic/claude-opus-5-5`
...
- [Image Edit Add Object By Text](/development/comfy-router/models/bria/image-edit-add-object-by-text/code): `bria/image-edit-add-object-by-text`
- [Image Edit Erase By Text](/development/comfy-router/models/bria/image-edit-erase-by-text/code): `bria/image-edit-erase-by-text`
- [Image Edit Erase Foreground](/development/comfy-router/models/bria/image-edit-erase-foreground/code): `bria/image-edit-erase-foreground`
...
- [Image Edit Relight](/development/comfy-router/models/bria/image-edit-relight/code): `bria/image-edit-relight`
...
- [Image Edit Replace Background](/development/comfy-router/models/bria/image-edit-replace-background/code): `bria/image-edit-replace-background`
- [Image Edit Replace Object By Text](/development/comfy-router/models/bria/image-edit-replace-object-by-text/code): `bria/image-edit-replace-object-by-text`
- [Image Edit Reseason](/development/comfy-router/models/bria/image-edit-reseason/code): `bria/image-edit-reseason`
- [Image Edit Restore](/development/comfy-router/models/bria/image-edit-restore/code): `bria/image-edit-restore`
- [Structured Instruction](/development/comfy-router/models/bria/structured-instruction/code): `bria/structured-instruction`
- [Video Edit Erase](/development/comfy-router/models/bria/video-edit-erase/code): `bria/video-edit-erase`
...
- [Seedream 5.0 Flash 260915](/development/comfy-router/models/byteplus/seedream-5-0-flash-260915/code): `byteplus/seedream-5-0-flash-260915`
...
- [Higgsfield Kling 3.4k](/development/comfy-router/models/higgsfield/higgsfield-kling-3-4k/code): `higgsfield/higgsfield-kling-3-4k`
- [Higgsfield Kling 3 Pro](/development/comfy-router/models/higgsfield/higgsfield-kling-3-pro/code): `higgsfield/higgsfield-kling-3-pro`
...
- [Meshy 7.1](/development/comfy-router/models/meshy/meshy-7-1/code): `meshy/meshy-7.1`
...
- [GPT 6 Luna](/development/comfy-router/models/openai/gpt-6-luna/code): `openai/gpt-6-luna`
- [GPT 6 Sol](/development/comfy-router/models/openai/gpt-6-sol/code): `openai/gpt-6-sol`
...
- [Chat Completions](/development/comfy-router/models/openrouter/chat-completions/code): `openrouter/chat-completions`
...
- [Sync 3](/development/comfy-router/models/synclabs/sync-3/code): `synclabs/sync-3`
