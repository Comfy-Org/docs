...
<AccordionGroup>
  <Accordion title="Am I charged for storing Builds that are not deployed?">
    ...
    Current network-storage rates are:

    - Standard storage below 1 TB: **$0.091 per GB/month**
    - Standard storage at 1 TB or more: **$0.065 per GB/month**
    - High-performance storage: **$0.182 per GB/month**

    See [comfy.org/pricing](https://www.comfy.org/pricing) for current rates. The compute catalog (`comfy deploy refs compute`) and the deploy dialog show the rates for a deployment.
  </Accordion>
