...
<AccordionGroup>
  <Accordion title="How do I run a deployed workflow?">
    A Serverless deployment gives your workflow a managed API endpoint. Submit an API-format workflow with `comfy deploy run` or the [Comfy SDKs](/development/api-development/sdks).
  </Accordion>
