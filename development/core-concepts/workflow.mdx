...
<Tip>
You can also export a workflow as a PNG image with the workflow embedded in its metadata — making it easy to share both the result and the recipe in a single file.
</Tip>