...
See the [Cloud API Reference](/development/cloud/api-reference#websocket-message-reference) for message types, and the [v1 Cloud API examples](/development/deploy/cloud#websocket-for-real-time-progress) for connection handling.
