...
If you want a managed version of this workflow, with builds, releases, and autoscaling handled for you, use a [Comfy API deployment on the Developer Platform](/development/serverless/overview).
