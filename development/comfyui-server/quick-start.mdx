...
All examples use the [default SD1.5 workflow](https://github.com/Comfy-Org/ComfyUI/blob/master/script_examples) for illustration. You can export any workflow in API format from the ComfyUI frontend (`File → Save (API Format)`).
