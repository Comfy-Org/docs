...
To use your ComfyUI Account API Key to call paid Partner Nodes, you need a [Comfy Platform API key](/development/api-development/getting-an-api-key).

<Card title="Getting an API Key" icon="key" href="/development/api-development/getting-an-api-key">
  Create and manage your Comfy Platform API Key for Partner Nodes, Cloud APIs, and more.
</Card>
