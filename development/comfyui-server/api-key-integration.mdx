...
<Note>
**Looking for the registry publish API key?** If you're trying to publish custom nodes to the Comfy Registry, you need a different API key. See the [Publishing Nodes](/registry/publishing#create-an-api-key-for-publishing) documentation for details on creating a registry publish API key.
</Note>
