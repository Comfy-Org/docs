---
title: "ComfyUI Server Messages (WebSocket API)"
icon: "comment"
description: "How ComfyUI's PromptExecutor sends WebSocket messages to the client, built-in types like execution_start and progress, and registering custom message types."
---
