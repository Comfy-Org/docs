...
title: "Messages"
icon: "comment"
description: "Learn how ComfyUI's PromptExecutor sends messages to the client via WebSocket, including built-in message types like execution_start and progress, how to register custom message types, and how to get node_id."
---
