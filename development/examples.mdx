---
title: "Comfy API and Router examples"
sidebarTitle: "Examples"
description: "Starting points for Comfy Router models and deployed ComfyUI workflows, plus full demo apps you can deploy and adapt."
icon: "code"
mode: "wide"
---
...
<div className="sample-card-grid">
  <div className="sample-card" data-sample-card="true">
    <div className="sample-card-inner">
      <div className="sample-card-face sample-card-front" data-sample-front="true">
        <img src="/images/samples/img2img-web-app.svg" alt="Preview of the image-to-image web app" className="sample-card-preview" data-sample-preview="api" noZoom="true" />
  ...
  <div className="sample-card" data-sample-card="true">
    <div className="sample-card-inner">
      <div className="sample-card-face sample-card-front" data-sample-front="true">
        <img src="/images/samples/sketch-to-image.svg" alt="Preview of the sketch-to-image app" className="sample-card-preview" data-sample-preview="api" noZoom="true" />
        <div className="sample-card-body">
  ...
  <div className="sample-card" data-sample-card="true">
    <div className="sample-card-inner">
      <div className="sample-card-face sample-card-front" data-sample-front="true">
        <img src="/images/samples/discord-image-bot.svg" alt="Preview of the Discord image bot" className="sample-card-preview" data-sample-preview="api" noZoom="true" />
        <div className="sample-card-body">
