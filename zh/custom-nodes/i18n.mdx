    ...
    settings: [
        {
            ...
            category: ["I18nDemo","DebugMode"], // 与 main.json 中的 settingsCategories 键匹配
            name: "Enable Debug Mode", // 会被翻译覆盖
            tooltip: "Show debug information in console for i18n demo nodes", // 会被翻译覆盖
            type: "boolean",
            defaultValue: false,
            experimental: true,
            onChange: (value) => {
        ...
        },
        {
            ...
            category: ["I18nDemo","DefaultTextOperation"], // 与 main.json 中的 settingsCategories 键匹配
            name: "Default Text Operation", // 会被翻译覆盖
            tooltip: "Default operation for text processor node", // 会被翻译覆盖
            type: "combo",
