...
<Tabs>
<Tab title="Windows">
- **不支持的设备**：ComfyUI Desktop Windows 仅支持带有 CUDA 的 NVIDIA GPU。对于其他 GPU，请使用 [ComfyUI 便携版](/zh/installation/comfyui_portable_windows)或[手动安装](/zh/installation/manual_install)
