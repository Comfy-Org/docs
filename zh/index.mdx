---
title: "ComfyUI 官方文档"
description: "ComfyUI 官方文档。开源、基于节点的生成式 AI 应用，支持构建图像、视频、音频和 3D 生成工作流。"
icon: "book-open"
mode: "wide"
sidebarTitle: "首页"
...
<div className="mb-12">
  ...
  <CardGroup cols={3}>
    ...
    >
      使用一个 API 密钥通过单一端点调用合作伙伴模型
    </Card>
    <Card
      title="可用模型"
      icon="layer-group"
      href="/zh/development/comfy-router/models"
    >
      浏览 Router 提供的全部模型
    </Card>
    <Card
...
<div className="mb-12">
  ...
  <CardGroup cols={3}>
    ...
    <Card
      title="本地 API"
      icon="terminal"
      href="/zh/development/comfyui-server/comms_overview"
    >
      集成本地 ComfyUI 服务器
    </Card>
    <Card
      title="Cloud API"
      icon="cloud"
      href="/zh/development/cloud/overview"
    >
    ...
    <Card
      title="Cloud API 参考"
      icon="book"
      href="/zh/development/cloud/api-reference"
    >
