...
description: "在 Windows 上下载并运行 ComfyUI 便携版：内置 Python 和适用于 Nvidia GPU 的 CUDA 构建的独立软件包。解压即可开始创作。"
icon: "box"
...
有关安装自定义节点依赖的详细说明，请参阅[自定义节点依赖指南](/zh/basic-concepts/custom-nodes)。
