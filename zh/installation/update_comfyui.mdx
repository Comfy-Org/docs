---
title: "如何更新 ComfyUI"
description: "更新任意安装类型的 ComfyUI：便携版更新脚本、Desktop 更新、手动安装的 git pull，以及常见更新问题的修复。"
icon: "circle-up"
...
<Tab title="桌面版">
Comfy 桌面版使用 Comfy Engine 作为包管理器来管理 ComfyUI。要更新 ComfyUI 本体，请打开 [管理面板](/zh/installation/desktop/usage/manage#更新选项卡) 的更新标签页，可以选择 **稳定版**（默认）和 **GitHub 最新版** 更新频道。
