...
<Tab title="桌面版">
Comfy 桌面版采用自动更新机制，确保你始终使用最新版本，不过由于 Desktop 版本是基于稳定版本构建的，所以它的功能更新相对滞后，你也可以访问 [下载页面](https://www.comfy.org/download) 来获取最新版本。

### 自动更新设置
请确保在设置中已经启用自动更新功能：
![Comfy 桌面版设置](/images/desktop/comfyui-desktop-update-setting.jpg)
...
2. 选择 `帮助`
3. 点击 `检查更新`
![Comfy 桌面版检查更新](/images/desktop/desktop_check_for_updates.jpg)
...
<Card title="故障排查" icon="bug" href="/zh/troubleshooting/overview">
