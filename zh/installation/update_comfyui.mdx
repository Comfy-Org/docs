...
<Tab title="桌面版">
Comfy 桌面版使用 Comfy Engine 作为包管理器来管理 ComfyUI。要更新 ComfyUI 本体，请打开 [管理面板](/zh/installation/desktop/usage/manage#update-tab) 的更新标签页，可以选择 **稳定版**（默认）和 **GitHub 最新版** 更新频道。
