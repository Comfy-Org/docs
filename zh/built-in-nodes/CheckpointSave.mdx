...
- 目前完全支持: SDXL、SD3、SVD 等主流架构,查看[源码](https://github.com/Comfy-Org/ComfyUI/blob/master/comfy_extras/nodes_model_merging.py#L176-L189)
- 基础支持：其它架构认可保存，但不会添加标准化的元数据信息

## 相关链接

相关源码: [nodes_model_merging.py#L227](https://github.com/Comfy-Org/ComfyUI/blob/master/comfy_extras/nodes_model_merging.py#L227)
