...
| `aspect_ratio` | 生成图像的宽高比。默认值："1:1"。 | COMBO | 否 | "1:1"<br />"3:4"<br />"2:3"<br />"3:2"<br />"4:3"<br />"16:9"<br />"9:16"<br />"21:9" |
| `megapixels` | 总像素预算。在方形比例下，1.0 约为 1024x1024。默认值：1.0。 | FLOAT | 否 | 0.1 - 16.0<br />(step of 0.1) |
