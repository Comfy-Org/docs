...
<Warning>
  **已退役（EOL）**：此节点已于 **2026 年 7 月 30 日** 达到生命周期终点。首尾帧视频请使用 [Kling 3.0 首尾帧转视频](/zh/tutorials/partner-nodes/kling/kling-3-0) 或其他受支持的 FLF2V 模板。
</Warning>

Runway 首尾帧生成视频节点通过上传首帧、尾帧及文本提示词来生成视频。
