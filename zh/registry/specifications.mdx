...
description: "ComfyUI 自定义节点 pyproject.toml 完整规范：[project] 和 [tool.comfy] 部分、必填字段、版本管理，以及完整示例。"
...
<Tip>要从发布归档中排除文件（与 `includes` 相反），请参阅发布页面中的 [`.comfyignore`](/zh/registry/publishing) 部分。</Tip>
