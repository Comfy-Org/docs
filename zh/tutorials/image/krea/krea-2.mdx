...
<CardGroup cols={3}>
  <Card title="扩散模型 (FP8)" icon="download" href="https://huggingface.co/Comfy-Org/Krea-2/blob/main/diffusion_models/krea2_turbo_fp8_scaled.safetensors">
    krea2_turbo_fp8_scaled.safetensors：Turbo FP8（推荐大多数用户使用）
  </Card>
  <Card title="文本编码器 (FP8)" icon="download" href="https://huggingface.co/Comfy-Org/Krea-2/blob/main/text_encoders/qwen3vl_4b_fp8_scaled.safetensors">
