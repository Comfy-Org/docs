...
<CardGroup cols={2}>
  ...
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://links.comfy.org/424gNY7">
...
1. 将 ComfyUI 更新至最新版本，或使用 [Comfy Cloud](https://links.comfy.org/424gNY7)
...
<CardGroup cols={2}>
  ...
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://links.comfy.org/4tJ57FZ">
    在 Comfy Cloud 上直接运行此工作流。
  </Card>
</CardGroup>
