---
title: "ERNIE-Image ComfyUI 工作流示例"
description: "ERNIE-Image 是百度开源的 8B 扩散变换器文生图模型，具备精准文字渲染、强大的指令跟随能力，并内置提示词增强器。"
...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_ernie_image-1.webp" alt="ERNIE-Image text-to-image 工作流预览" />

<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=image_ernie_image&utm_source=docs&utm_medium=referral&utm_campaign=ernie-image">
    在 Comfy Cloud 中直接运行此工作流
  </Card>
  <Card title="下载工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_ernie_image.json">
...
![ERNIE-Image 输出示例](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_ernie_image.png)
...
[ERNIE-Image-Turbo](https://huggingface.co/Baidu/ERNIE-Image-Turbo) 是经 DMD 和 RL 优化的更快变体，仅需 **8 步**即可生成图像，而标准模型约需 50 步。
...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_ernie_image_turbo-1.webp" alt="ERNIE-Image-Turbo text-to-image 工作流预览" />

<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=image_ernie_image_turbo&utm_source=docs&utm_medium=referral&utm_campaign=ernie-image">
    在 Comfy Cloud 中直接运行此工作流
  </Card>
  <Card title="下载工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_ernie_image_turbo.json">
...
![ERNIE-Image-Turbo 输出示例](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_ernie_image_turbo.png)
