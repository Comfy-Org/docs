...
<a href="https://cloud.comfy.org/?template=image_qwen_Image_2512&utm_source=docs&utm_medium=referral&utm_campaign=qwen-image-2512" style={{ display: 'inline-block', backgroundColor: '#7c3aed', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold', marginBottom: '1rem'}}>
    在 Comfy Cloud 上运行
</a>
