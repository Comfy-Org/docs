...
具有更强的人像真实感、更精细的自然细节和更出色文字渲染能力的文生图模型。
...
![Qwen-Image-2512 输出示例](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_qwen_Image_2512.png)
