...
<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 中运行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_e1_1&utm_source=docs&utm_medium=referral&utm_campaign=hidream_e1">
    在 Comfy Cloud 中打开
  </Card>
...
<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 中运行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_e1_full&utm_source=docs&utm_medium=referral&utm_campaign=hidream_e1">
    在 Comfy Cloud 中打开
  </Card>
