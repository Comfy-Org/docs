...
<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_i1_full&utm_source=docs">
...
<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_i1_dev&utm_source=docs">
    Run this workflow on Comfy Cloud with zero setup
  </Card>
...
<CardGroup cols={2}>
  <CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_i1_fast&utm_source=docs">
    Run this workflow on Comfy Cloud with zero setup
  </Card>
