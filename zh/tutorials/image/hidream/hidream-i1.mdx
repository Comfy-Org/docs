...
**混合架构设计**
采用 Diffusion Transformer（DiT）与混合专家系统（MoE）的组合架构：
- 基于 Diffusion Transformer（DiT），通过双流 MMDiT 模块处理多模态信息，单流 DiT 模块优化全局一致性。
...
这一组合使其在颜色、数量、空间关系等复杂语义解析上达到 SOTA 水平，中文提示词支持显著优于同类开源模型。

**原始模型版本**

HiDream-ai 提供三个版本的 HiDream-I1 模型，以满足不同需求。以下是原始模型仓库的链接：

| 模型名 | 描述 | 推理步数 | 仓库链接 |
|--------|------|----------|----------|
| HiDream-I1-Full | 完整版 | 50 | [🤗 HiDream-I1-Full](https://huggingface.co/HiDream-ai/HiDream-I1-Full) |
| HiDream-I1-Dev | 蒸馏开发版 | 28 | [🤗 HiDream-I1-Dev](https://huggingface.co/HiDream-ai/HiDream-I1-Dev) |
| HiDream-I1-Fast | 蒸馏快速版 | 16 | [🤗 HiDream-I1-Fast](https://huggingface.co/HiDream-ai/HiDream-I1-Fast) |

## 关于本篇工作流示例

在本示例中，我们将使用 ComfyOrg 重新打包的版本。你可以在 [HiDream-I1_ComfyUI](https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/) 仓库中找到本示例中将使用的所有模型文件。

<Tip>
在开始之前，请更新你的 ComfyUI 版本，确保其至少在此[提交](https://github.com/Comfy-Org/ComfyUI/commit/9ad792f92706e2179c58b2e5348164acafa69288)之后，以保证你的 ComfyUI 原生支持 HiDream。
</Tip>
...
你需要使用 City96 的 [ComfyUI-GGUF](https://github.com/city96/ComfyUI-GGUF) 中的“U-Net 加载器 (GGUF)”节点来替换“UNet 加载器”节点。

### NF4 版本模型
- [HiDream-I1-nf4](https://github.com/hykilpikonna/HiDream-I1-nf4) 
- 通过 [ComfyUI-HiDream-Sampler](https://github.com/SanDiegoDude/ComfyUI-HiDream-Sampler) 节点来使用 NF4 版本模型。
