...
输入文本提示词，选择分辨率和宽高比。使用高效的 Lens 文生图模型生成高质量图像。
...
2. 进入 **模板** 并搜索 **Lens**
3. 选择 **Lens** 工作流
4. 下载任何缺失的模型（参见 [模型下载](#lens-model-downloads)），输入提示词，然后点击 **队列**

### Lens Turbo: Text to Image (`image_lens_turbo_t2i`)

输入文本提示词，选择分辨率、宽高比和推理步数。使用 Lens 文生图模型生成高质量图像。
