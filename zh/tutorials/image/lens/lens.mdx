...
1. 更新 ComfyUI 到最新版本，或使用 [Comfy Cloud](https://cloud.comfy.org/?template=image_lens_t2i&utm_source=docs&utm_medium=referral&utm_campaign=lens)
2. 进入 **模板** 搜索 **Lens**
3. 选择 **Lens** 工作流
...
1. 更新 ComfyUI 到最新版本，或使用 [Comfy Cloud](https://cloud.comfy.org/?template=image_lens_turbo_t2i&utm_source=docs&utm_medium=referral&utm_campaign=lens)
