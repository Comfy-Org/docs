...
<CardGroup cols={2}>
  ...
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=image_newbieimage_exp0_1-t2i&utm_source=docs&utm_medium=referral&utm_campaign=newbie-image">
    Open in cloud
  </Card>
</CardGroup>
</CardGroup>
