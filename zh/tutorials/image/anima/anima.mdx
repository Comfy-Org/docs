...
2. 前往 **模板**，搜索 **Aima Base v1**
3. 选择 **Aima Base v1: Text to Image** 工作流
4. 下载缺失的模型（参见[模型下载](#anima-model-downloads-anima-模型下载)），输入提示词后点击 **运行**

#### 示例输出

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_anima_base_v1-1.webp" alt="Anima Base v1 示例输出" />
...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_anima_preview-1.webp" alt="Anima Preview 示例输出" />
