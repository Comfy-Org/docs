...
### Anima Base v1：文生图 {#image_anima_base_v1}

输入描述动漫或艺术插画的文本提示词。生成以动漫概念、角色或风格为核心的非写实图像。
...
![Anima Base v1 示例输出](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_anima_base_v1.png)
...
4. 下载缺失的模型（参见[模型下载](#anima-模型下载)），输入提示词，然后点击 **运行**

### Anima Preview：动漫文生图 {#image_anima_preview}

输入文本提示词，使用 Anima 模型生成动漫风格图像。配置步数和 CFG 缩放等设置以控制输出。
...
![Anima Preview 示例输出](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_anima_preview.png)
