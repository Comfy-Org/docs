...
<CardGroup cols={2}>
  <Card title="前视图图像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/3d_hunyuan3d_multiview_to_model_front_image.png">
    `LoadImage` 节点 56 · 前视图
  </Card>
  <Card title="左视图图像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/3d_hunyuan3d_multiview_to_model_left_image.png">
    `LoadImage` 节点 78 · 左视图
  </Card>
  <Card title="后视图图像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/3d_hunyuan3d_multiview_to_model_back_image.png">
    `LoadImage` 节点 80 · 后视图
  </Card>
  <Card title="右视图图像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/3d_hunyuan3d_multiview_to_model_right_image.png">
    `LoadImage` 节点 87 · 右视图
  </Card>
</CardGroup>
...
如果你需要增加更多视角，请确保 `Hunyuan3Dv2条件多视角` 节点中加载了其它视角的图片，并确保在 `Load Image` 节点中加载了对应视角的图片。
...
- hunyuan3d-dit-v2-mv-turbo：[model.fp16.safetensors](https://huggingface.co/tencent/Hunyuan3D-2mv/blob/main/hunyuan3d-dit-v2-mv-turbo/model.fp16.safetensors?download=true) – 下载后可重命名为 `hunyuan3d-dit-v2-mv-turbo.safetensors`
