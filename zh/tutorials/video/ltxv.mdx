...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '1rem', alignItems: 'start'}}>
  <img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/ltxv_image_to_video_input_image.jpg" alt="ltxv_image_to_video_input_image.jpg 输入图像" style={{width: '100%', height: 'auto', objectFit: 'contain'}} />
</div>
