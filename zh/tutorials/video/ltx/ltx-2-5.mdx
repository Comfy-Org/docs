...
<CardGroup cols={2}>
  ...
  <Card title="文本编码器：gemma4_e2b_it_int8_convrot" icon="download" href="https://huggingface.co/Comfy-Org/gemma-4/blob/main/text_encoders/gemma4_e2b_it_int8_convrot.safetensors">
