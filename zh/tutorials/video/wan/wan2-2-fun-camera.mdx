...
<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 中运行" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_fun_camera&utm_source=docs&utm_medium=referral&utm_campaign=wan2-2-fun-camera">
    在 Comfy Cloud 中打开
  </Card>
...
<CardGroup cols={1}>
  <Card title="输入起始图片" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/video/wan/wan2.2_fun_camera/input.jpg">
