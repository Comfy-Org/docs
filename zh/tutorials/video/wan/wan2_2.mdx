...
sidebarTitle: Wan2.2
translationSourceHash: c0efd4ab
...
translationBlockHashes:
  ...
  "Wan2.2 14B I2V Image-to-Video Workflow Example": 8131a46a
...
<CardGroup cols={1}>
  <Card title="wan2.2_ti2v_5B_fp16.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/blob/main/split_files/diffusion_models/wan2.2_ti2v_5B_fp16.safetensors">
    5B 混合 diffusion 模型。放置于 <code>ComfyUI/models/diffusion_models/</code>
  </Card>
</CardGroup>
...
### Wan 2.2 14B 文生视频 {#video_wan2_2_14B_t2v}

使用 Wan 2.2 从文本提示生成高质量视频，具备电影级美学控制与动态运动生成能力。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_wan2_2_14B_t2v-1.webp" alt="Wan 2.2 14B 文生视频工作流预览" />
...
上述所有模型都可以在 [Comfy-Org/Wan_2.2_ComfyUI_Repackaged](https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged) 中找到。
...
<CardGroup cols={2}>
  <Card title="wan2.2_t2v_high_noise_14B_fp8_scaled.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/blob/main/split_files/diffusion_models/wan2.2_t2v_high_noise_14B_fp8_scaled.safetensors">
    高噪波 Diffusion 模型。放置到 <code>ComfyUI/models/diffusion_models/</code>
  </Card>
  <Card title="wan2.2_t2v_low_noise_14B_fp8_scaled.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/blob/main/split_files/diffusion_models/wan2.2_t2v_low_noise_14B_fp8_scaled.safetensors">
    低噪波 Diffusion 模型。放置到 <code>ComfyUI/models/diffusion_models/</code>
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="umt5_xxl_fp8_e4m3fn_scaled.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/blob/main/split_files/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors">
    FP8 文本编码器。放置到 <code>ComfyUI/models/text_encoders/</code>
  </Card>
</CardGroup>
...
### 3. 按步骤完成工作流
![步骤示意图](/images/tutorial/video/wan/wan2_2/wan_2.2_14b_t2v.jpg)
...
### Wan 2.2 14B 首尾帧转视频 {#video_wan2_2_14B_flf2v}

通过定义起始帧和结束帧，生成平滑的视频过渡。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_wan2_2_14B_flf2v-1.webp" alt="Wan 2.2 14B 首尾帧转视频工作流预览" />
