...
<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=video_causal_forcing_i2v&utm_source=docs&utm_medium=referral&utm_campaign=wan-causal-forcing">
    在 Comfy Cloud 中打开
  </Card>
...
这种循环方法带来了 **很强的时序一致性**：每帧自然地承接前一帧。这可以通过很少的推理步数（1 到 4 步）生成高质量结果。
