...
<CardGroup cols={2}>
<Card title="WanVaceToVideo 节点文档" icon="book" href="/zh/built-in-nodes/conditioning/video-models/wan-vace-to-video">
WanVaceToVideo 节点文档
</Card>
<Card title="TrimVideoLatent 节点文档" icon="book" href="/zh/built-in-nodes/latent/video/trim-video-latent">
