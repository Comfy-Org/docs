...
感谢我们强大的 ComfyUI 作者们，他们提供了功能丰富的节点。如果你想直接查看相关版本，请参阅[使用自定义节点的工作流](#workflow-using-custom-nodes)。
...
- 由于我们需要将与控制视频相同的帧数输入到 `WanFunControlToVideo` 节点，如果指定的帧数超过实际的控制视频帧数，多余的帧可能会显示不符合控制条件的画面。我们将在[使用自定义节点的工作流](#workflow-using-custom-nodes)中解决此问题
