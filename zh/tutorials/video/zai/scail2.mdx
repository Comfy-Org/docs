...
替换视频中的角色，同时保留动作和场景上下文。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_wan21_scail2_character_replacement-1.webp" alt="SCAIL-2 角色替换工作流预览" />
...
<CardGroup cols={2}>
  ...
  <Card title="下载工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_wan21_scail2_character_replacement.json">
    下载 JSON 或在模板库中搜索 "SCAIL-2 Character Replacement"
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="参考图像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/reference_streetwear_character.png">
    下载默认参考角色图像，或使用自己的图像。
  </Card>
  <Card title="驱动视频" icon="video" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/driving_outdoor_dance.mp4">
    下载默认驱动视频，或使用自己的视频。
  </Card>
</CardGroup>
...
本工作流使用两个子图节点：**Base** 子图（第一段）和 **Extend** 子图（后续段落），用于支持短视频和长视频的角色动画。
