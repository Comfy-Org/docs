...
请下载以下视频并将其拖入 ComfyUI 以加载工作流。工作流已嵌入模型下载链接。
...
如果模型未成功下载，您可以在此部分手动下载。

**Diffusion model**

<Card title="扩散模型" icon="download" href="https://huggingface.co/Comfy-Org/Cosmos_Predict2_repackaged/resolve/main/cosmos_predict2_2B_video2world_480p_16fps.safetensors">
...
<Card title="文本编码器" icon="download" href="https://huggingface.co/comfyanonymous/cosmos_1.0_text_encoder_and_VAE_ComfyUI/resolve/main/text_encoders/oldt5_xxl_fp8_e4m3fn_scaled.safetensors">
