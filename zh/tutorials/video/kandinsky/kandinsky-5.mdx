...
<CardGroup cols={2}>
  <Card title="下载 JSON 工作流文件" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_kandinsky5_t2v.json">
...
<CardGroup cols={2}>
  <Card title="下载 JSON 工作流文件" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_kandinsky5_i2v.json">
