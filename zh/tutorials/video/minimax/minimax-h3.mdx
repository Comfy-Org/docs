...
translationSourceHash: 3a7e4650
...
translationBlockHashes:
  ...
  "Advanced workflows with the native nodes": f479925f
...
社区训练的示例嵌入可在 [silveroxides/MiniMax-H3_tests](https://huggingface.co/silveroxides/MiniMax-H3_tests/tree/main/embeddings) 仓库中找到，例如 `minimaxh3_art_is_explosion.safetensors`（以 `embedding:minimaxh3_art_is_explosion` 引用）。
