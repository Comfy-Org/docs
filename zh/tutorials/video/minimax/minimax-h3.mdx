...
translationSourceHash: a19ad880
...
ComfyUI 为 MiniMax H3 内置了三种原生工作流，每种都针对特定的生成模式设计：
...
<CardGroup cols={2}>
  ...
  <Card title="文本编码器：qwen3vl_32b_minimax_h3_int8_convrot" icon="download" href="https://huggingface.co/Comfy-Org/MiniMax-H3/blob/main/text_encoders/qwen3vl_32b_minimax_h3_int8_convrot.safetensors">
