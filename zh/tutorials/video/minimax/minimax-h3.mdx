...
translationSourceHash: e00aacbd
...
<UpdateReminder/>
<Note>
H3 的开放权重让你可以在本地运行模型。本地生成输出的商业使用需要 [MiniMax 商业许可证](https://comfy.org/minimax/license)，可通过 Comfy（唯一官方经销商）获取。Comfy Cloud 上的生成已包含商业使用权。
</Note>
