...
translationSourceHash: 5550b3a0
...
translationBlockHashes:
  ...
  "Advanced workflows with the native nodes": 3d17ebca
...
官方风格嵌入可在 [Comfy-Org/MiniMax-H3](https://huggingface.co/Comfy-Org/MiniMax-H3/tree/main/embeddings) 仓库的 `embeddings` 文件夹中找到（共 10 个），社区训练的示例也可在 [silveroxides/MiniMax-H3_tests](https://huggingface.co/silveroxides/MiniMax-H3_tests/tree/main/embeddings) 仓库中找到。文件名即其预期效果的描述，触发词为去掉扩展名的文件名：
