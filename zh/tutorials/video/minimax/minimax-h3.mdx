...
translationSourceHash: 60130127
...
translationBlockHashes:
  ...
  "ComfyUI Native Workflows": 985b95f5
...
### MiniMax H3 图像转视频延续工作流

I2V 工作流的延续变体：加载一张图像，然后描述你想要的运动、镜头和音频。该工作流默认使用空提示词，执行前可随时编辑。

<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=video_minimax_h3_i2v_continuation&utm_source=docs&utm_medium=referral&utm_campaign=minimax-h3">
    在 Comfy Cloud 中打开
  </Card>
  <Card title="下载工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_minimax_h3_i2v_continuation.json">
    下载 JSON 或在模板库中搜索 "MiniMax H3 I2V Continuation"
  </Card>
</CardGroup>

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_minimax_h3_i2v_continuation-1.webp" alt="MiniMax H3 图像转视频延续工作流预览" />
