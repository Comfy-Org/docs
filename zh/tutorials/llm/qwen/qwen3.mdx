...
### Qwen 3.0：文本生成（`llm_qwen3_text_gen`）

输入文本提示词，使用 Qwen3-4B-Thinking 模型生成详细且经过推理的回复。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/llm_qwen3_text_gen-1.webp" alt="Qwen 3.0 文本生成工作流预览" />
