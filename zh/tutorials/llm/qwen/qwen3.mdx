...
Qwen 3.0 模型以文本编码器的形式加载到 ComfyUI 中。选择合适的版本下载：
...
<CardGroup cols={2}>
  ...
  <Card title="Qwen3 4B (fp4)" icon="download" href="https://huggingface.co/Comfy-Org/flux2-klein/resolve/main/split_files/text_encoders/qwen_3_4b_fp4_flux2.safetensors">
    FP4 量化版。文件更小，适合低显存环境。
  </Card>
</CardGroup>

> fp4 变体（`qwen_3_4b_fp4_flux2.safetensors`）是 4-bit 量化版本，文件更小，适用于显存有限或需要更快下载的场景。
...
├── 📂 models/
│   └── 📂 text_encoders/
│       └── qwen_3_4b.safetensors   # 或 qwen_3_4b_fp4_flux2.safetensors
```
