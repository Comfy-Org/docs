...
### Qwen3.5: 文本生成（`llm_qwen3_5_text_gen`）

使用 Qwen3.5 模型分析输入图像并生成描述性文本提示词。此工作流执行图像描述和反向提示词工程。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/llm_qwen3_5_text_gen-1.webp" alt="Qwen3.5 文本生成工作流预览" />
...
<CardGroup cols={2}>
  <Card title="man_with_red_hat.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/man_with_red_hat.png">
    `LoadImage` 节点 2 · `man_with_red_hat.png`
  </Card>
</CardGroup>

<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '1rem', alignItems: 'start'}}>
  <img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/man_with_red_hat.png" alt="输入图像" style={{width: '100%', height: 'auto', objectFit: 'contain'}} />
</div>

此工作流展示了 Qwen3.5 的**文本生成和图像理解**能力。它接受文本提示词和可选图像输入，根据输入生成描述性文本或结构化分析。
