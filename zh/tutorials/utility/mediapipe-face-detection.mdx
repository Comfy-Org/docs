...
如需进行视频人脸检测，从 ComfyUI 菜单中打开 "Video Face Detection (Mediapipe)" blueprint。它将相同的检测子图封装在视频处理管线中，包含裁剪、帧处理和视频输出。

<Card title="打开 Video Face Detection Blueprint" icon="book-open" href="https://github.com/Comfy-Org/ComfyUI/blob/master/blueprints/Video%20Face%20Detection%20(Mediapipe).json">
  从 ComfyUI 仓库访问 Video Face Detection blueprint
</Card>
