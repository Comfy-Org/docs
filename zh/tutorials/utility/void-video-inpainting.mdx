---
title: "VOID：ComfyUI 视频修复工作流"
sidebarTitle: "VOID 视频修复"
description: "学习使用 Netflix 开源的 VOID 视频修复模型在 ComfyUI 中移除视频中的物体"
---
...
VOID（Video Object Inpainting and Deletion）是 Netflix 于 2026 年 5 月 14 日开源的一款强大的视频修复模型。它采用两阶段扩散 pipeline，能够从视频中移除物体并以时间连贯的内容填补空缺。
...
[VOID 模型 - GitHub](https://github.com/Netflix/void-model)
...
VOID 能够从视频中移除不需要的物体，同时保持自然的运动、光照和画面连贯性。以上示例展示了从场景中移除物体后的处理结果。

### 核心优势

- **真正的物体移除**，而非单帧修补 — 在整个片段中生成连贯的运动和光照
- **交互感知的缝隙修复** — 被遮挡的像素将被填充，仿佛物体及其对邻近元素的影响从未存在过，阴影、重叠等因果线索比简单的擦除更加自然
...
<Card title="了解 Subgraph" icon="book-open" href="/interface/features/subgraph">
