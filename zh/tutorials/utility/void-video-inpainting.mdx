...
**处理前**（左）— 原始视频中的滑雪者。**处理后**（右）— 移除滑雪者后的处理后的结果。VOID 在移除物体的同时保持了自然的运动、光照和画面连贯性。
...
### VOID: 视频修复 {#utility_void_video_inpainting}

上传视频并遮罩您想要移除的物体。生成一段干净的视频，其中物体及其物理交互已被删除。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/utility_void_video_inpainting-1.webp" alt="VOID 视频修复工作流预览" />

<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 中运行" icon="cloud" href="https://cloud.comfy.org/?template=utility_void_video_inpainting&utm_source=docs&utm_medium=referral&utm_campaign=void-video-inpainting">
    在 Comfy Cloud 中打开
  </Card>
  <Card title="下载工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/utility_void_video_inpainting.json">
    下载 JSON，或在模板库中搜索 &quot;VOID: Video Inpainting&quot;
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="snowboarder.mp4" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/snowboarder.mp4">
    `LoadVideo` 节点 4 · `snowboarder.mp4`
  </Card>
</CardGroup>
...
- [void_pass2.safetensors](https://huggingface.co/Comfy-Org/void-model/blob/main/diffusion_models/void_pass2.safetensors) — 精炼阶段，时间稳定性更佳
- [void_pass1.safetensors](https://huggingface.co/Comfy-Org/void-model/blob/main/diffusion_models/void_pass1.safetensors) — 主要阶段
