...
VOID（Video Object Inpainting and Deletion）是 Netflix 于 2026 年 5 月 14 日开源的一款强大的视频修复模型，基于 [CogVideoX](https://github.com/THUDM/CogVideo) 架构。它采用两阶段扩散 pipeline，能够从视频中移除物体并以时间连贯的内容填补空缺。
