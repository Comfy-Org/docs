...
SAM 3.1 在 ComfyUI 中获得原生支持（PR [#13408](https://github.com/Comfy-Org/ComfyUI/pull/13408)），模型权重基于 [Apache 2.0 协议](https://github.com/facebookresearch/sam3/blob/main/LICENSE) 发布。
