...
确保你的 `ComfyUI/models/checkpoints` 文件夹中至少有一个 SD1.5 模型文件，例如 [v1-5-pruned-emaonly-fp16.safetensors](https://huggingface.co/Comfy-Org/stable-diffusion-v1-5-archive/blob/main/v1-5-pruned-emaonly-fp16.safetensors)

如果你还没有安装，请参考[开始 ComfyUI 的 AI 绘图之旅](/zh/get_started/first_generation)中的模型安装部分说明。
...
![K 采样器](/images/comfy_core/sampling/k_sampler.png)
