...
<CardGroup cols={2}>
  <Card title="在云端试用" icon="cloud" href="https://cloud.comfy.org/?template=api_reve_image_create&utm_source=docs&utm_medium=inhouse_social&utm_campaign=reve_model_launch">
...
<CardGroup cols={2}>
  <Card title="在云端试用" icon="cloud" href="https://cloud.comfy.org/?template=api_reve_image_edit&utm_source=docs&utm_medium=inhouse_social&utm_campaign=reve_model_launch">
...
<CardGroup cols={2}>
  <Card title="在云端试用" icon="cloud" href="https://cloud.comfy.org/?template=api_reve_image_remix&utm_source=docs&utm_medium=inhouse_social&utm_campaign=reve_model_launch">
