...
### 文本转视频（Omni Flash） {#api_google_gemini_omni_flash_t2v}

使用预览版 Gemini Omni Flash 模型，从单条文本提示生成视频。在一条提示中描述场景、时长和画面比例，模型即可渲染出带原生音频轨道的视频片段。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/api_google_gemini_omni_flash_t2v-1.webp" alt="Gemini Omni Flash 文本转视频工作流预览" />
...
<CardGroup cols={2}>
  ...
  <Card title="下载工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_google_gemini_omni_flash_t2v.json">
    下载 JSON 或在模板库中搜索 "Gemini Omni"
  </Card>
</CardGroup>

<Note>
预览版 Omni Flash 模型计划于 2026 年 9 月 30 日退役。正式版请使用下方的 Omni Flash 1.1 工作流。
</Note>
