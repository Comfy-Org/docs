...
Stability AI Stable Diffusion 3.5 Image 节点允许你使用 Stability AI 的 Stable Diffusion 3.5 模型，通过文本提示词或参考图像创建高质量、细节丰富的图像内容。

在本指南中，我们将向你展示如何使用此节点设置文生图和图生图的工作流。
...
5. 点击 `Run` 按钮，或者使用快捷键 `Ctrl(cmd) + Enter` 来执行图像生成。
...
6. 点击 `Run` 按钮，或者使用快捷键 `Ctrl(cmd) + Enter` 来执行图像生成。
