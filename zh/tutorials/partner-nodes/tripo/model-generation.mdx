...
<CardGroup cols={1}>
  <Card title="下载 Json 格式工作流文件" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/tripo/api_tripo_text_to_model.json">
    文生模型工作流
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="下载 Json 格式工作流文件" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/tripo/image_to_model/api_tripo_image_to_model.json">
    图生模型工作流
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="下载 Json 格式工作流文件" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/tripo/multiview_to_image/api_tripo_multiview_to_model.json">
    多视图模型生成工作流
  </Card>
</CardGroup>
