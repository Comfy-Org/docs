...
[Luma Text to Video](/zh/built-in-nodes/partner-node/video/luma/luma-text-to-video) 节点允许你使用Luma AI的创新视频生成技术，通过文本描述创建高质量、流畅的视频内容。
...
<Card title="Luma Text to Video 节点文档" icon="book" href="/zh/built-in-nodes/partner-node/video/luma/luma-text-to-video">
