...
[Luma Image to Image](/zh/built-in-nodes/partner-node/image/luma/luma-image-to-image) 节点允许你使用Luma AI的技术根据文本提示词修改现有图像，同时保留原始图像的某些特征和结构。
...
<Card title="Luma Image to Image 节点文档" icon="book" href="/zh/built-in-nodes/partner-node/image/luma/luma-image-to-image">
