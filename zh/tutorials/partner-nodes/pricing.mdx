...
| BytePlus Video Generation With Audio (每百万 tokens) | generate_audio: false, model: seedance-1-5-pro-251215          | 253.2 / 百万 tokens  | Video  |
| BytePlus Video Generation With Audio (每百万 tokens) | generate_audio: true, model: seedance-1-5-pro-251215           | 506.4 / 百万 tokens  | Video  |
...
| BytePlus Video Generation Product (每千 tokens)   | model: dreamina-seedance-2-0, resolution: 1080P, video_type: text-to-video (无视频输入: 文本或图像)  | 5.281 / 千 tokens   | Video  |
| BytePlus Video Generation Product (每千 tokens)   | model: dreamina-seedance-2-0, resolution: 1080P, video_type: image-to-video (无视频输入: 文本或图像) | 5.281 / 千 tokens   | Video  |
| BytePlus Video Generation Product (每千 tokens)   | model: dreamina-seedance-2-0, resolution: 1080P, video_type: video-to-video (有视频输入)              | 3.243 / 千 tokens   | Video  |
...
| BytePlus Video Generation Product (每千 tokens)   | model: dreamina-seedance-2-0-fast, resolution: 1080P, video_type: text-to-video (无视频输入: 文本或图像) | 4.226 / 千 tokens   | Video  |
| BytePlus Video Generation Product (每千 tokens)   | model: dreamina-seedance-2-0-fast, resolution: 1080P, video_type: image-to-video (无视频输入: 文本或图像)| 4.226 / 千 tokens   | Video  |
| BytePlus Video Generation Product (每千 tokens)   | model: dreamina-seedance-2-0-fast, resolution: 1080P, video_type: video-to-video (有视频输入)             | 2.488 / 千 tokens   | Video  |

> **Seedance 2.0 token 计算方式：** 输出 tokens = (输入视频时长 + 输出视频时长) × 输出视频长度 × 输出视频宽度 × 输出视频帧率 ÷ 1024。当输入为文本、图像或音频时，输入时长计为 0。Seedance 2.0 的输出帧率为 24fps。对于视频转视频输入，存在最低 token 用量限制。**每千 token 积分**取决于输出分辨率：在相同模型和 `video_type` 下，**1080P 是 720P 费率的 2.5 倍**。**Seedance 2.0 Fast** 模型最高支持 1080P 输出；标准 **Seedance 2.0** 模型还额外支持 4K 输出。
...
| HappyHorse 视频生成产品       | 模型: happyhorse1.1, 分辨率: 720P, 视频类型: 文生视频               | 42.24/秒  | 视频 |
| HappyHorse 视频生成产品       | 模型: happyhorse1.1, 分辨率: 720P, 视频类型: 图生视频               | 42.24/秒  | 视频 |
| HappyHorse 视频生成产品       | 模型: happyhorse1.1, 分辨率: 720P, 视频类型: 参考生视频             | 42.24/秒  | 视频 |
| HappyHorse 视频生成产品       | 模型: happyhorse1.1, 分辨率: 1080P, 视频类型: 文生视频              | 54.31/秒  | 视频 |
| HappyHorse 视频生成产品       | 模型: happyhorse1.1, 分辨率: 1080P, 视频类型: 图生视频              | 54.31/秒  | 视频 |
| HappyHorse 视频生成产品       | 模型: happyhorse1.1, 分辨率: 1080P, 视频类型: 参考生视频            | 54.31/秒  | 视频 |
