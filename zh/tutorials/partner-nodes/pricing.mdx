...
| prod-v1-BFL Image Products | model: flux-tools/erase-v1  | 6.33 / run + 0.84 / 额外 MP | Image    |
| prod-v1-BFL Image Products | model: flux-tools/vto-v1    | 7.91 / run + 1.06 / 额外 MP | Image    |
