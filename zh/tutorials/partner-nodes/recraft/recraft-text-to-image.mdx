...
[Recraft Text to Image](/zh/built-in-nodes/partner-node/image/recraft/recraft-text-to-image) 节点允许你使用Recraft AI的图像生成技术，通过文本描述创建高质量、风格多样的图像内容。
...
- **Recraft Style**：提供多种预设风格，如真实照片、数字插画、Logo设计等
