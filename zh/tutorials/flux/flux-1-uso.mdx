...
<CardGroup cols={2}>
  <Card title="下载 JSON 工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux1_dev_uso_reference_image_gen.json">
    下载工作流 JSON 并将其拖拽到 ComfyUI 中
  </Card>
