...
translationSourceHash: ee954407
...
<CardGroup cols={3}>
  ...
  <Card title="方法二：WebSocket + History" icon="chart-line" href="#方法二websocket-+-history（监控执行完成）">
    **推荐。** 等待完成，然后下载结果。简单性和可靠性之间最佳平衡。
  </Card>
  <Card title="方法三：SaveImageWebsocket" icon="images" href="#方法三websocket-配合-saveimagewebsocket（实时获取图片）">
