...
- 确保你的 ComfyUI 版本 >= [PR #8041](https://github.com/Comfy-Org/ComfyUI/pull/8041)
- 对应账户的 [API Key](/zh/development/api-development/getting-an-api-key)
- 足够的账户积分

使用 API Key 来调用 ComfyUI 内置的 API 节点需要先在 [ComfyUI Platform](https://platform.comfy.org/login) 上注册一个账户，然后[创建 API key](/zh/development/api-development/getting-an-api-key)

<Card title="使用 API Key 进行登录" icon="link" href="/zh/interface/user#使用-api-key-进行登录">
...
- API 节点概述: https://docs.comfy.org/zh/tutorials/partner-nodes/overview
...
- [API节点概述](https://docs.comfy.org/zh/tutorials/partner-nodes/overview)
