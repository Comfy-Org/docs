---
title: "ComfyUI 服务器路由（HTTP 和 WebSocket API）"
description: "ComfyUI Server API 路由：内置 GET、POST 和 WebSocket 端点，涵盖 prompt、队列、历史、模型和用户数据，以及如何添加自定义路由。"
icon: "route"
