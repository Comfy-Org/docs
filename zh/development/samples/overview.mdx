...
<div className="sample-card-grid">
  <div className="sample-card" data-sample-card="true">
    <div className="sample-card-inner">
      <div className="sample-card-face sample-card-front" data-sample-front="true">
        <img src="/images/samples/img2img-web-app.svg" alt="图生图网页应用的预览" className="sample-card-preview" data-sample-preview="api" noZoom="true" />
  ...
  <div className="sample-card" data-sample-card="true">
    <div className="sample-card-inner">
      <div className="sample-card-face sample-card-front" data-sample-front="true">
        <img src="/images/samples/sketch-to-image.svg" alt="草图生图应用的预览" className="sample-card-preview" data-sample-preview="api" noZoom="true" />
        <div className="sample-card-body">
  ...
  <div className="sample-card" data-sample-card="true">
    <div className="sample-card-inner">
      <div className="sample-card-face sample-card-front" data-sample-front="true">
        <img src="/images/samples/discord-image-bot.svg" alt="Discord 图像机器人的预览" className="sample-card-preview" data-sample-preview="api" noZoom="true" />
        <div className="sample-card-body">
