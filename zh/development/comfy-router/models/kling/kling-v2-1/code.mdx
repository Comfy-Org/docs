...
Generated from the schema Router serves at `GET /v2/models/kling/kling-v2-1/openapi.json`, the same document it validates a call against before the request reaches the provider。
### 输出
