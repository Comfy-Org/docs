...
- **Runware**，即 `runware/runware-nano-banana-2`：`POST https://api.comfy.org/v2/models/vertexai/gemini-3.1-flash-image?model_provider=runware`
- **WaveSpeed**，即 `wavespeed/wavespeed-nano-banana-2`：`POST https://api.comfy.org/v2/models/vertexai/gemini-3.1-flash-image?model_provider=wavespeed`
