...
translationBlockHashes:
  ...
  "Examples": 67e6c8f1
---
{/* 已生成文件。由 `pnpm code-pages:gen` 从 router-schemas/openai/o1.json 生成。 */}
...
由 Router 在 `GET /v2/models/openai/o1/openapi.json` 提供的 schema 生成，请求到达提供商之前，Router 会依据同一份文档校验调用。### 输出
