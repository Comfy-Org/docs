...
注意：Seedance 2.0 和 2.0 fast 不支持 1080p。Seedance 2.5 支持 480p、720p 和 1080p。
  ...
  可能的值：`480p`、`720p`、`1080p`、`4k`</ParamField>
...
由 Router 在 `GET /v2/models/byteplus/dreamina-seedance-2-0-260128/openapi.json` 提供的 schema 生成，该文档也是请求到达提供商之前 Router 用于校验调用的同一份文档。### 输出
