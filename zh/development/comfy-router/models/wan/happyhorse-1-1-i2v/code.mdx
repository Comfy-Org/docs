...
<ParamField body="input.media" type="object[]">
  适用于 wan2.7、wan3.0 和 happyhorse-1.x 模型的媒体资产列表。用于指定视频生成的参考素材（图像、音频、视频）。
...
生成自 Router 在 `GET /v2/models/wan/happyhorse-1.1-i2v/openapi.json` 提供的 schema,该文档也是请求到达提供商之前 Router 用于校验调用的同一文档。
### 输出
