...
没有进度事件、webhook 或优先级等级：跟踪请求的方式就是状态路由。[API 参考](/zh/development/comfy-router/reference#endpoints) 包含每个路由的完整约定。
...
<CardGroup cols={2}>
  ...
  <Card title="API 参考" icon="book" href="/zh/development/comfy-router/reference#endpoints">
    四个队列路由，逐字段说明。
  </Card>
</CardGroup>
