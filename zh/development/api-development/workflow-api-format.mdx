...
2. 通过 `文件 → 导出工作流 (API)` 导出

---

## 相关页面

- [运行工作流](/zh/development/run-workflows/overview)：比较 API 和部署选项
- [Cloud API 概述](/zh/development/cloud/overview)：向 Comfy Cloud 提交 API 格式的工作流
- [API 示例](/zh/development/comfyui-server/api-examples)：查看 API 格式工作流的实际运行效果
- [获取 API 密钥](/zh/development/api-development/getting-an-api-key)：Cloud API 和合作节点所需
