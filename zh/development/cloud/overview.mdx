...
这也是 SDK 的默认目标，因此使用 Comfy Cloud 时无需对其进行配置。若要将同一代码指向 Comfy API 部署或你自己的 ComfyUI，请设置 `COMFY_BASE_URL`。请参阅[选择基础 URL](/zh/development/api-development/sdks#选择基础-url)。
