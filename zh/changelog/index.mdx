...
**合作伙伴节点更新**
* [**GPT-6 Astra**](https://github.com/Comfy-Org/ComfyUI/pull/16125)：为 OpenAI Chat 节点添加了 `gpt-6-astra` 模型，并支持推理努力级别

**合作伙伴节点移除**
* [**退役模型**](https://github.com/Comfy-Org/ComfyUI/pull/16121)：移除了供应商已关停的模型所对应的节点：OpenAI DALL·E 2 和 DALL·E 3、LTX-2（Fast 和 Pro）、Seedream 3.0、Seedance 1.0 Lite、Kling 视频扩展节点，以及字节跳动参考图像转视频节点。
