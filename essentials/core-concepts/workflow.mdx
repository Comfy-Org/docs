...
In the context of ComfyUI, the term **_workflow_** is a synonym for the node network or graph. It corresponds to the **_scene graph_** in a 3D or multimedia program: the network of all of the nodes within a particular disk file. 3D programs call this a **_scene file_**_._ Video editing, compositing, and multimedia programs usually call it a **_project file_**.
