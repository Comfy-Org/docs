...
These three steps are below. Once you know how to add an extension, you may wish to look 
through the [hooks](javacript_hooks) available to get your code called, 
a description of various [Comfy objects](javascript_objects_and_hijacking) you might need,
or the [example code snippets](javascript_examples).
