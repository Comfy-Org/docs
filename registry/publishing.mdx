...
<Note>
  **Important:** This API key is specifically for **publishing custom nodes to the Registry**. If you're looking to use paid API nodes in your workflows instead, see [API Nodes Overview](/tutorials/api-nodes/overview).
</Note>

Go [here](https://registry.comfy.org/nodes) and click on the publisher you want to create an API key for. This key will be used to publish custom nodes via the CLI or GitHub Actions. 
