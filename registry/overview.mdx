...
<Warning>You might encounter this error: {'Failed to publish node version: 400 {"message":"Invalid personal access token"}\n'}

This may be when copy-pasting, your API key might have an additional \x16 at the back when using CTRL+V (for Windows), eg:************************************************\x16. 

It is recommended to copy-paste your API key via right-clicking instead.</Warning>
