...
이미 ComfyUI를 대규모로 운영 중인 사용자들에게 물어봤을 때, 수요는 바로 그 두 언어에 있었습니다. 두 SDK 모두 동일한 문서화된 HTTP 계약을 기반으로 하므로, 현재 어떤 언어에서든 API와 통신할 수 있습니다. 다른 언어의 공식 SDK를 원하신다면 [저희 Discord](https://discord.com/invite/comfyorg)의 `#developer-platform` 채널에서 알려주세요.
