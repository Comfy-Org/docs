...
**이식성.** 로컬 ComfyUI, Comfy Cloud, 그리고 서버리스 배포에서도 동일한 동작을 보장합니다. 동일한 코드, 다른 base URL입니다.
...
| **실행 환경** | Comfy Cloud, 서버리스 배포 및 자체 호스팅 ComfyUI, 동일한 규약 | Cloud API와 ComfyUI Server API는 다름 |
