...
<Frame caption="ComfyUI 프론트엔드에서 API 형식으로 워크플로 내보내기">
  <img src="/images/development/export_workflow_api_format.png" alt="API 형식으로 워크플로 저장" />
</Frame>
...
- [워크플로 실행](/ko/development/run-workflows/overview): API 및 배포 옵션 비교
...
- [API 키 얻기](/ko/development/api-development/getting-an-api-key): Cloud API 및 파트너 노드에 필수
