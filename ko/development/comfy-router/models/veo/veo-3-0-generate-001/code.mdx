...
Router가 `GET /v2/models/veo/veo-3.0-generate-001/openapi.json`에서 제공하는 스키마를 기반으로 생성되었습니다. 이 문서는 요청이 공급자에 도달하기 이전에 Router가 호출을 검증할 때 기준으로 삼는 것과 동일한 문서입니다.### 출력
