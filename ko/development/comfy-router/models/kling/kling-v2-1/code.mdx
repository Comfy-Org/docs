...
translationBlockHashes:
  ...
  "Examples": e835e733
---
{/* 생성된 파일. router-schemas/kling/kling-v2-1.json에서 `pnpm code-pages:gen`으로 생성되었습니다. */}
...
Router가 `GET /v2/models/kling/kling-v2-1/openapi.json`에서 제공하는 스키마에서 생성되었으며, 이는 요청이 공급자에게 도달하기 전에 호출을 검증하는 데 사용하는 것과 동일한 문서입니다.### 출력
