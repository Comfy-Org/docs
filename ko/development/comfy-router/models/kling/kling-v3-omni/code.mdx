...
translationBlockHashes:
  ...
  "Examples": d0ddb30c
---
{/* 생성된 파일. `pnpm code-pages:gen`이 router-schemas/kling/kling-v3-omni.json에서 생성했습니다. */}
...
Router가 `GET /v2/models/kling/kling-v3-omni/openapi.json`에서 제공하는 스키마를 기반으로 생성되었으며, 이는 요청이 공급자에 도달하기 전에 호출을 검증하는 데 사용하는 것과 동일한 문서입니다.### 출력
