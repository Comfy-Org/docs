...
translationBlockHashes:
  ...
  "Examples": 14429ff8
---
{/* 생성된 파일. `pnpm code-pages:gen`에 의해 router-schemas/kling/kling-v1-6.json에서 생성됨. */}
...
`GET /v2/models/kling/kling-v1-6/openapi.json`에서 Router가 제공하는 스키마에서 생성되었으며, 이는 요청이 공급자에게 도달하기 전에 호출을 검증하는 데 사용하는 동일한 문서입니다.### 출력
