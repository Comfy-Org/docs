...
translationBlockHashes:
  ...
  "Examples": e420aca1
---
{/* 생성된 파일. `pnpm code-pages:gen`에 의해 router-schemas/wan/wan2.5-t2i-preview.json에서 생성되었습니다. */}
...
[Comfy 워크스페이스](https://platform.comfy.org/profile/api-keys)에서 키를 생성한 뒤 `COMFY_API_KEY`로 내보내세요. Python, TypeScript, Swift 스니펫은 Comfy SDK(`pip install comfy-sdk`, `npm install @comfyorg/sdk`, 그리고 [`ComfySwiftSDK`](https://github.com/Comfy-Org/comfy-swift-sdk) Swift 패키지)를 사용하며, cURL 스니펫은 동일한 호출을 raw HTTP로 전송합니다.
