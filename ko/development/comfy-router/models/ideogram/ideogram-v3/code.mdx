...
[Comfy 워크스페이스](https://platform.comfy.org/profile/api-keys?onboarding=router)에서 키를 생성하고 `COMFY_API_KEY`로 내보내세요. Python 및 TypeScript 스니펫은 Comfy SDK를 사용하며(`pip install comfy-sdk` 및 `npm install @comfyorg/sdk`), cURL 스니펫은 원시 HTTP를 통한 동일한 호출입니다.
