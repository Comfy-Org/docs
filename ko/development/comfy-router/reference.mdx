...
표 설명은 간략합니다. 모델 선택, 검증, 재시도, 결제에 대해서는 [Comfy Router API 사용하기](/ko/development/comfy-router/quickstart)를, 헤더 동작에 대해서는 [헤더](/ko/development/comfy-router/headers)를 참고하세요.
