...
<Warning>
  **지원 중단됨:** v1 Cloud API는 [Comfy API v2](/ko/api-reference/v2/overview)로 대체되어 지원이 중단되었습니다. 엔드포인트, 요청/응답 형식 및 동작은 사전 통지 없이 수정될 수 있습니다.
</Warning>
...
메시지 유형 및 처리 방법은 [API 참조](/ko/development/cloud/api-reference#실시간-진행-상황을-위한-websocket)를 참조하세요.