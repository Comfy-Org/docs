---
title: "ComfyUI 서버 메시지 (WebSocket API)"
description: "ComfyUI PromptExecutor가 WebSocket으로 클라이언트에 메시지를 보내는 방식. execution_start, progress 등 내장 메시지 타입과 커스텀 메시지 타입 등록 방법을 설명합니다."
icon: "comment"
