...
description: "EmptyLatentAudio 노드는 오디오 처리를 위한 빈 잠재 텐서를 생성합니다. 지정된 지속 시간과 배치 크기를 가진 빈 오디오 잠재 표현을 생성하며, 이는 오디오 생성 또는 처리 워크플로우의 시작점으로 사용할 수 있습니다. 이 노드는 오디오 지속 시간과 샘플 속도를 기반으로 적절한 잠재 차원을 자동으로 계산합니다."
