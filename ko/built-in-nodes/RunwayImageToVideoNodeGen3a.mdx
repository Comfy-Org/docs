...
description: "Runway 이미지-투-비디오(Gen3a Turbo) 노드는 Runway의 Gen3a Turbo 모델을 사용하여 단일 시작 프레임에서 비디오를 생성합니다. 텍스트 프롬프트와 초기 이미지 프레임을 입력받아 지정된 지속 시간과 화면 비율에 따라 비디오 시퀀스를 생성합니다. 이 노드는 Runway의 API에 연결하여 원격으로"
