...
description: "SamplerLCMUpscale 노드는 잠재 일관성 모델(LCM) 샘플링과 이미지 업스케일링 기능을 결합한 특수 샘플링 방법을 제공합니다. 다양한 보간 방법을 사용하여 샘플링 과정 중에 이미지를 업스케일링할 수 있으므로, 이미지 품질을 유지하면서 더 높은 해상도의 출력물을 생성하는 데 유용합니다."
