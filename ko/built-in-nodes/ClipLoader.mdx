...
description: "CLIPLoader 노드는 텍스트 인코더 모델(CLIP, T5 또는 이와 유사한 모델)을 파일에서 로드하여, 텍스트 프롬프트를 수치 표현으로 변환해야 하는 다른 노드에서 사용할 수 있도록 제공합니다. 다양한 모델 아키텍처를 지원하며, 각 아키텍처에는 특정 인코더 유형이 필요합니다."
