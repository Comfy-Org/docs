...
description: "TrimVideoLatent 노드는 비디오 잠재 표현의 시작 부분에서 프레임을 제거합니다. 잠재 비디오 샘플을 입력받아 지정된 수의 프레임을 앞에서 잘라내고, 남은 비디오 부분을 반환합니다. 이를 통해 초기 프레임을 제거하여 비디오 시퀀스를 단축할 수 있습니다."
