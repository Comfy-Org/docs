...
description: "LoraModelLoader 노드는 학습된 LoRA(Low-Rank Adaptation) 가중치를 확산 모델에 적용합니다. 학습된 LoRA 모델에서 가중치를 불러오고 영향 강도를 조정하여 기본 모델을 수정합니다. 이를 통해 확산 모델을 처음부터 다시 학습시키지 않고도 동작을 사용자 지정할 수 있습니다."
