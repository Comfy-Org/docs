...
description: "PerturbedAttentionGuidance 노드는 확산 모델에 교란된 주의 유도(perturbed attention guidance)를 적용하여 생성 품질을 향상시킵니다. 샘플링 과정에서 모델의 자체 주의 메커니즘을 값 투영에 초점을 맞춘 단순화된 버전으로 대체하여 작동합니다. 이 기법은 조건부 잡음 제거 과"
