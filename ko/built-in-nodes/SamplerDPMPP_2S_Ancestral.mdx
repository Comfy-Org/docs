...
description: "SamplerDPMPP2SAncestral 노드는 DPM++ 2S Ancestral 샘플링 방식을 사용하여 이미지를 생성하는 샘플러를 생성합니다. 이 샘플러는 결정론적 요소와 확률적 요소를 결합하여 일관성을 유지하면서도 다양한 결과를 생성합니다. 샘플링 과정 중 무작위성과 노이즈 수준을 제어할 수 있습니다."
