...
description: "ConditioningStableAudio 노드는 오디오 생성을 위해 긍정 및 부정 조건 입력에 타이밍 정보를 추가합니다. 이 노드는 시작 시간과 전체 지속 시간 매개변수를 설정하여 오디오 콘텐츠가 생성되어야 하는 시점과 지속 시간을 제어합니다. 오디오 특화 타이밍 메타데이터를 추가하여 기존 조건 데이터를 수정합니다."
