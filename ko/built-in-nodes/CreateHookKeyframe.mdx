...
description: "Create Hook Keyframe 노드는 생성 과정에서 후크 동작이 변경되는 특정 지점을 정의할 수 있게 해줍니다. 이 노드는 생성 진행률의 특정 백분율 지점에서 후크 강도를 수정하는 키프레임을 생성하며, 이러한 키프레임들을 연결하여 복잡한 스케줄링 패턴을 만들 수 있습니다."
