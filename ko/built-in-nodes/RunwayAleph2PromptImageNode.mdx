...
description: "이 노드는 가이드 이미지를 출력 비디오의 특정 시점에 고정하여, 해당 지점에서 편집된 비디오의 모습을 제어합니다. 이 노드를 Runway Aleph2 비디오 투 비디오 노드의 promptimages 입력에 연결하고, 선택적 promptimages 입력을 사용하여 여러 개(최대 5개)를 함께 체인으로 연결할 수"
