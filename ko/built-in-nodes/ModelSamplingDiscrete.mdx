...
description: "이 노드는 이산 샘플링 전략을 적용하여 모델의 샘플링 동작을 수정하도록 설계되었습니다. epsilon, vprediction, lcm 또는 x0과 같은 다양한 샘플링 방법을 선택할 수 있으며, 선택적으로 제로샷 노이즈 비율(zsnr) 설정에 따라 모델의 노이즈 감소 전략을 조정합니다."
