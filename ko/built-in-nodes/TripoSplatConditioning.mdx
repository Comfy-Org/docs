...
description: "이 노드는 DINOv3와 Flux2 VAE를 사용하여 입력 이미지를 인코딩함으로써 TripoSpat 모델을 위한 긍정 및 부정 조건부 데이터를 생성합니다. 또한 KSampler의 시작점 역할을 하는 고정 크기의 노이즈 대상(잠재 변수 및 카메라 데이터)을 생성합니다."
