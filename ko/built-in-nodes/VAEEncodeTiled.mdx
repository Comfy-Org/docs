...
description: "VAEEncodeTiled 노드는 이미지를 더 작은 타일로 분할하고 Variational Autoencoder를 사용하여 인코딩합니다. 이 타일 방식은 메모리 제한을 초과할 수 있는 대형 이미지를 처리할 수 있게 해줍니다. 이 노드는 이미지 및 비디오 VAE를 모두 지원하며, 공간 및 시간 차원에 대한 별도의 타일링 제어"
