...
description: "BerniniConditioning 노드는 Wan2.2-A14B 모델을 위한 비디오 및 이미지 컨디셔닝 데이터를 준비합니다. 제공된 VAE를 사용하여 소스 비디오, 참조 비디오 및 참조 이미지를 인코딩한 후, 이를 컨텍스트 내 토큰으로 컨디셔닝 데이터에 첨부합니다. 작업은 연결된 입력에서 자동으로 유추됩니다."
