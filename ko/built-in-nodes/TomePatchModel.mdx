...
description: "TomePatchModel 노드는 확산 모델에 토큰 병합(ToMe)을 적용하여 추론 중 계산 요구 사항을 줄입니다. 이는 어텐션 메커니즘에서 유사한 토큰을 선택적으로 병합하여 이미지 품질을 유지하면서 모델이 더 적은 토큰을 처리할 수 있도록 합니다. 이 기술은 품질 저하 없이 생성 속도를 높이는 데 도움을 줍니다."
