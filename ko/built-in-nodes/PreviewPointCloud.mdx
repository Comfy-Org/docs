...
description: "Preview Point Cloud 노드는 ComfyUI 인터페이스 내에서 3D 포인트 클라우드 파일을 볼 수 있도록 합니다. 포인트 클라우드를 임시 파일로 저장하고 3D 미리보기 창에 표시하며, 모델 데이터와 뷰포트 설정을 추가 처리할 수 있도록 전달합니다."
