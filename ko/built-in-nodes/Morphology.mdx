...
description: "형태학 노드는 이미지에 다양한 형태학적 연산을 적용합니다. 형태학적 연산은 이미지의 형태를 처리하고 분석하는 데 사용되는 수학적 연산입니다. 이 노드는 침식, 팽창, 열기, 닫기 등의 연산을 사용자 정의 가능한 커널 크기로 수행하여 효과 강도를 제어할 수 있습니다."
