...
description: "CLIPTextEncodeControlnet 노드는 CLIP 모델을 사용하여 텍스트 입력을 처리하고, 이를 기존 컨디셔닝 데이터와 결합하여 컨트롤넷 애플리케이션을 위한 향상된 컨디셔닝 출력을 생성합니다. 입력 텍스트를 토큰화하고 CLIP 모델을 통해 인코딩한 후, 결과 임베딩을 제공된 컨디셔닝 데이터에 크로스 어텐션 컨트"
