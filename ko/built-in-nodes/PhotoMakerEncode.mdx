...
description: "PhotoMakerEncode 노드는 이미지와 텍스트를 처리하여 AI 이미지 생성을 위한 컨디셔닝 데이터를 생성합니다. 참조 이미지와 텍스트 프롬프트를 입력받아, 참조 이미지의 시각적 특성을 기반으로 이미지 생성을 안내하는 임베딩을 생성합니다. 이 노드는 텍스트에서 \"photomaker\" 토큰을 찾아 이미지 기반 컨디셔닝"
