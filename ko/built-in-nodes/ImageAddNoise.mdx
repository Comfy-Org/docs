...
description: "ImageAddNoise 노드는 입력 이미지에 무작위 노이즈를 추가합니다. 지정된 난수 시드를 사용하여 일관된 노이즈 패턴을 생성하고, 노이즈 효과의 강도를 제어할 수 있습니다. 결과 이미지는 입력 이미지와 동일한 크기를 유지하지만 시각적 텍스처가 추가됩니다."
