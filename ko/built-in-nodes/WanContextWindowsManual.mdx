...
description: "WAN 컨텍스트 윈도우(수동) 노드는 2차원 처리를 수행하는 WAN 계열 모델의 컨텍스트 윈도우를 수동으로 구성할 수 있게 해줍니다. 윈도우 길이, 중첩, 스케줄링 방식 및 융합 기법을 지정하여 샘플링 중에 사용자 정의 컨텍스트 윈도우 설정을 적용합니다. 이를 통해 모델이 서로 다른 컨텍스트 영역에서 정보를 처리하는 방식"
