...
description: "LatentOperationSharpen 노드는 가우시안 커널을 사용하여 잠재 표현에 선명화 효과를 적용합니다. 잠재 데이터를 정규화하고, 사용자 정의 선명화 커널로 컨볼루션을 적용한 후 원래 휘도를 복원하는 방식으로 작동합니다. 이를 통해 잠재 공간 표현의 세부 사항과 가장자리가 향상됩니다."
