...
description: "이 노드는 ComfyUI/models/checkpoints 폴더에 있는 모델을 감지하며, extramodelpaths.yaml 파일에 구성된 추가 경로의 모델도 읽어옵니다. 때로는 ComfyUI 인터페이스를 새로고침하여 해당 폴더에서 모델 파일을 읽도록 해야 할 수도 있습니다."
