...
description: "RecordAudio 노드는 오디오 녹음 인터페이스를 통해 녹음되거나 선택된 오디오 파일을 불러옵니다. 이 노드는 오디오 파일을 처리하여 워크플로우의 다른 오디오 처리 노드에서 사용할 수 있는 파형 형식으로 변환합니다. 샘플 속도를 자동으로 감지하고 추가 조작을 위해 오디오 데이터를 준비합니다."
