...
description: "WanFirstLastFrameToVideo 노드는 시작 프레임과 종료 프레임을 텍스트 프롬프트와 결합하여 비디오 컨디셔닝을 생성합니다. 첫 번째 프레임과 마지막 프레임을 인코딩하고, 생성 과정을 안내하는 마스크를 적용하며, 사용 가능한 경우 CLIP 비전 특징을 통합하여 비디오 생성을 위한 잠재 표현을 생성합니다. 이"
