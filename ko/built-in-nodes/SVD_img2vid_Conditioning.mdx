...
description: "SVDimg2vidConditioning 노드는 Stable Video Diffusion을 사용한 비디오 생성을 위한 컨디셔닝 데이터를 준비합니다. 초기 이미지를 입력받아 CLIP 비전 및 VAE 인코더를 통해 처리하여 포지티브 및 네거티브 컨디셔닝 쌍과 비디오 생성을 위한 빈 잠재 공간을 생성합니다. 이 노드는 생성"
