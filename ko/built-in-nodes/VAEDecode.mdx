...
description: "VAEDecode 노드는 지정된 Variational Autoencoder(VAE)를 사용하여 잠재 표현을 이미지로 디코딩하도록 설계되었습니다. 이 노드는 압축된 데이터 표현에서 이미지를 생성하고, 잠재 공간 인코딩으로부터 이미지를 재구성하는 역할을 수행합니다."
