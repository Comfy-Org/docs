...
description: "SamplingPercentToSigma 노드는 샘플링 백분율 값을 모델의 샘플링 매개변수를 사용하여 해당 시그마 값으로 변환합니다. 0.0에서 1.0 사이의 백분율 값을 입력받아 모델의 노이즈 스케줄에서 적절한 시그마 값으로 매핑하며, 경계값에서 계산된 시그마 또는 실제 최대/최소 시그마 값을 반환하는 옵션을 제공합니다"
