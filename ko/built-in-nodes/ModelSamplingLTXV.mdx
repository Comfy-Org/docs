...
description: "ModelSamplingLTXV 노드는 토큰 수를 기반으로 모델에 고급 샘플링 매개변수를 적용합니다. 기본 시프트 값과 최대 시프트 값 사이의 선형 보간을 사용하여 시프트 값을 계산하며, 이 계산은 입력 잠재 변수의 토큰 수에 따라 달라집니다. 그런 다음 노드는 특수화된 모델 샘플링 구성을 생성하여 입력 모델에 적용합니다"
