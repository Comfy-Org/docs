...
description: "HunyuanVideo15SuperResolution 노드는 비디오 초고해상도 프로세스를 위한 컨디셔닝 데이터를 준비합니다. 비디오의 잠재 표현과 선택적으로 시작 이미지를 입력받아 노이즈 증강 및 CLIP 비전 데이터와 함께 패키징하여 모델이 더 높은 해상도의 출력을 생성하는 데 사용할 수 있는 형식으로 변환합니다."
