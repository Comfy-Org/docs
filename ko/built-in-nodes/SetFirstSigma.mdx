...
description: "SetFirstSigma 노드는 시그마 값 시퀀스의 첫 번째 시그마 값을 사용자 지정 값으로 대체하여 수정합니다. 기존 시그마 시퀀스와 새 시그마 값을 입력으로 받아, 첫 번째 요소만 변경되고 나머지 시그마 값은 그대로 유지된 새 시그마 시퀀스를 반환합니다."
