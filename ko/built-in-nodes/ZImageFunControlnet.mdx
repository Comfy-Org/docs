...
description: "ZImageFunControlnet 노드는 특수화된 제어 네트워크를 적용하여 이미지 생성 또는 편집 과정에 영향을 줍니다. 기본 모델, 모델 패치 및 VAE를 사용하며, 제어 효과의 강도를 조정할 수 있습니다. 이 노드는 기본 이미지, 인페인팅 이미지 및 마스크와 함께 작동하여 보다 정밀한 편집이 가능합니다."
