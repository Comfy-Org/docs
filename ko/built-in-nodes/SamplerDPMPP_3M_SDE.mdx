...
description: "SamplerDPMPP3MSDE 노드는 샘플링 과정에서 사용할 DPM++ 3M SDE 샘플러를 생성합니다. 이 샘플러는 구성 가능한 노이즈 매개변수를 사용하는 3차 다단계 확률적 미분 방정식 방법을 활용합니다. 노드를 통해 노이즈 계산을 GPU 또는 CPU에서 수행할지 선택할 수 있습니다."
