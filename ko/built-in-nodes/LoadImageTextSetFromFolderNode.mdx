...
description: "지정된 디렉토리에서 학습용 이미지 배치와 해당 이미지의 텍스트 캡션을 로드합니다. 이 노드는 자동으로 이미지 파일과 연결된 캡션 텍스트 파일을 검색하고, 지정된 크기 조정 설정에 따라 이미지를 처리한 후 제공된 CLIP 모델을 사용하여 캡션을 인코딩합니다."
