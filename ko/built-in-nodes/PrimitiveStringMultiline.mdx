...
description: "PrimitiveStringMultiline 노드는 여러 줄의 텍스트 입력 필드를 제공하여 워크플로우에서 문자열 값을 입력하고 전달할 수 있도록 합니다. 이 노드는 여러 줄에 걸친 텍스트 입력을 받아들이고, 동일한 문자열 값을 변경 없이 출력합니다. 긴 텍스트 콘텐츠나 여러 줄로 구성된 서식 있는 텍스트를 입력해야 할 때"
