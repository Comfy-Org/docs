...
description: "이 노드는 Luma Ray 3.2를 사용하여 기존 비디오를 새로운 프롬프트로 다시 렌더링하며, 원본 움직임을 유지하면서 스타일 변경, 조명 변경, 요소 추가 또는 제거를 할 수 있습니다. 소스 비디오는 최대 18초까지 가능하며, 편집된 비디오는 소스의 원본 길이를 유지합니다."
