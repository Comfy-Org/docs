...
description: "LatentBlend 노드는 두 개의 잠재 샘플을 지정된 혼합 비율로 결합합니다. 두 개의 잠재 입력을 받아 첫 번째 샘플에는 혼합 비율을, 두 번째 샘플에는 역비율을 적용하여 새로운 출력을 생성합니다. 입력 샘플의 형태가 다른 경우, 두 번째 샘플이 첫 번째 샘플의 크기에 맞게 자동으로 조정됩니다."
