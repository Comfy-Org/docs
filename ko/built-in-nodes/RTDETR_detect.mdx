...
description: "RT-DETR 탐지 노드는 RT-DETR 모델을 사용하여 입력 이미지에서 객체 탐지를 수행합니다. 객체를 식별하고, 주변에 경계 상자를 그린 후 COCO 데이터셋 클래스에 따라 레이블을 지정합니다. 신뢰도 점수, 객체 클래스별로 결과를 필터링할 수 있으며, 탐지 결과의 총 개수를 제한할 수도 있습니다."
