...
description: "Get Video Components 노드는 비디오 파일에서 모든 주요 구성 요소를 추출합니다. 비디오를 개별 프레임으로 분리하고, 오디오 트랙을 추출하며, 비디오의 프레임 속도 정보를 제공합니다. 이를 통해 각 구성 요소를 독립적으로 사용하여 추가 처리 또는 분석을 수행할 수 있습니다."
