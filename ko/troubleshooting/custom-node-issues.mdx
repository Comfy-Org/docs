...
![설정 메뉴 - 맞춤형 노드 비활성화](/images/troubleshooting/desktop-diable-custom-node.jpg)
또는 서버를 수동으로 실행하세요:
```bash
...
![맞춤형 노드 유형](/images/troubleshooting/custom_node_type.jpg)
...
<Tabs>
   <Tab title="프론트엔드 확장 기능이 있는 맞춤형 노드">
...
<Steps>
  <Step title="이진 탐색을 이용해 맞춤형 노드 찾기">
