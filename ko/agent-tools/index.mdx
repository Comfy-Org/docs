...
<Note>
  **Comfy Cloud MCP는 퍼블릭 베타입니다.** 설정, 피드백 채널 및 관련 도구(Comfy Skills, Comfy CLI)에 대한 내용은 [Comfy Cloud MCP](/ko/mcp) 페이지에서 확인하세요.
</Note>

<CardGroup cols={2}>
  <Card title="Comfy Cloud MCP" icon="cloud" href="/ko/mcp">
  ...
  <Card title="Comfy CLI" icon="terminal" href="/ko/cli">
...
**채팅 대신 터미널 워크플로를 원하시나요?** 스크립트 및 자동화를 위해 [Comfy CLI](/ko/cli)(`comfy generate`, 베타)를 참조하세요. 터미널에서 로컬 ComfyUI를 설치하고 시작하려면 [Comfy CLI 시작하기](/ko/comfy-cli/getting-started)부터 시작하세요.
