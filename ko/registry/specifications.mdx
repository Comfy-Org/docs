...
description: "ComfyUI 커스텀 노드 pyproject.toml 전체 사양. [project]와 [tool.comfy] 섹션, 필수 필드, 버전 관리, 완전한 예제를 포함합니다."
...
<Tip>게시된 아카이브에서 파일을 제외하려면(‘includes’의 반대), 게시 페이지의 [`.comfyignore`](/ko/registry/publishing#comfyignore로-파일-제외하기)를 참조하세요.</Tip>
