...
### Gemma4: 텍스트 생성 (`llm_gemma4_text_gen`)

텍스트 프롬프트와 선택적으로 이미지, 오디오 또는 비디오를 입력할 수 있습니다. 구성 가능한 추론, 코딩 및 다국어 지원을 통해 텍스트 출력을 생성합니다.

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/llm_gemma4_text_gen-1.webp" alt="Gemma4 텍스트 생성 워크플로 미리보기" />
...
<CardGroup cols={2}>
  ...
  <Card title="워크플로 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/llm_gemma4_text_gen.json">
    JSON을 다운로드하거나 템플릿 라이브러리에서 &quot;Gemma4: 텍스트 생성&quot;을 검색하세요.
  </Card>
</CardGroup>

**Input materials**

일치하는 노드에 이 선택적 파일들을 업로드하세요:
...
<CardGroup cols={2}>
  <Card title="the_lily_veil.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/the_lily_veil.png">
    `LoadImage` 노드 2 · `the_lily_veil.png`
  </Card>
  ...
  <Card title="video_wan_vace_inpainting_input_video.mp4" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/video_wan_vace_inpainting_input_video.mp4">
    `LoadVideo` 노드 6 · `video_wan_vace_inpainting_input_video.mp4`
  </Card>
</CardGroup>

이 워크플로는 Gemma4의 핵심 **텍스트 생성** 기능을 보여줍니다. 텍스트 프롬프트와 함께 추가적인 컨텍스트로 이미지, 오디오 파일 또는 비디오를 선택할 수 있으며, 자연어 출력을 생성합니다 — 추론, 코딩 및 다국어 프롬프트를 지원합니다.
