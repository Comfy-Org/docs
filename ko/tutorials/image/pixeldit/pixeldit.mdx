...
translationSourceHash: 09a57073
...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_pixeldit_t2i-1.webp" alt="PixelDiT 텍스트-to-이미지 워크플로우" />
...
<CardGroup cols={1}>
  <Card title="워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_pixeldit_t2i.json">
    JSON 파일 다운로드 또는 템플릿 라이브러리에서 'PixelDiT' 검색
  </Card>
</CardGroup>
