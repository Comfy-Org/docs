...
<CardGroup cols={1}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=image_omnigen2_t2i&utm_source=docs">
    Comfy Cloud에서 실행
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=image_omnigen2_image_edit&utm_source=docs">
    Comfy Cloud에서 실행
  </Card>
</CardGroup>
