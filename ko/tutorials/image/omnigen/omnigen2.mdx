...
<CardGroup cols={1}>
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=image_omnigen2_t2i&utm_source=docs">
...
<CardGroup cols={1}>
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=image_omnigen2_image_edit&utm_source=docs">
    Open and run this workflow directly in Comfy Cloud.
  </Card>
</CardGroup>
