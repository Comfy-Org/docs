...
<CardGroup cols={2}>
  ...
  <Card title="Qwen-Image 공식 모델 워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image.json">
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="JSON 형식 워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_instantx_controlnet.json">
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="JSON 형식 워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_controlnet_patch.json">
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="JSON 형식 워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_union_control_lora.json">
  </Card>
</CardGroup>
