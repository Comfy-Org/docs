...
translationSourceHash: fd32bd6f
translationFrom: tutorials/image/anima/anima.mdx
translationBlockHashes:
  "_intro": 8946174e
  "Available workflows": 0808b70c
...
### Anima Base v1: 텍스트 기반 이미지 생성 {#image_anima_base_v1}

애니메이션이나 예술적 일러스트레이션을 설명하는 텍스트 프롬프트를 입력하세요. 애니메이션 개념, 캐릭터 또는 스타일에 초점을 맞춘 비사실적 이미지를 생성합니다.

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_anima_base_v1-1.webp" alt="Anima Base v1 텍스트 기반 이미지 생성 워크플로 미리보기" />
...
![Anima Base v1 예시 출력](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_anima_base_v1.png)
...
4. 누락된 모델을 다운로드하고([모델 다운로드](#anima-모델-다운로드) 참조), 프롬프트를 입력한 후 **큐**를 클릭하세요

### Anima 미리보기: 애니메이션 텍스트 기반 이미지 생성 {#image_anima_preview}

텍스트 프롬프트를 입력해 Anima 모델을 사용한 애니메이션 스타일 이미지를 생성합니다. steps 및 CFG scale과 같은 설정을 구성해 출력을 제어할 수 있습니다.

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_anima_preview-1.webp" alt="Anima 미리보기 텍스트 기반 이미지 생성 워크플로 미리보기" />
...
![Anima 미리보기 예시 출력](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_anima_preview.png)
