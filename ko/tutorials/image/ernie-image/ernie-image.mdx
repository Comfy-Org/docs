...
description: "ERNIE-Image는 Baidu의 오픈소스 8B 디퓨전 트랜스포머 텍스트-이미지 모델로, ComfyUI에서 정확한 텍스트 렌더링과 내장 프롬프트 향상기를 제공합니다."
sidebarTitle: "ERNIE-Image"
translationSourceHash: bb9c1c5c
translationFrom: tutorials/image/ernie-image/ernie-image.mdx
translationBlockHashes:
  "_intro": 070dc9dc
  "ERNIE-Image text-to-image workflow": 0273e958
  "ERNIE-Image-Turbo": 7d92aa5d
...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_ernie_image-1.webp" alt="ERNIE-Image text-to-image 워크플로 미리보기" />

<CardGroup cols={2}>
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=image_ernie_image&utm_source=docs&utm_medium=referral&utm_campaign=ernie-image">
    Comfy Cloud에서 이 워크플로를 직접 실행
  </Card>
  <Card title="워크플로 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_ernie_image.json">
...
![ERNIE-Image 출력 예시](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_ernie_image.png)
...
[ERNIE-Image-Turbo](https://huggingface.co/Baidu/ERNIE-Image-Turbo)는 DMD 및 RL로 최적화된 더 빠른 변형으로, 표준 모델의 약 50단계 대비 **8단계**만으로 이미지를 생성합니다.
...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_ernie_image_turbo-1.webp" alt="ERNIE-Image-Turbo text-to-image 워크플로 미리보기" />

<CardGroup cols={2}>
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=image_ernie_image_turbo&utm_source=docs&utm_medium=referral&utm_campaign=ernie-image">
    Comfy Cloud에서 이 워크플로를 직접 실행
  </Card>
  <Card title="워크플로 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_ernie_image_turbo.json">
...
![ERNIE-Image-Turbo 출력 예시](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_ernie_image_turbo.png)
