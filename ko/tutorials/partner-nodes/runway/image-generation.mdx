...
## Runway Image Generation이 뛰어난 분야

- **텍스트 기반 이미지 생성**: 텍스트 프롬프트와 `Runway 텍스트 이미지 생성` 노드를 사용해 이미지를 생성하며, 출력 이미지의 종횡비를 조절할 수 있습니다.
- **레퍼런스 기반 이미지 생성**: 입력 레퍼런스 이미지와 텍스트 프롬프트를 참조하여 이미지를 생성합니다.
- **스타일 변환, 이미지 확장, 디테일 제어**: Runway의 모델은 이미지 생성에 이러한 기능을 지원합니다.
...
![ComfyUI Runway 텍스트 기반 이미지 생성 워크플로](https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/runway/image/text_to_image.png)

### 2. 워크플로를 단계별로 완료하세요

![ComfyUI Runway 텍스트 기반 이미지 생성 워크플로 단계 안내](/images/tutorial/api_nodes/runway/runway_text_to_image_step_guide.jpg)
...
![ComfyUI Runway 레퍼런스 기반 이미지 생성 워크플로](https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/runway/image/reference_to_image/runway_reference_to_image.png)

입력용 이미지를 아래에서 다운로드하세요.

![ComfyUI Runway 레퍼런스 기반 이미지 생성 입력 이미지](https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/runway/image/reference_to_image/input.png)

### 2. 워크플로를 단계별로 완료하세요

![ComfyUI Runway 레퍼런스 기반 이미지 생성 워크플로 단계 안내](/images/tutorial/api_nodes/runway/runway_reference_to_image_step_guide.jpg)
