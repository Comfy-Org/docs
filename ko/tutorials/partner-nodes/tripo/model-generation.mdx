...
<CardGroup cols={1}>
  <Card title="Json 형식 워크플로우 파일 다운로드" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/tripo/api_tripo_text_to_model.json">
    텍스트 기반 3D 모델 생성 워크플로우
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="Json 형식 워크플로우 파일 다운로드" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/tripo/image_to_model/api_tripo_image_to_model.json">
    이미지 기반 3D 모델 생성 워크플로우
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="Json 형식 워크플로우 파일 다운로드" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/api_nodes/tripo/multiview_to_image/api_tripo_multiview_to_model.json">
    멀티뷰 모델 생성 워크플로우
  </Card>
</CardGroup>
