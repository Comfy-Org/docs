...
> **Seedance 2.0 토큰 계산:** 출력 토큰 = (입력 비디오 지속 시간 + 출력 비디오 지속 시간) × 출력 비디오 길이 × 출력 비디오 너비 × 출력 비디오 프레임 레이트 ÷ 1024. 입력이 텍스트, 이미지, 또는 오디오인 경우 입력 지속 시간 = 0. Seedance 2.0은 24fps로 출력합니다. 비디오-투-비디오 입력에는 최소 토큰 사용 제한이 적용됩니다. **K 토큰당 크레딧**은 출력 해상도에 따라 달라집니다: 동일한 모델과 `video_type`에서 **1080P는 720P 요금의 2.5배**입니다. `Seedance 2.0 Fast` 모델은 최대 1080P까지 지원하며, 표준 `Seedance 2.0` 모델은 추가로 4K 출력을 지원합니다.
...
| HappyHorse 비디오 생성 제품 | 모델: happyhorse1.1, 해상도: 720P, 비디오 유형: 텍스트 기반 비디오 생성 | 42.24 / 초 | 비디오 |
| HappyHorse 비디오 생성 제품 | 모델: happyhorse1.1, 해상도: 720P, 비디오 유형: 이미지 기반 비디오 생성 | 42.24 / 초 | 비디오 |
| HappyHorse 비디오 생성 제품 | 모델: happyhorse1.1, 해상도: 720P, 비디오 유형: 레퍼런스 기반 비디오 생성 | 42.24 / 초 | 비디오 |
| HappyHorse 비디오 생성 제품 | 모델: happyhorse1.1, 해상도: 1080P, 비디오 유형: 텍스트 기반 비디오 생성 | 54.31 / 초 | 비디오 |
| HappyHorse 비디오 생성 제품 | 모델: happyhorse1.1, 해상도: 1080P, 비디오 유형: 이미지 기반 비디오 생성 | 54.31 / 초 | 비디오 |
| HappyHorse 비디오 생성 제품 | 모델: happyhorse1.1, 해상도: 1080P, 비디오 유형: 레퍼런스 기반 비디오 생성 | 54.31 / 초 | 비디오 |
