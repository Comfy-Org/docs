...
> **Seedance 2.0 토큰 계산:** 출력 토큰 = (입력 비디오 지속 시간 + 출력 비디오 지속 시간) × 출력 비디오 길이 × 출력 비디오 너비 × 출력 비디오 프레임 레이트 ÷ 1024. 입력이 텍스트, 이미지, 또는 오디오인 경우 입력 지속 시간 = 0. Seedance 2.0은 24fps로 출력합니다. 비디오-투-비디오 입력에는 최소 토큰 사용 제한이 적용됩니다. **K 토큰당 크레딧**은 출력 해상도에 따라 달라집니다: 동일한 모델과 `video_type`에서 **1080P는 720P 요금의 2.5배**입니다.
...
| Luma Ray 3.2 비디오 편집 | 해상도: 360p | 113.94 - 227.88 / 실행 | 비디오 |
| Luma Ray 3.2 비디오 편집 | 해상도: 540p | 151.92 - 303.84 / 실행 | 비디오 |
| Luma Ray 3.2 비디오 편집 | 해상도: 720p | 227.88 - 455.76 / 실행 | 비디오 |
| Luma Ray 3.2 비디오 편집 | 해상도: 1080p | 455.76 - 911.52 / 실행 | 비디오 |
...
| xAI 비디오 생성 출력 비디오 (초당)                  | endpoint: v1/videos/generations, model: grok-imagine-video-1.5-preview, resolution: 480p                 | 24.14 / 초      | 비디오   |
| xAI 비디오 생성 출력 비디오 (초당)                  | endpoint: v1/videos/generations, model: grok-imagine-video-1.5-preview, resolution: 720p                 | 42.24 / 초      | 비디오   |
| xAI 비디오 생성 입력 이미지                         | endpoint: v1/videos/generations, model: grok-imagine-video-1.5-preview, type: image-to-video           | 3.02 / 초       | 비디오   |
