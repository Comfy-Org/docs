...
<Card title="Luma 텍스트-to-이미지 노드 문서" icon="book" href="/built-in-nodes/partner-node/image/luma/luma-text-to-image">
Luma 텍스트-to-이미지 파트너 노드 문서
</Card>

<Card title="Luma 레퍼런스 노드 문서" icon="book" href="/built-in-nodes/partner-node/image/luma/luma-reference">
Luma 레퍼런스 파트너 노드 문서
</Card>
