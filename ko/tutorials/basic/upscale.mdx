...
<Note>
더 고급 업스케일링 옵션을 찾으시나요? 다양한 모델과 활용 사례를 다룬 종합적인 [이미지 업스케일링 가이드](/tutorials/utility/image-upscale)를 확인해보세요. 여기에는 인물 강화, 제품 사진 촬영 등이 포함됩니다.
...
기본 업스케일링을 마스터한 후, 이를 [텍스트-to-이미지](/tutorials/basic/text-to-image) 워크플로우와 결합할 수 있습니다. 텍스트-to-이미지의 기본 사항은 [텍스트-to-이미지 튜토리얼](/tutorials/basic/text-to-image)을 참고하세요.
