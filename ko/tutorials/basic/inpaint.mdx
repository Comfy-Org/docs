...
[512-inpainting-ema.safetensors](https://huggingface.co/Comfy-Org/stable_diffusion_2.1_repackaged/blob/main/512-inpainting-ema.safetensors) 파일을 다운로드하여 `ComfyUI/models/checkpoints` 폴더에 넣으세요:
...
[512-inpainting-ema.safetensors](https://huggingface.co/Comfy-Org/stable_diffusion_2.1_repackaged/blob/main/512-inpainting-ema.safetensors) 모델로 생성한 결과가 더 나은 인페인팅 효과와 자연스러운 전환을 보여줍니다. 이는 해당 모델이 인페인팅에 특화되어 있어 생성 영역을 더 잘 제어할 수 있고, 결과적으로 인페인팅 효과가 개선되기 때문입니다.
