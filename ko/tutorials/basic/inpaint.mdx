...
이 워크플로우를 [텍스트-이미지](/tutorials/basic/text-to-image) 및 [이미지-이미지](/tutorials/basic/image-to-image)와 비교해 보면, 주요 차이점은 VAE 섹션의 조건부 입력에 있음을 알 수 있습니다. 이번 워크플로우에서는 인페인팅에 특화된 **VAE 인코더 (인페인팅용)** 노드를 사용해 생성 영역을 더 잘 제어하고 더 나은 결과를 얻을 수 있도록 돕습니다.
