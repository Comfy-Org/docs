...
translationSourceHash: b9d51ed8
translationFrom: tutorials/utility/face-detection/mediapipe.mdx
translationBlockHashes:
  "_intro": 950f431c
  "MediaPipe Face Detection Workflow": 3e54e54f
...
### Mediapipe: 이미지 얼굴 감지 (`utility_face_detection_mediapipe`)

이미지를 입력하고 얼굴당 최대 6개의 얼굴 랜드마크를 감지하여 초고속 다중 얼굴 감지를 가능하게 합니다.

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/utility_face_detection_mediapipe-1.webp" alt="Mediapipe 이미지 얼굴 감지 워크플로우 미리보기" />
...
<CardGroup cols={2}>
  ...
  <Card title="워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/utility_face_detection_mediapipe.json">
    JSON 다운로드 또는 템플릿 라이브러리에서 &quot;Mediapipe: 이미지 얼굴 감지&quot; 검색
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="soft_neon_girl.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/soft_neon_girl.png">
    `LoadImage` 노드 5 · `soft_neon_girl.png`
  </Card>
</CardGroup>

<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '1rem', alignItems: 'start'}}>
  <img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/soft_neon_girl.png" alt="입력 이미지" style={{width: '100%', height: 'auto', objectFit: 'contain'}} />
</div>
...
| **custom_face_oval** | `거짓` | 마스크 출력에 얼굴 윤곽 영역 포함 |
| **custom_lips** | `거짓` | 마스크에 입술 포함(활성화된 다른 영역과 합집합) |
| **custom_left_eye** | `거짓` | 마스크에 왼쪽 눈 영역 포함 |
| **custom_right_eye** | `거짓` | 마스크에 오른쪽 눈 영역 포함 |
| **custom_irises** | `거짓` | 마스크에 홍채 영역 포함 |
