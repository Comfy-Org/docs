...
</div>### SDPose-OOD: 이미지를 포즈 맵으로 변환 {#utility_sdpose_ood_image_to_pose}
...
</div>### SDPose-OOD: 비디오를 포즈 맵으로 변환 {#utility_sdpose_ood_video_to_pose_map}
...
**diffusion_models** (RT-DETRv4 검출기):
...
- [rt_detr_v4-x-hgnet_fp32.safetensors](https://huggingface.co/Comfy-Org/SDPose/blob/main/diffusion_models/rt_detr_v4-x-hgnet_fp32.safetensors) (풀 정밀도, 더 큰 용량)
