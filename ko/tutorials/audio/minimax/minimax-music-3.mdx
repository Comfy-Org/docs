...
<UpdateReminder/>
<Note>
[커뮤니티 라이선스](https://huggingface.co/MiniMaxAI/MiniMax-Music3/blob/main/LICENSE)는 연간 매출 2천만 달러 미만인 기업에 상업적 사용을 허용합니다. 이 기준을 초과하는 경우, 상업적 사용에는 [MiniMax 상업용 라이선스](https://comfy.org/minimax/license)가 필요하며, 해당 라이선스는 유일한 공식 리셀러인 Comfy를 통해 제공됩니다.
</Note>
