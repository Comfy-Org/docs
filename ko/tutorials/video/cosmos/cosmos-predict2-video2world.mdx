...
Cosmos-Predict2는 텍스트-이미지(Text2Image)와 비디오-월드(Video2World)를 포함한 다양한 생성 방식을 지원하며,
...
텍스트-이미지 섹션은 다음을 참고하세요:

<Card title="Cosmos Predict2 텍스트-이미지" icon="book" href="/ko/tutorials/image/cosmos/cosmos-predict2-t2i">
  Cosmos-Predict2를 이용한 텍스트-이미지 생성
</Card>
{/* 
<UpdateReminder/>
