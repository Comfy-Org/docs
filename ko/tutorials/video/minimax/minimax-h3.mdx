...
자세한 프롬프트 작성 안내는 공식 [MiniMax H3 비디오 프롬프트 작성 가이드](https://huggingface.co/MiniMaxAI/MiniMax-H3/blob/main/docs/VIDEO_PROMPT_WRITING_GUIDE_base_en.md)를 참조하세요.
...
자세한 프롬프트 작성 안내는 공식 [MiniMax H3 전체 참조 모드 프롬프트 가이드](https://huggingface.co/MiniMaxAI/MiniMax-H3/blob/main/docs/VIDEO_PROMPT_WRITING_GUIDE_ref_en.md)를 참조하세요.
