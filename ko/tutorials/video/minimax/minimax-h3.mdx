...
커뮤니티에서 학습된 예제 임베딩은 [silveroxides/MiniMax-H3_tests](https://huggingface.co/silveroxides/MiniMax-H3_tests/tree/main/embeddings) 저장소에서 찾을 수 있습니다(예: `minimaxh3_art_is_explosion.safetensors`, `embedding:minimaxh3_art_is_explosion`으로 참조).
