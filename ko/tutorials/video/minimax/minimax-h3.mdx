...
### MiniMax H3 이미지 기반 비디오 생성 연속 워크플로

I2V 워크플로의 연속 변형입니다. 이미지를 로드한 다음 원하는 모션, 장면, 오디오를 설명합니다. 워크플로는 빈 프롬프트로 제공되며 실행 전에 자유롭게 편집할 수 있습니다.

<CardGroup cols={2}>
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=video_minimax_h3_i2v_continuation&utm_source=docs&utm_medium=referral&utm_campaign=minimax-h3">
    Comfy Cloud에서 열기
  </Card>
  <Card title="워크플로 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_minimax_h3_i2v_continuation.json">
    JSON 다운로드 또는 템플릿 라이브러리에서 "MiniMax H3 I2V Continuation" 검색
  </Card>
</CardGroup>

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_minimax_h3_i2v_continuation-1.webp" alt="MiniMax H3 이미지 기반 비디오 생성 연속 워크플로 미리보기" />
