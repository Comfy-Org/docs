...
비디오에서 자막, 캡션, 워터마크 또는 기타 텍스트 오버레이를 원클릭으로 제거:
...
Googlyeyes LTX-2.3 LoRA를 사용하여 입력 비디오의 누구나 구글리 아이로 만들기:

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/template_ltx2_3_lora_googly_eyes-1.webp" alt="LTX-2.3 구글리 아이 워크플로 미리보기" />
...
<CardGroup cols={2}>
  ...
  <Card title="워크플로 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/template_ltx2_3_lora_googly_eyes.json">
    JSON 다운로드 또는 템플릿 라이브러리에서 "구글리 아이" 검색
  </Card>
</CardGroup>
