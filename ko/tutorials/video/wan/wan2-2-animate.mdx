...
커스텀 노드 설치 방법이 궁금하시다면 [커스텀 노드 설치 방법](/installation/install_custom_node)을 참고해주세요.
...
Wan2.2 animate 워크플로우에서 [서브그래프](/interface/features/subgraph)를 사용했으며, 무브 모드로 전환하는 방법은 다음과 같습니다:
