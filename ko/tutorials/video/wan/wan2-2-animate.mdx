...
<CardGroup cols={2}>
  ...
  <Card title="워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_wan2_2_14B_animate.json">
...
<CardGroup cols={2}>
  <Card title="Wan2.2 Animate 14B FP8 (Kijai)" icon="download" href="https://huggingface.co/Kijai/WanVideo_comfy_fp8_scaled/blob/main/Wan22Animate/Wan2_2-Animate-14B_fp8_e4m3fn_scaled_KJ.safetensors">
    Wan2_2-Animate-14B_fp8_e4m3fn_scaled_KJ.safetensors: Kijai의 리포지토리에서 제공하는 스케일링 FP8 모델
  </Card>
