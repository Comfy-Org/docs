...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_5B_ti2v&utm_source=docs">Comfy Cloud에서 열기</Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_t2v&utm_source=docs">Comfy Cloud에서 열기</Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_i2v&utm_source=docs">Comfy Cloud에서 열기</Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_flf2v&utm_source=docs">Comfy Cloud에서 열기</Card>
</CardGroup>
