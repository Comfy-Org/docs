...
<CardGroup cols={2}>
  <Card title="워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux_kontext_dev_basic.json">
    JSON을 다운로드하거나 템플릿 라이브러리에서 "Flux Kontext Dev"를 검색하세요
  </Card>
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=flux_kontext_dev_basic&utm_source=docs">
    Comfy Cloud에서 열기
  </Card>
</CardGroup>
