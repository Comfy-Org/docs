...
<CardGroup cols={2}>
  <Card title="워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux_kontext_dev_basic.json">JSON 다운로드 또는 템플릿 라이브러리에서 "Flux Kontext Dev" 검색</Card>
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=flux_kontext_dev_basic&utm_source=docs&utm_medium=referral&utm_campaign=flux-1-kontext-dev">Comfy Cloud에서 열기</Card>
</CardGroup>
