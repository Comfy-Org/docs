...
현재 ComfyUI에서는 이 모든 버전을 사용할 수 있으며, [Pro 및 Max 버전](/tutorials/partner-nodes/black-forest-labs/flux-1-kontext)은 파트너 노드를 통해 호출할 수 있고, Dev 오픈소스 버전은 본 가이드의 지침을 참고하세요.
