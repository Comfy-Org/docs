...
translationSourceHash: a02fc86f
translationFrom: tutorials/flux/flux-1-controlnet.mdx
translationBlockHashes:
  "_intro": a69fbfae
  "FLUX.1 ControlNet Model Introduction": c242319b
  "FLUX.1-Canny-dev Complete Version Workflow": 0c4240ac
  "FLUX.1-Depth-dev-lora Workflow": ebfe0fb5
...
<CardGroup cols={2}>
  ...
  <Card title="워크플로 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux_canny_model_example.json">
    JSON을 다운로드하거나 템플릿 라이브러리에서 "Flux.1 Canny" 검색
  </Card>
</CardGroup>
...
- [flux1-canny-dev.safetensors](https://huggingface.co/black-forest-labs/FLUX.1-Canny-dev/blob/main/flux1-canny-dev.safetensors?download=true) (해당 리포지토리의 이용 약관에 동의했는지 확인해 주세요)
...
<CardGroup cols={2}>
  ...
  <Card title="워크플로 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux_depth_lora_example.json">
    JSON을 다운로드하거나 템플릿 라이브러리에서 "Flux.1 Depth LoRA" 검색
  </Card>
</CardGroup>
