...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=flux_canny_model_example&utm_source=docs">Comfy Cloud에서 열기</Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=flux_depth_lora_example&utm_source=docs">Comfy Cloud에서 열기</Card>
</CardGroup>
