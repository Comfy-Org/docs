...
translationSourceHash: 9d9eb50c
...
<CardGroup cols={3}>
  <Card title="4B 텍스트-to-Image 워크플로우" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_flux2_klein_text_to_image.json">
...
<CardGroup cols={3}>
  <Card title="9B 텍스트-to-Image 워크플로우" icon="download" href="http://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_flux2_text_to_image_9b.json">
