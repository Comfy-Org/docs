...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud에서 실행" icon="cloud" href="https://cloud.comfy.org/?template=flux1_dev_uso_reference_image_gen&utm_source=docs">이 워크플로우를 Comfy Cloud에서 실행하세요</Card>
</CardGroup>
