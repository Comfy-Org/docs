...
translationSourceHash: bada5ac1
translationFrom: tutorials/flux/flux-1-text-to-image.mdx
translationBlockHashes:
  "_intro": 36e44c17
  "Flux.1 Full Version Text-to-Image Example": 49017a58
...
Flux Dev 전체 버전으로 고품질 이미지를 생성하세요. 더 큰 VRAM과 여러 개의 모델 파일이 필요하지만, 최고의 프롬프트 추종 능력을 제공합니다.
...
<CardGroup cols={2}>
  ...
  <Card title="워크플로 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux_dev_full_text_to_image.json">
    JSON 다운로드 또는 템플릿 라이브러리에서 &quot;Flux.1 Dev FP8&quot; 검색
  </Card>
</CardGroup>

**예시 출력**

![Flux.1 Dev FP8 체크포인트 예시 출력](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/flux_dev_full_text_to_image.png)

아래 이미지를 다운로드해 ComfyUI에 드래그하여 워크플로를 로드하세요.

[flux1-dev-fp8.safetensors](https://huggingface.co/Comfy-Org/flux1-dev/blob/main/flux1-dev-fp8.safetensors?download=true)를 다운로드해 `ComfyUI/models/checkpoints/` 디렉토리에 저장하세요.
...
Flux.1 Schnell fp8 양자화 버전으로 빠르게 이미지를 생성하세요. 저사양 하드웨어에 이상적이며, 단 4단계만으로 이미지를 생성할 수 있습니다.
