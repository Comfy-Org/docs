...
<Tab title="데스크탑">
Comfy 데스크탑은 Comfy Engine을 패키지 매니저로 사용하여 ComfyUI를 관리합니다. ComfyUI 엔진을 업데이트하려면 [관리 패널](/ko/installation/desktop/usage/manage#update-tab)의 업데이트 탭을 열고 **안정판**(기본값) 또는 **GitHub 최신판** 업데이트 채널을 선택할 수 있습니다.
