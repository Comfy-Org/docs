...
<CardGroup cols={3}>
  ...
  <Card title="Linux" icon="linux" href="/ko/installation/desktop/linux">
    Debian 기반 배포판에 `.deb` 또는 AppImage를 설치합니다.
  </Card>
</CardGroup>
...
Comfy Desktop 소스는 [GitHub](https://github.com/Comfy-Org/Comfy-Desktop)에 있습니다. 이중 라이선스입니다: AGPL-3.0-or-later, 또는 Comfy Org의 상업용 라이선스.