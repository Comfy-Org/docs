...
<Note>
**Docker：** ComfyUI는 현재 공식 Docker 이미지를 제공하지 않습니다. 커뮤니티에서 유지보수하는 Docker 이미지(예: [ai-dock/comfyui](https://github.com/ai-dock/comfyui))를 사용할 수 있지만, 이러한 이미지는 ComfyUI 팀의 공식 지원을 받지 않습니다.
</Note>
