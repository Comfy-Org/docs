...
<Info>사용자 정의 노드의 기본 구조는 [여기](/custom-nodes/backend/server_overview)에서 자세히 설명되어 있습니다.</Info>
...
<Info>ComfyUI가 사용자 정의 노드를 어떻게 발견하고 로드하는지 자세한 설명은 [노드 라이프사이클 문서](/custom-nodes/backend/lifecycle)를 참조하세요.</Info>
