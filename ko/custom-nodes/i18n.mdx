---
title: "ComfyUI 맞춤형 노드 i18n 지원"
description: "ComfyUI 맞춤형 노드에 다국어 지원을 추가하는 방법 알아보기"
...
맞춤형 노드 i18n 데모: [comfyui-wiki/ComfyUI-i18n-demo](https://github.com/comfyui-wiki/ComfyUI-i18n-demo)

## 디렉토리 구조

맞춤형 노드 아래에 `locales` 폴더를 생성하고, 여러 유형의 번역 파일을 지원하세요:
...
예를 들어, i18n-demo 맞춤형 노드에서는 다음과 같은 두 가지 메뉴 설정을 등록했습니다:
```javascript
