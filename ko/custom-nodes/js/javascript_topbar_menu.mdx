---
title: "탑바 메뉴"
description: "ComfyUI 탑바 메뉴에 커스텀 명령을 추가합니다. 기존 메뉴에 추가, 서브메뉴 생성, 한 명령을 여러 위치에 배치하는 방법을 포함합니다."
translationSourceHash: 210e5e77
translationFrom: custom-nodes/js/javascript_topbar_menu.mdx
translationBlockHashes:
  "_intro": 686d68ec
  "Basic Usage": f50d108f
  "Command Configuration": ad9a0317
  "Menu Configuration": 58481d65
  "Menu Examples": f310db1f
---
