---
title: "선택 도구 상자"
description: "getSelectionToolboxCommands를 사용해 선택된 노드, 그룹, 캔버스 항목에 대해 ComfyUI 선택 도구 상자에 커스텀 액션 명령을 추가합니다."
translationSourceHash: f66d3f91
translationFrom: custom-nodes/js/javascript_selection_toolbox.mdx
translationBlockHashes:
  "_intro": 356ec52a
  "Basic Usage": a850ba5d
  "Command Definition": b0aab3a4
  "Icon Options": c511932a
  "Dynamic Command Visibility": 49b6198d
  "Working with Selected Items": 90ff1ddb
  "Complete Example": dc8a50e4
  "Notes": 6f71c3bf
---
