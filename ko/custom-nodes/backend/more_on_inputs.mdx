---
title: "숨겨진 및 유연한 입력"
description: "커스텀 노드를 만들 때 사용하는 ComfyUI의 숨겨진 입력(UNIQUE_ID, PROMPT, EXTRA_PNGINFO, DYNPROMPT)과 유연한 입력. 커스텀 데이터 타입과 와일드카드 입력을 포함합니다."
translationSourceHash: 15687c09
translationFrom: custom-nodes/backend/more_on_inputs.mdx
translationBlockHashes:
  "Hidden inputs": 98a727dc
  "Flexible inputs": 7f070736
---
