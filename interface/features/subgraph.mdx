...
<Note>
    The subgraph feature requires ComfyUI frontend version xxxx or later. If you don't see this feature, please refer to: [How to Update ComfyUI](/installation/update_comfyui)
</Note>
