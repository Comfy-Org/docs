...
![Mask Editor main interface with tool panel, canvas, and settings side panel](/images/interface/maskeditor/maskeditor_main_editor.png)
...
In the screenshot above, the left panel shows five tools: Mask Pen, Paint Pen, Eraser, Paint Bucket, and Color Select.
