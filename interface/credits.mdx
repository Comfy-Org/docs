...
<Note>
The credit system does not mean ComfyUI is moving towards a paid model. Because calling closed-source AI models requires credits, the credit system was added to support `API Nodes`. If you don't need to use `API Nodes`, you can still use ComfyUI completely free and unrestricted.
</Note>
