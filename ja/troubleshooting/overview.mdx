...
<Tabs>
<Tab title="Windows">
- **サポートされていないデバイス**: ComfyUI Desktop Windows は CUDA を搭載した NVIDIA GPU のみをサポートしています。他の GPU については [ComfyUI Portable](/ja/installation/comfyui_portable_windows) または [手動インストール](/ja/installation/manual_install) を使用してください
