...
icon: "cube"
sidebarTitle: "模型問題" "1. Prevention strategies list differs (EN has 3 items, ZH has 4 items including ComfyUI Manager compatibility indicator). 2. Slow Model Loading solutions differ (EN lacks --highvram option present in ZH)."
