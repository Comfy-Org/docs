...
title: 設定
sidebarTitle: 設定
description: ComfyUI-Manager の設定を構成します "ZH title has typo (\"配置配置\"). ZH table omits \"(with System User API)\". ZH URLs point to different repo owners (comfy-org vs ltdrdata) and include locale paths. Following EN source for URLs and details."
translationSourceHash: d87a6ccb
translationFrom: manager/configuration.mdx
reviewSourceHash: d87a6ccb
---
