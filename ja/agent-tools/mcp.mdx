...
<AccordionGroup>
  ...
  <Accordion title="自分のマシンがローカル接続を実行できるかどうかを確認するには？">
...
<AccordionGroup>
  ...
  <Accordion title="一方の接続で始めたが、もう一方が必要になった場合はどうすればいいですか？">
  ...
  <Accordion title="Comfy MCP を更新するには？">
...
<AccordionGroup>
  ...
  <Accordion title="/comfy や /cloud と入力しても何も表示されませんでした。">
