...
<CardGroup cols={2}>
  ...
  <Card title="Comfy CLI" icon="terminal" href="/ja/agent-tools/comfy-cli">
    <code>comfy generate</code>（ベータ）のエージェント向け簡単な概要です。完全なCLIガイドは <a href="/ja/comfy-cli/getting-started">はじめに</a> をご覧ください。
  </Card>
</CardGroup>
...
**より優れたローカルエージェントの UX はロードマップに含まれています。** ファーストパーティのローカルエージェントエクスペリエンスの向上は、私たちのビジョンの一部です。Cloud MCP は最初にリリースできる部分でした。今後、ローカル機能のさらなる改良が続きます。
