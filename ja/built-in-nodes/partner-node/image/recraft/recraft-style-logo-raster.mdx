...
translationFrom: built-in-nodes/partner-node/image/recraft/recraft-style-logo-raster.mdx, zh-CN/built-in-nodes/partner-node/image/recraft/recraft-style-logo-raster.mdx
