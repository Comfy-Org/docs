...
translationFrom: built-in-nodes/partner-node/image/recraft/recraft-vectorize-image.mdx, zh/built-in-nodes/partner-node/image/recraft/recraft-vectorize-image.mdx
