...
translationFrom: built-in-nodes/partner-node/image/recraft/recraft-text-to-image.mdx, zh-CN/built-in-nodes/partner-node/image/recraft/recraft-text-to-image.mdx
