...
translationFrom: built-in-nodes/partner-node/image/recraft/recraft-remove-background.mdx, zh-CN/built-in-nodes/partner-node/image/recraft/recraft-remove-background.mdx
---
