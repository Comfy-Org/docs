...
translationFrom: built-in-nodes/partner-node/video/pixverse/pixverse-transition-video.mdx, zh-CN/built-in-nodes/partner-node/video/pixverse/pixverse-transition-video.mdx
