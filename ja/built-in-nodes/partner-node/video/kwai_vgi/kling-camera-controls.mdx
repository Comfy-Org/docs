...
translationFrom: built-in-nodes/partner-node/video/kwai_vgi/kling-camera-controls.mdx, zh-CN/built-in-nodes/partner-node/video/kwai_vgi/kling-camera-controls.mdx
---
