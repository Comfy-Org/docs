...
translationFrom: built-in-nodes/partner-node/video/kwai_vgi/kling-start-end-frame-to-video.mdx, zh/built-in-nodes/partner-node/video/kwai_vgi/kling-start-end-frame-to-video.mdx
