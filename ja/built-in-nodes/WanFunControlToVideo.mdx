...
translationMismatches:
  - "description"
---
このノードは、アリババ社の Wan Fun Control モデルによる動画生成をサポートするために追加され、[このコミット](https://github.com/Comfy-Org/ComfyUI/commit/3661c833bcc41b788a7c9f0e7bc48524f8ee5f82) 以降に導入されました。
