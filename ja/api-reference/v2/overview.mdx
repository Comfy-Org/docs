...
Comfy API v2 は、送信してポーリングする永続的なジョブとしてワークフローを実行します。モデルを直接呼び出す場合（パートナーモデル 1 つ、リクエスト 1 つ、モデル固有のネイティブな入出力）は、代わりに [Comfy Router](/ja/api-reference/comfy-router/quickstart) をご覧ください。
