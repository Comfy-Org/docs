...
旧バージョンの Desktop Legacy（シングルインストールのデスクトップアプリ）を引き続き使用している場合でも、カスタムノード、ワークフロー、モデルを新しい Comfy Desktop に移行できます。既存のデータは保持され、手動での移行は不要です。

<CardGroup cols={1}>
  <Card title="移行ガイド" icon="arrow-right" href="/ja/installation/desktop/usage/migrate">
    Desktop Legacy から Comfy Desktop への移行手順。
  </Card>
</CardGroup>
