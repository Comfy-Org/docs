---
title: "ComfyUI(portable) Windows: ローカルセルフホスト"
description: "このチュートリアルでは、ComfyUI Portable のダウンロード方法、使用開始方法、および対応するプログラムの実行方法について説明します。"
icon: "box"
sidebarTitle: "Portable (ローカル)"
  ...
  <Tab title="Nvidia GPU">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Nvidia GPU (CUDA 12.6, Python 3.12)" icon="download" href="https://github.com/Comfy-Org/ComfyUI/releases/latest/download/ComfyUI_windows_portable_nvidia_cu126.7z">
       Nvidia 10 シリーズおよびそれ以前の GPU 向け
      </Card>
    </CardGroup>

    ファイルをダウンロードし、[7-ZIP](https://7-zip.org/) で解凍します。解凍後のフォルダー構造：
...
ダウンロードと解凍後、以下の画像に示すようにコマンドが実行されているのが確認できます。
