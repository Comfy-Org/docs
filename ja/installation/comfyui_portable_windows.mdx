...
icon: "box"
sidebarTitle: "ポータブル版 (Windows)" "The Chinese source includes a section \"Community Distributed Version\" (Akiya Integration Pack) which is absent in the English source. The Chinese source uses <Note> for the warning about closing the command line, while the English source uses <Warning>."
