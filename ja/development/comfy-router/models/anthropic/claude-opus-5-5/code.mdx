---
title: "Comfy Router で Claude Opus 5.5 を使う"
description: "Comfy Router 経由で anthropic/claude-opus-5-5 を呼び出します: エンドポイント、リクエストの形状、Router が返すレスポンスについて。"
...
translationBlockHashes:
  ...
  "Examples": fd6d9b8d
---
{/* 生成済みファイル。`pnpm code-pages:gen` により router-schemas/anthropic/claude-opus-5-5.json から生成されています。 */}
...
<ParamField body="messages[].content" type="object" required>
  文字列の省略形、またはコンテンツブロックの配列（text、image、document、tool_use、tool_result、...）のいずれか。
</ParamField>
