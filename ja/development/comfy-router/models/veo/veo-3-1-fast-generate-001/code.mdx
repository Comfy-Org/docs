...
translationBlockHashes:
  ...
  "Examples": 88e27039
---
{/* 生成済みファイル。`pnpm code-pages:gen` により router-schemas/veo/veo-3.1-fast-generate-001.json から生成されました。 */}
...
<ParamField body="parameters.sampleCount" type="integer">生成するビデオの数。指定しない場合は、1本のビデオが生成されます。
...
Router が `GET /v2/models/veo/veo-3.1-fast-generate-001/openapi.json` で提供するスキーマから生成されています。これは、リクエストがプロバイダーに到達する前に Router が呼び出しの検証に使用するのと同じドキュメントです。### 出力
