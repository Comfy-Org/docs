...
Router が `GET /v2/models/byteplus/dreamina-seedance-2-5-260628/openapi.json` で提供するスキーマから生成されています。これは、リクエストがプロバイダーに到達する前に Router が呼び出しの検証に使用するドキュメントと同じです。### 出力
