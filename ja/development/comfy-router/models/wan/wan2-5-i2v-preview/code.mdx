...
- wan2.7-i2v、wan2.7-t2v: 2 から 15 の整数
- wan2.7-r2v、wan2.7-videoedit: 2 から 10 の整数
- wan3.0-video: ビデオ入力なしの場合は 2 から 30 の整数。ビデオ入力がある場合は、
  入力ビデオの長さと出力ビデオの長さの合計が 30 秒を超えてはなりません。-1 を指定すると
  スマート長さモードが有効になり、モデルが適切な長さを選択します
...
wan2.7 モデルの場合、指定しない場合は解像度ティアに基づいてデフォルトが設定されます。
