...
表の説明は簡潔です。モデルの選択、検証、再試行、課金については[Using the Comfy Router API](/ja/development/comfy-router/quickstart)を、ヘッダーの動作については[Headers](/ja/development/comfy-router/headers)を参照してください。
