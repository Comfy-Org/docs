...
<CardGroup cols={3}>
  ...
  <Card title="方法2: WebSocket + History" icon="chart-line" href="#方法2websocket-+-history（完了を監視）">
    **推奨。** 完了を待ち、結果をダウンロード。シンプルさと信頼性の最適なバランス。
  </Card>
  <Card title="方法3: SaveImageWebsocket" icon="images" href="#方法3websocket-+-saveimagewebsocket（リアルタイム画像）">
