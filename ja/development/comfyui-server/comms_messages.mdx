---
title: "ComfyUI サーバーメッセージ（WebSocket API）"
description: "ComfyUI の PromptExecutor が WebSocket 経由でクライアントにメッセージを送る仕組み。execution_start や progress などの組み込みメッセージタイプと、カスタムメッセージタイプの登録方法を解説します。"
icon: "comment"
translationSourceHash: 1e9281fe
