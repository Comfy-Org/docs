---
title: "メッセージ"
description: "ComfyUI の PromptExecutor が WebSocket 経由でクライアントにメッセージを送る仕組み。execution_start や progress などの組み込みメッセージタイプ、カスタムメッセージタイプの登録、node_id の取得方法を解説します。"
icon: "comment"
translationSourceHash: 136e9402
