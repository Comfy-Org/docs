...
有料 API ノードを呼び出すために ComfyUI アカウント API キーを使用するには、[Comfy Platform API キー](/ja/development/api-development/getting-an-api-key)が必要です。

<Card title="API キーを取得する" icon="key" href="/ja/development/api-development/getting-an-api-key">
  Partner Nodes、Cloud API など向けの Comfy Platform API キーの作成と管理。
</Card>
