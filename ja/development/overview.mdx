...
Python バックエンド、JavaScript UI 拡張、外部連携で ComfyUI を拡張します。まずは[カスタムノードの概要](/ja/custom-nodes/overview)をご覧ください。

## レジストリ

Comfy レジストリでカスタムノードをパッケージ化して公開します。[レジストリの概要](/ja/registry/overview)または[公開チュートリアル](/ja/registry/publishing)から始めてください。
