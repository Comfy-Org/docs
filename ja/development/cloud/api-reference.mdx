...
icon: "book-open" "English source uses <PollJobCompletion /> component for \"Checking Job Status\" section, while Chinese source has inline CodeGroup with polling code examples. English source structure will be preserved."
  - "URLs in Chinese source include /zh/ prefix for internal links, English source does not. English URL structure will be preserved."
