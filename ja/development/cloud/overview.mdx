...
これは SDK のデフォルトのターゲットでもあるため、Comfy Cloud 用に設定する必要はありません。同じコードを Comfy API デプロイやご自身の ComfyUI に向けるには、`COMFY_BASE_URL` を設定してください。[ベース URL の選択](/ja/development/api-development/sdks#ベースurlの選択) を参照してください。
