...
description: "ComfyUI 公式ドキュメント。オープンソースのノードベース生成 AI アプリケーションで、画像・動画・音声・3D 生成ワークフローを構築できます。"
icon: "book-open"
sidebarTitle: "ホーム"
mode: "wide"
...
<div className="mb-12">
  ...
  <CardGroup cols={3}>
    ...
    >
      世界中のトップクリエイターのComfyUIワークフローを見つける
    </Card>
  </CardGroup>
</div>
...
<div className="mb-12">
  ...
  <CardGroup cols={3}>
    ...
    >
      ターミナルから comfy generate（ベータ）でパートナーモデルを呼び出し
    </Card>
  </CardGroup>
</div>
...
<div className="mb-12">
  ...
  <CardGroup cols={3}>
    ...
    >
      1 つの API キーで単一エンドポイント経由によりパートナーモデルを呼び出す
    </Card>
    <Card
      title="利用可能なモデル"
      icon="layer-group"
      href="/ja/development/comfy-router/models"
    >
      Router で利用できるすべてのモデルを参照
    </Card>
    <Card
      title="API リファレンス"
      icon="book"
...
<div className="mb-12">
  ...
  <CardGroup cols={3}>
    ...
    <Card
      ...
      icon="book"
      href="/ja/development/cloud/api-reference"
    >
