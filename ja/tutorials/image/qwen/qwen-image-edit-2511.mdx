...
description: "ComfyUI で Qwen-Image-Edit-2511 を使って画像を編集できます。キャラクターの一貫性が向上し、多人物編集、LoRA サポート、より強力な幾何学的推論に対応しています。"
...
- [ブログ記事](https://qwen.ai/blog?id=qwen-image-edit-2511)

## Qwen-Image-Edit-2511 ComfyUI ネイティブワークフローの例

<UpdateReminder />

### Qwen Image Edit 2511 - マテリアル置換 {#image_qwen_image_edit_2511}
