...
translationSourceHash: 8705aef9
translationFrom: tutorials/image/qwen/qwen-image-layered.mdx
translationBlockHashes:
  "_intro": 19900234
  "Qwen-Image-Layered workflow": 3b9420d2
...
画像を編集可能なRGBAレイヤーに分解し、色変更、置き換え、リサイズ、位置変更のワークフローを実現します。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_qwen_image_layered-1.webp" alt="Qwen-Image-Layered ワークフロープレビュー" />
...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=image_qwen_image_layered&utm_source=docs&utm_medium=referral&utm_campaign=qwen-image-layered">
    セットアップ不要で ComfyUI オンラインで実行
  </Card>
</CardGroup>

**入力素材**

次のファイルを`LoadImage`ノード **74** にアップロードします：
