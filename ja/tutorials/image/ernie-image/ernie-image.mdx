...
<Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=image_ernie_image&utm_source=docs">
...
<Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=image_ernie_image_turbo&utm_source=docs">
    このワークフローを Comfy Cloud 上で直接実行します。
  </Card>
