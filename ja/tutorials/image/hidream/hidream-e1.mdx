...
HiDream E1.1 で画像を編集します。HiDream-E1-Full と比較して、画像品質と編集精度に優れています。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/hidream_e1_1-1.webp" alt="HiDream E1.1 の画像編集ワークフローのプレビュー" />
...
<CardGroup cols={2}>
  ...
  <Card title="ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/hidream_e1_1.json">
    JSON をダウンロードするか、テンプレートライブラリで「HiDream E1.1」を検索してください
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="hidream_e1_1_input_image.jpg" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/hidream_e1_1_input_image.jpg">
    `LoadImage` ノード 13 · `hidream_e1_1_input_image.jpg`
  </Card>
</CardGroup>
...
### HiDream E1 画像編集 {#hidream_e1_full}

HiDream E1 で画像を編集します。プロフェッショナル向けの自然言語による画像編集モデルです。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/hidream_e1_full-1.webp" alt="HiDream E1 の画像編集ワークフローのプレビュー" />
...
<CardGroup cols={2}>
  ...
  <Card title="ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/hidream_e1_full.json">
    JSON をダウンロードするか、テンプレートライブラリで「HiDream E1 Full」を検索してください
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="hidream_e1_full_input_image.jpg" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/hidream_e1_full_input_image.jpg">
    `LoadImage` ノード 13 · `hidream_e1_full_input_image.jpg`
  </Card>
</CardGroup>
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '1rem', alignItems: 'start'}}>
  ...
  <img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/hidream_e1_full.png" alt="HiDream E1 の出力例" style={{width: '100%', height: 'auto', objectFit: 'contain'}} />
</div>
