...
<CardGroup cols={2}>
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_e1_1&utm_source=docs&utm_medium=referral&utm_campaign=hidream_e1">
    Comfy Cloud で開く
  </Card>
...
<CardGroup cols={2}>
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_e1_full&utm_source=docs&utm_medium=referral&utm_campaign=hidream_e1">
    Comfy Cloud で開く
  </Card>
