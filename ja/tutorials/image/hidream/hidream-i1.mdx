...
<CardGroup cols={2}>
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_i1_full&utm_source=docs">
...
<CardGroup cols={2}>
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_i1_dev&utm_source=docs">
    セットアップ不要で Comfy Cloud で実行
  </Card>
...
<CardGroup cols={2}>
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=hidream_i1_fast&utm_source=docs">
    セットアップ不要で Comfy Cloud で実行
  </Card>
