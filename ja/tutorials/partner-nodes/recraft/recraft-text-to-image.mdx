...
## Recraft Text to Image が得意なこと

- **高品質な生成**: Recraft AI の画像生成技術を使用して、テキストの説明から画像を作成します
- **スタイル制御**: `Recraft Style` ノードを使用して、デジタルアート、リアルな写真、ロゴデザインなどのプリセットスタイルを選択できます
- **色の制御**: `Recraft Color RGB` ノードで希望の色を設定できます
- **出力サイズの調整**: `size` パラメーターを変更して、出力サイズを制御できます
- **SVG 変換**: オプションの `Recraft Vectorize Image` ノードが、生成された画像を SVG 形式に変換します
