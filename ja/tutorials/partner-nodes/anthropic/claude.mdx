...
| モデル | 特長 |
|-------|-----------|
| **Opus 5** | Anthropicの最新フラッグシップモデルで、2026年7月24日にリリース。Claude Fable 5の最先端インテリジェンスに半額で迫り、コーディングとナレッジワークの評価において新たな最高水準を達成。 |
...
- ノードの高度なオプションで、`max_tokens`（最大 32000）と `temperature`（0.0 〜 1.0）を調整します
