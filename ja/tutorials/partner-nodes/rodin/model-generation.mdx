...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=api_rodin_image_to_model&utm_source=docs">
    Comfy Cloud で開く
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=api_rodin_multiview_to_model&utm_source=docs">
    Comfy Cloud で開く
  </Card>
