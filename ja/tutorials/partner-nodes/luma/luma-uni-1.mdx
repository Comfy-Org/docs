...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/api_luma_uni_1_image_create-1.webp" alt="Luma UNI-1 画像生成ワークフローのプレビュー" />

<CardGroup cols={2}>
  <Card title="クラウドで画像生成を実行" icon="cloud" href="https://cloud.comfy.org/?template=api_luma_uni_1_image_create&utm_source=docs&utm_medium=referral&utm_campaign=luma-uni-1">
    Comfy Cloud で画像生成ワークフローを即座に試す。
  </Card>
  <Card title="画像生成ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_luma_uni_1_image_create.json">
