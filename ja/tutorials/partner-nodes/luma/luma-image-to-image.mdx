...
[Luma Image to Image](/ja/built-in-nodes/partner-node/image/luma/luma-image-to-image) ノードは、Luma AI の技術を活用してテキストプロンプトに基づき既存の画像を編集する機能を提供します。この際、元の画像の特定の特徴や構造を保持することが可能です。
