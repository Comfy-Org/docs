...
現在、[Ideogram V3](/ja/built-in-nodes/partner-node/image/ideogram/ideogram-v3) ノードは以下の2つのモードをサポートしています：
...
- [Ideogram V3](/ja/built-in-nodes/partner-node/image/ideogram/ideogram-v3)

## Ideogram 3.0 API ノード：テキストから画像を生成するモード

画像入力およびマスク入力を行わずに [Ideogram V3](/ja/built-in-nodes/partner-node/image/ideogram/ideogram-v3) を使用する場合、ノードはテキストから画像を生成するモードで動作します。
