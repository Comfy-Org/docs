...
translationSourceHash: 3f87786f
...
- **画像リミックス**：一貫性を保ちながら、参照画像の要素をターゲット画像に組み合わせ
...
テキストプロンプトを入力して、詳細な美学と正確なテキストレンダリングを備えた高品質な画像を生成します。
...
<CardGroup cols={2}>
  <Card title="Comfy Cloudで実行" icon="cloud" href="https://cloud.comfy.org/?template=api_reve_image_create&utm_source=docs&utm_medium=referral&utm_campaign=reve-image">
    Comfy Cloudで開く
  </Card>
  <Card title="ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/archived/api_reve_image_create.json">
    JSONをダウンロードするか、テンプレートライブラリで&quot;Reve: Text to Image&quot;を検索
  </Card>
</CardGroup>
...
以下の例は、細部まで保持された4K解像度の出力を示しています：
...
画像をアップロードし、テキストの指示で編集します。Reveの高度な編集モデルを使って、変更された出力画像を生成します。
...
<CardGroup cols={2}>
  <Card title="Comfy Cloudで実行" icon="cloud" href="https://cloud.comfy.org/?template=api_reve_image_edit&utm_source=docs&utm_medium=referral&utm_campaign=reve-image">
    Comfy Cloudで開く
  </Card>
  <Card title="ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/archived/api_reve_image_edit.json">
    JSONをダウンロードするか、テンプレートライブラリで&quot;Reve: Image Edit&quot;を検索
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="woman_running_in_field.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/woman_running_in_field.png">
    `LoadImage`ノード 4 · `woman_running_in_field.png`
  </Card>
</CardGroup>
...
Reveの高度なモデルを使って画像をリミックスおよび編集します。複数の参照画像を1つの出力に組み合わせます。
...
<CardGroup cols={2}>
  <Card title="Comfy Cloudで実行" icon="cloud" href="https://cloud.comfy.org/?template=api_reve_image_remix&utm_source=docs&utm_medium=referral&utm_campaign=reve-image">
    Comfy Cloudで開く
  </Card>
  <Card title="ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/archived/api_reve_image_remix.json">
    JSONをダウンロードするか、テンプレートライブラリで&quot;Reve: Image Remix And Edit&quot;を検索
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="iced_drink_cup.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/iced_drink_cup.png">
    `LoadImage`ノード 2 · `iced_drink_cup.png`
  </Card>
  <Card title="casual_male_portrait.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/casual_male_portrait.png">
    `LoadImage`ノード 4 · `casual_male_portrait.png`
  </Card>
  <Card title="japanese_street_alley.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/japanese_street_alley.png">
    `LoadImage`ノード 5 · `japanese_street_alley.png`
  </Card>
</CardGroup>
...
2. 左サイドバーのノードライブラリまたはテンプレートで、Reve Image Create、Reve Image Remix、Reve Image Editノードを**探します**。
3. ノードをキャンバスに**ドロップ**して開始します。

## 利用可能なノード

| ノード | タイプ | 説明 |
|------|------|-------------|
| **Reve Image Create** | テキストから画像へ | テキストプロンプトから最大4K解像度の画像を生成 |
| **Reve Image Edit** | 画像編集 | 既存の画像の照明、カラーグレーディング、モーションを変更 |
| **Reve Image Remix** | 画像リミックス | 参照画像の視覚的プロパティをターゲット画像に転送 |
