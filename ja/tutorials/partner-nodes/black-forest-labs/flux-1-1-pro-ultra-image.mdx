...
## Flux 1.1 Pro Ultra Imageが得意なこと

- **ウルトラ高解像度**: 最大4MPの画像を生成。スタンダードバージョンの解像度の4倍
- **高速生成**: 単一画像の生成時間を10秒未満に維持し、同様の高解像度モデルより2.5倍高速
- **スケール対応のプロンプト精度**: Ultra Modeは生成速度を維持しながらプロンプトを正確に反映。広告やeコマース業務に適している
- **自然なリアリズム**: Raw Modeは肌の色、照明、風景の詳細を最適化し、「AIらしさ」を軽減
