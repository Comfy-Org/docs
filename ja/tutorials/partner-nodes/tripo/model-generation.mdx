...
<CardGroup cols={2}>
  <Card title="Run Text-to-Model on Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_tripo_text_to_model&utm_source=docs">
...
<CardGroup cols={2}>
  <Card title="Run Image-to-Model on Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_tripo_image_to_model&utm_source=docs">
...
<CardGroup cols={2}>
  <Card title="Run Multiview-to-Model on Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_tripo_multiview_to_model&utm_source=docs">
