...
## Seed Audio 1.0 が得意なこと

- **マルチモーダルオーディオ生成**: 1つのプロンプトから、音声、音楽、サウンドエフェクト、環境オーディオを生成します。聞こえた内容を説明するだけで、Seed Audio がそれを生成します
- **ボイスクローン**: プロンプト内で `@Audio1`、`@Audio2`、`@Audio3` とタグ付けされた最大3つの参照クリップから音声をクローンし、複数キャラクターのダイアログや一貫性のあるナレーションを実現します
- **プリセット音声**: 参照クリップなしで信頼性の高い高品質なナレーションが必要な場合に、内蔵の TTS 2.0 音声から選択できます
- **画像駆動の音声**: キャラクター画像から音声を導き出し、トーンとスタイルを視覚的な被写体に合わせます
- **きめ細かな制御**: 生成ごとに話速、ピッチ、音量、サンプルレートを個別に調整できます
- **複数話者のダイアログ**: プロンプト内でキャラクター名を指定すると、Seed Audio が音声の割り当て、交代での発話、感情表現を処理します
- **1回の実行で最大2分**: ナレーション、ポッドキャストクリップ、ビデオ吹き替え、サウンドデザインに適した長尺オーディオクリップを生成できます

これらの機能により、Seed Audio 1.0 は、ビデオのボイスオーバー、複数キャラクターのオーディオドラマ、製品デモ、eラーニングのナレーション、ゲームオーディオのプロトタイピング、アクセシビリティコンテンツなど、幅広いユースケースに対応します。
