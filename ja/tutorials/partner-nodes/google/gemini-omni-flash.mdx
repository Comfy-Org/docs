...
### テキストから動画へ（Omni Flash） {#api_google_gemini_omni_flash_t2v}

プレビュー版の Gemini Omni Flash モデルを使って、単一のテキストプロンプトから動画を生成します。シーン、長さ、アスペクト比を 1 つのプロンプトで記述するだけで、ネイティブ音声トラック付きのクリップをレンダリングします。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/api_google_gemini_omni_flash_t2v-1.webp" alt="Gemini Omni Flash テキストから動画ワークフローのプレビュー" />
...
<CardGroup cols={2}>
  ...
  <Card title="ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_google_gemini_omni_flash_t2v.json">
    JSON をダウンロードするか、テンプレートライブラリで「Gemini Omni」を検索してください
  </Card>
</CardGroup>

<Note>
プレビュー版の Omni Flash モデルは 2026 年 9 月 30 日に提供終了予定です。GA モデルについては、以下の Omni Flash 1.1 ワークフローを使用してください。
</Note>
