...
[Stability AI Stable Diffusion 3.5 Image](/ja/built-in-nodes/partner-node/image/stability-ai/stability-ai-stable-diffusion-3-5-image) ノードを使用すると、Stability AI の Stable Diffusion 3.5 モデルを活用し、テキストプロンプトまたは参照画像をもとに高品質でディテール豊かな画像コンテンツを作成できます。
