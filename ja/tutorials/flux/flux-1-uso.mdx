...
<CardGroup cols={2}>
  <Card title="JSON ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux1_dev_uso_reference_image_gen.json">
    ワークフロー JSON をダウンロードし、ComfyUI にドラッグ＆ドロップしてください
  </Card>
