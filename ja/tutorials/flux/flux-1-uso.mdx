...
className="prose"
target='_blank'
href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux1_dev_uso_reference_image_gen.json"
...
<CardGroup cols={2}>
  <Card title="Download JSON Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/flux1_dev_uso_reference_image_gen.json">
