...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=flux_canny_model_example&utm_source=docs">
    Comfy Cloud で開く
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=flux_depth_lora_example&utm_source=docs">
    Comfy Cloud で開く
  </Card>
</CardGroup>
