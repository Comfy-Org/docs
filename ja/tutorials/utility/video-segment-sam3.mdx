...
SAM 3.1 は ComfyUI でネイティブサポートされており（PR [#13408](https://github.com/Comfy-Org/ComfyUI/pull/13408)）、モデルウェイトは [Apache 2.0 ライセンス](https://github.com/facebookresearch/sam3/blob/main/LICENSE) のもとで提供されています。
