...
3. `Queue` をクリックするか、`Ctrl(cmd) + Enter` で実行します### SeedVR2 7B Int8：画像の拡大 {#utility_seedvr2_7b_int8_upscale_image}
...
3. `Queue` をクリックするか、`Ctrl(cmd) + Enter` を使用して実行します### SeedVR2 3B Int8：ビデオのアップスケール {#utility_seedvr2_3b_int8_upscale_video}
