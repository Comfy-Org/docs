...
動画の顔検出には、ComfyUI メニューから "Video Face Detection (Mediapipe)" blueprint を開いてください。同じ検出サブグラフを、トリム、フレーム処理、動画出力を備えたビデオパイプラインでラップしています。

<Card title="Video Face Detection Blueprint を開く" icon="book-open" href="https://github.com/Comfy-Org/ComfyUI/blob/master/blueprints/Video%20Face%20Detection%20(Mediapipe).json">
  ComfyUI リポジトリから Video Face Detection blueprint にアクセス
</Card>
