...
VOID（Video Object Inpainting and Deletion）は、Netflix が 2026年5月14日にオープンソース化した強力なビデオ修復モデルで、[CogVideoX](https://github.com/THUDM/CogVideo) をベースに構築されています。2パス拡散パイプラインを採用し、動画からオブジェクトを削除し、時間的に一貫性のあるコンテンツで穴を埋めます。
