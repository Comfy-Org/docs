...
本チュートリアルを[テキストから画像へ（Text to Image）](/ja/tutorials/basic/text-to-image)のチュートリアルと丁寧に比較してみると、  
...
関連する原理については、[テキストから画像へ（Text to Image）](/ja/tutorials/basic/text-to-image) チュートリアル内の原理解説をご参照ください。
