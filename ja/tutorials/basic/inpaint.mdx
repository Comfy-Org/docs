...
一方、[512-inpainting-ema.safetensors](https://huggingface.co/Comfy-Org/stable_diffusion_2.1_repackaged/blob/main/512-inpainting-ema.safetensors) モデルを用いた結果は、より高品質なインペインティング効果と、自然な境界のトランジションが得られます。  
