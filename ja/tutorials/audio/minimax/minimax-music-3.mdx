---
title: "ComfyUI の MiniMax Music 3: AI 音楽生成"
...
<Note>
[コミュニティライセンス](https://huggingface.co/MiniMaxAI/MiniMax-Music3/blob/main/LICENSE)では、年間売上高が 2,000 万米ドル未満の企業による商用利用が許可されています。この基準を超える場合、商用利用には [MiniMax 商用ライセンス](https://comfy.org/minimax/license)が必要です。これは、唯一の正規販売代理店である Comfy から入手できます。
</Note>
