...
ControlNet は、拡散モデル（例：Stable Diffusion）に基づく条件付き制御生成モデルであり、2023 年に [Lvmin Zhang](https://github.com/lllyasviel) 氏と Maneesh Agrawala 氏らが論文『[Adding Conditional Control to Text-to-Image Diffusion Models](https://arxiv.org/abs/2302.05543)』において初めて提案しました。
