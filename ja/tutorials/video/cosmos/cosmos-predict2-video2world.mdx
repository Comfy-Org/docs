...
sidebarTitle: "Cosmos-Predict2" "EN description specifies \"Video2World\", while ZH description mentions \"Text-to-Video and Image-to-Video\". EN workflow section is commented out, while ZH is active. EN import path for UpdateReminder differs from ZH."
