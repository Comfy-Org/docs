...
ビデオ内のキャラクターを置換し、動きとシーンのコンテキストを保持します。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_wan21_scail2_character_replacement-1.webp" alt="SCAIL-2 キャラクター置換ワークフローのプレビュー" />
...
<CardGroup cols={2}>
  <Card title="参照画像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/reference_streetwear_character.png">
    デフォルトの参照キャラクター画像をダウンロードするか、ご自身のものをご使用ください。
  </Card>
  <Card title="ドライビングビデオ" icon="video" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/driving_outdoor_dance.mp4">
    デフォルトのドライビングビデオをダウンロードするか、ご自身のものをご使用ください。
  </Card>
</CardGroup>
