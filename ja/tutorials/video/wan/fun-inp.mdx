...
sidebarTitle: "Wan2.1 Fun InP" "English Step 6 omits the technical limitation regarding MP4 vs WebP support present in the Chinese version. English header uses \"InP\" while Chinese uses \"Control\" in section 2 title. English import path differs from Chinese localized path."
