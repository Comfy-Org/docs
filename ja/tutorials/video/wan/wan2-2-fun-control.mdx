...
sidebarTitle: "Wan2.2 Fun Control" "1. Video Embed: English source uses YouTube iframe, Chinese source uses Bilibili iframe. 2. Table Structure: English source lists resolution in text above table, Chinese source includes resolution as a table column. 3. Import Path: English source uses '/snippets/tutorials/update-reminder.mdx', Chinese source uses '/snippets/zh/tutorials/update-reminder.mdx'."
