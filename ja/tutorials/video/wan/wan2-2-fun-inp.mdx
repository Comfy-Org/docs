...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_wan2_2_14B_fun_inpaint-1.webp" alt="Wan2.2 Fun Inp ワークフロープレビュー" />
...
<CardGroup cols={2}>
  ...
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_fun_inpaint&utm_source=docs&utm_medium=referral&utm_campaign=wan2-2-fun-inp">
    Comfy Cloud で開く
  </Card>
