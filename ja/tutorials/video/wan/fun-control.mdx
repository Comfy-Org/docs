...
sidebarTitle: "Wan2.1 Fun Control" "The English \"Usage Tips\" section combines content that appears in separate sections in the Chinese version (native workflow notes + usage tips + additional custom nodes section). The structure differs slightly but semantic content is consistent."
