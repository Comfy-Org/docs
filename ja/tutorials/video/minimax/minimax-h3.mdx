...
### MiniMax H3 画像から動画への継続ワークフロー

I2Vワークフローの継続バリアントです。画像を読み込み、希望するモーション、ショット、オーディオを記述します。ワークフローは空のプロンプトで提供され、実行前に自由に編集できます。

<CardGroup cols={2}>
  <Card title="Comfy Cloud で実行" icon="cloud" href="https://cloud.comfy.org/?template=video_minimax_h3_i2v_continuation&utm_source=docs&utm_medium=referral&utm_campaign=minimax-h3">
    Comfy Cloud で開く
  </Card>
  <Card title="ワークフローをダウンロード" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_minimax_h3_i2v_continuation.json">
    JSON をダウンロードするか、テンプレートライブラリで「MiniMax H3 I2V Continuation」を検索してください
  </Card>
</CardGroup>

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_minimax_h3_i2v_continuation-1.webp" alt="MiniMax H3 画像から動画への継続ワークフロープレビュー" />
