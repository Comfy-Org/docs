...
sidebarTitle: "HunyuanVideo 1.5" "Section order differs: EN places \"Workflow templates\" before \"Model links\", while ZH places \"Model links\" before \"Workflow templates\". ZH title includes \"ComfyUI Tutorial\" whereas EN does not."
