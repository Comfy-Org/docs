...
**機能説明：** 照明が一致した編集画像を生成し、前後の比較を並べて表示します。ポートレートやプロダクトの再照明、写真コレクションの一貫した照明、Eコマースカタログ撮影に最適です。

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_bernini_r_image_editing-1.webp" alt="Bernini-R 画像編集ワークフロープレビュー" />
...
<CardGroup cols={2}>
  <Card title="入力画像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/example.png">
    デフォルトの入力画像をダウンロードするか、独自の画像を使用してください。
  </Card>
  <Card title="参照画像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/desert_oasis_backyard.png">
    デフォルトの参照画像をダウンロードするか、独自の画像を使用してください。
  </Card>
</CardGroup>
...
**参照画像入力：** **Subject to Image** で使用します。1枚以上の参照画像（被写体、服、シーン、小道具）が必要な場合に使用します。プロンプト内で `image0`、`image1` などを使って各画像を参照します。**Image Editing** タスクでは不要です。代わりに `source_image` を使用します。
...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_bernini_r_video_editing-1.webp" alt="Bernini-R 動画編集ワークフロープレビュー" />
...
<CardGroup cols={2}>
  <Card title="入力動画" icon="video" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/vintage_field_style_look.mp4">
    デフォルトの入力動画をダウンロードするか、独自の動画を使用してください。
  </Card>
  <Card title="参照画像" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/example.png">
    デフォルトの参照画像をダウンロードするか、独自の画像を使用してください。
  </Card>
</CardGroup>
