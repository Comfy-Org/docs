...
<CardGroup cols={2}>
  <Card title="Download JSON Workflow File" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_kandinsky5_t2v.json">
...
<CardGroup cols={2}>
  <Card title="Download JSON Workflow File" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_kandinsky5_i2v.json">
