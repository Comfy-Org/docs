---
title: "Javascript 拡張" "English source contains typo '__init_.py' (single underscore) in prose, Chinese reference corrects to '__init__.py'. Also EN phrase 'follows is to' contains grammar error."
