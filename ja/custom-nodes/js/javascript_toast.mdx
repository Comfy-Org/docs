---
title: "Toast API"
description: "ComfyUI の Toast API で、ユーザーに非ブロッキングの通知メッセージを表示します。基本的な使い方、toast タイプ（success、warning、error）、alert ヘルパー、完全な API リファレンスをカバーします。"
translationSourceHash: b38df222
