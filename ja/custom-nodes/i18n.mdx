    ...
    settings: [
        {
            ...
            category: ["I18nDemo","DebugMode"], // main.json の settingsCategories キーと一致します
            name: "Enable Debug Mode", // 翻訳によって上書きされます
            tooltip: "Show debug information in console for i18n demo nodes", // 翻訳によって上書きされます
            type: "boolean",
            defaultValue: false,
            experimental: true,
            onChange: (value) => {
        ...
        },
        {
            ...
            category: ["I18nDemo","DefaultTextOperation"], // main.json の settingsCategories キーと一致します
            name: "Default Text Operation", // 翻訳によって上書きされます
            tooltip: "Default operation for text processor node", // 翻訳によって上書きされます
            type: "combo",
