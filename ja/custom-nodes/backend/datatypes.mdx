...
description: "ComfyUI カスタムノードのデータ型リファレンス：Python 型、テンソル形式（IMAGE、LATENT、MASK）、カスタム型、INPUT_TYPES のワイルドカード。"
...
これらは最も重要な組み込みデータ型です。[独自のデータ型を定義する](./more_on_inputs#カスタムデータ型) こともできます。
...
[ノイズ混合の例](./snippets#ノイズバリエーションの作成) を参照
