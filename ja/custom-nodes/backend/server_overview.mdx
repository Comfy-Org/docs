---
title: "プロパティ"
description: "カスタムノードのプロパティ" "The English source code block under \"Validating Types\" is missing a comma after the `input1` definition, whereas the Chinese reference includes it. I have preserved the English source code exactly as per instructions."
