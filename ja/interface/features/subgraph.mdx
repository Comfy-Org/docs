...
<Steps>
    ...
    <Step title="サブグラフアイコンをクリック">
        ![サブグラフアイコン](/images/interface/features/subgraph/subgraph_icon.jpg)
        ツールバーでサブグラフアイコンを見つけます
    </Step>
    <Step title="サブグラフが作成されました">
        ![サブグラフを使用したワークフロー](/images/interface/features/subgraph/workflow_using_subgraph.jpg)
    ...
    <Step title="サブグラフをカスタマイズ">
        ...
        ![サブグラフを使用したワークフロー](/images/interface/features/subgraph/subgraph_after_edited.jpg)
    </Step>
</Steps>
