...
sidebarTitle: "サブグラフ"
icon: "share-nodes" "The English Note states that converting subgraphs back to nodes will be supported in the future, but the English body section \"Unpack Subgraphs to Nodes\" and the Chinese reference indicate this feature is currently available."
