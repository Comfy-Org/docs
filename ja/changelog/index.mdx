...
**パートナーノードの更新**
* [**GPT-6 Astra**](https://github.com/Comfy-Org/ComfyUI/pull/16125): OpenAI Chat ノードに `gpt-6-astra` モデルを追加し、推論の努力レベルをサポートしました。

**パートナーノードの削除**
* [**提供終了モデル**](https://github.com/Comfy-Org/ComfyUI/pull/16121): ベンダーがサービスを終了したモデルのノードを削除しました：OpenAI DALL·E 2 および DALL·E 3、LTX-2（Fast および Pro）、Seedream 3.0、Seedance 1.0 Lite、Kling Video Extend ノード、および ByteDance参照画像から動画生成ノード。
