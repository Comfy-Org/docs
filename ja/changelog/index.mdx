...
<Update label="v0.37.2" description="2026年9月23日">

**パートナーノードの更新**
* [**Recraft V4.1 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16501): Recraft V4 テキストから画像へのノードに Recraft V4.1 Flash を追加しました。これは同ファミリーの中で最速かつ最低コストのモデルです
* [**Claude Opus 5.5**](https://github.com/Comfy-Org/ComfyUI/pull/16479): Claude ノードに Claude Opus 5.5 を追加しました
* [**Quiver Arrow 2**](https://github.com/Comfy-Org/ComfyUI/pull/16478): SVG ノードに Arrow 2 モデルを推論エフォート制御とともに追加しました

**新しいノードの更新**
* [**Generate Text**](https://github.com/Comfy-Org/ComfyUI/pull/16442): モデルのチャットテンプレートの system ターンを置き換える `system_prompt` 入力と、独立した thinking 出力を追加しました

</Update>

<Update label="v0.37.1" description="2026年9月22日">

**パートナーノードの更新**
* [**HY Image 3.5 Preview**](https://github.com/Comfy-Org/ComfyUI/pull/16462): 最大5枚の参照画像を使ったテキストから画像への生成と画像編集、ネイティブ2K出力

</Update>

<Update label="v0.37.0" description="2026年9月21日">

**新しいオープンソースモデルのサポート**
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight): アルファチャンネルとマルチ画像参照を使ったネイティブ2K生成および編集
* [**MoGe 3**](https://github.com/Comfy-Org/ComfyUI/pull/16381): 単一画像からのきめ細かなジオメトリ推定。ViT-LおよびViT-gチェックポイントに対応

**新しいノードの更新**
* [**YuE2 CFG**](https://github.com/Comfy-Org/ComfyUI/pull/16373): YuE2 Generate MusicノードにCFG制御を追加
* [**Empty Latent Image**](https://github.com/Comfy-Org/ComfyUI/pull/16384): デフォルトの幅と高さが1024に変更

**パートナーノードの更新**
* [**GPT Image 2**](https://github.com/Comfy-Org/ComfyUI/pull/16366): 透過背景オプションを追加
* [**Meshy 7.1**](https://github.com/Comfy-Org/ComfyUI/pull/16412): Meshy 3DノードにMeshy 7.1を追加
* [**Tripo P2 outputs**](https://github.com/Comfy-Org/ComfyUI/pull/16369): 空のGLBやFBXを書き出すことになるP2の実行を拒否

**パフォーマンスと安定性**
* [**Auto fast-disk**](https://github.com/Comfy-Org/ComfyUI/pull/16333): 高速NVMeで`--fast-disk`を自動有効化。さらにAimdo 0.5.5と`--disable-fast-disk`
* [**Qwen text encoders**](https://github.com/Comfy-Org/ComfyUI/pull/15623): Qwen3、3.5、3.8向けのCUDAグラフとW4A8 GEMV
* [**Dynamic VRAM text encoder**](https://github.com/Comfy-Org/ComfyUI/pull/16374): 動的VRAMが有効なときはテキストエンコーダをGPU上に保持
* [**Wan VRAM**](https://github.com/Comfy-Org/ComfyUI/pull/16418): comfy-kitchenアテンションによるピークVRAMの低減

**バグ修正**
* [**ACE-Step VAE**](https://github.com/Comfy-Org/ComfyUI/pull/16405): 非bf16 GPUでのVAEデコードクラッシュを修正
* [**MiniMax Music 3**](https://github.com/Comfy-Org/ComfyUI/pull/16428): CUDAグラフ有効時のノイズ混入した出力を修正

</Update>

<Update label="v0.36.0" description="2026年9月15日">

**新しいオープンソースモデルのサポート**
* [**FastVideo FastH3**](https://cloud.comfy.org/?template=video_fastvideo_fasth3_i2v): テキストから動画へ、および画像から動画への生成に対応した FastVideo 8ステップ蒸留 MiniMax H3。ネイティブオーディオ付き
* [**Marigold V2**](https://github.com/Comfy-Org/ComfyUI/pull/16232): 単一画像からの深度、表面ノーマル、アルベド推定
* [**YuE2**](https://github.com/Comfy-Org/ComfyUI/pull/16250): スタイルプロンプトと歌詞からの音楽生成

**新しいノードの更新**
* [**Video Concatenate**](https://github.com/Comfy-Org/ComfyUI/pull/16267): 複数のビデオクリップを連結
* [**Generic Loops**](https://github.com/Comfy-Org/ComfyUI/pull/16227): グラフ内のリストをループし、異種のアイテムを各イテレーションで引き継ぎ、ノードスキーマでループ境界を宣言
* [**Linear color space**](https://github.com/Comfy-Org/ComfyUI/pull/16247): ImageColorSpace にリニアを追加
* [**Gemini V3 ノード**](https://github.com/Comfy-Org/ComfyUI/pull/16287): GeminiNodeV3 を追加し、V2 ノードを非推奨化

**パートナーノードの更新**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): P2 モデルによるテキスト、画像、マルチビューからの3Dモデル生成
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): テキストから動画へ、画像から動画へ。720p/1080p 出力とドラフトモードに対応
* [**Flux Video Edit**](https://github.com/Comfy-Org/ComfyUI/pull/16259): テキスト指示からソースクリップを編集: オブジェクトの削除や置き換え、映像のリスタイル、画面上のテキストやセリフの変更
* [**Bria edit suite**](https://github.com/Comfy-Org/ComfyUI/pull/16264): 新しい画像編集ノードと Video Eraser ノード

**パフォーマンスと安定性**
* [**Auto fast-disk**](https://github.com/Comfy-Org/ComfyUI/pull/16333): ディスクが高速な場合に `--fast-disk` を自動検出して有効化、さらに Aimdo 0.5.5
* [**MiniMax-H3 VAE**](https://github.com/Comfy-Org/ComfyUI/pull/16187): VAE の最適化と VAE メモリ使用量の削減
* [**Llama rope kernels**](https://github.com/Comfy-Org/ComfyUI/pull/16326): llama ベースのモデルで comfy-kitchen apply rope を使用し、より多くのモデルで高速カーネルを利用
* [**AMD Windows VA quota**](https://github.com/Comfy-Org/ComfyUI/pull/16199): VA クォータを 4TB に引き上げ
* [**YuE2 on AMD**](https://github.com/Comfy-Org/ComfyUI/pull/16293): AMD の問題を修正し、generate ABC ノードにコントロールを追加
* [**YuE2 longer songs**](https://github.com/Comfy-Org/ComfyUI/pull/16292): 最大再生時間を 900 秒に増加

**バグ修正**
* [**Add Noise alpha**](https://github.com/Comfy-Org/ComfyUI/pull/15626): アルファチャンネルにノイズを追加しなくなりました
* [**H3 Fun ControlNet**](https://github.com/Comfy-Org/ComfyUI/pull/16240): Comfy モデルコンパイラが有効なときの H3 Fun ControlNet を修正

**ワークフローテンプレート**
* [**Templates v0.11.62**](https://github.com/Comfy-Org/ComfyUI/pull/16350): FastH3 ビデオ、Marigold V2 推定、YuE2 音楽テンプレートを追加し、Tripo、Gemini、Ideogram ワークフローを更新

</Update>

<Update label="v0.35.2" description="2026年9月14日">

**パートナーノードの更新**
* [**Bria edit suite**](https://github.com/Comfy-Org/ComfyUI/pull/16264): 新しい画像編集ノードと Video Eraser ノード
* [**Flux Video Edit**](https://github.com/Comfy-Org/ComfyUI/pull/16259): テキスト指示からソースクリップを編集: オブジェクトの削除や置換、映像のスタイル変更、画面上のテキストやセリフの変更
* [**Gemini V3 ノード**](https://github.com/Comfy-Org/ComfyUI/pull/16287): GeminiNodeV3 を追加し、V2 ノードを非推奨に
* [**パートナーの進捗推定**](https://github.com/Comfy-Org/ComfyUI/pull/16152): パートナージョブがキュー中および実行中に、サーバーの所要時間推定から残り時間を表示

**バグ修正**
* [**H3 Fun ControlNet**](https://github.com/Comfy-Org/ComfyUI/pull/16240): Comfy モデルコンパイラが有効な場合の H3 Fun ControlNet を修正

**ワークフローテンプレート**
* [**テンプレート v0.11.60**](https://github.com/Comfy-Org/ComfyUI/pull/16319): 同梱のワークフローテンプレートを更新

</Update>

<Update label="v0.35.1" description="2026年9月10日">

**パートナーノードの更新**
* [**Tripo v3 API**](https://github.com/Comfy-Org/ComfyUI/pull/16201): Tripoノードをv3 APIに移行し、Smart Segmentノードを追加しました
* [**Microsoft MAI Image 2.6**](https://github.com/Comfy-Org/ComfyUI/pull/16188): OpenRouter Imageノードにmai-image-2.6モデルとmai-image-2.6-flashモデルを追加しました
* [**MAI 自動アスペクト比率**](https://github.com/Comfy-Org/ComfyUI/pull/16229): MAI画像ノードに自動アスペクト比率オプションを追加しました
* [**Gemini 3.8 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16195): GeminiテキストノードにGemini 3.8 Flashを追加しました

**ワークフローテンプレート**
* [**テンプレート v0.11.59**](https://github.com/Comfy-Org/ComfyUI/pull/16233): 同梱のワークフローテンプレートを更新しました
...
**パートナーノードの更新**
* [**MiniMax H3 Max**](https://github.com/Comfy-Org/ComfyUI/pull/16025): MiniMax H3 のテキストから動画、最初と最後のフレーム、リファレンスの各ノードに H3 Max モデルオプションを追加しました

**パフォーマンスと安定性**
* [**TRELLIS リメッシュのメモリ**](https://github.com/Comfy-Org/ComfyUI/pull/16034): TRELLIS ワークフローでリメッシュ処理のメモリ使用量を削減しました

**バグ修正**
* [**3D プレビューのパス**](https://github.com/Comfy-Org/ComfyUI/pull/16038): Preview3DAdvanced、PreviewGaussianSplat、PreviewPointCloud の一時パスに注釈を付け、Cloud プレビューが解決されるようにしました
...
**パートナーノードの更新**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/3UjQmgE): より高速なビデオ生成と会話型編集、4K出力とビデオ拡張に対応

**バグ修正**
* [**HEVCリマックス**](https://github.com/Comfy-Org/ComfyUI/pull/15809): HEVCをhvc1としてmp4/movにリマックスし、Apple製プレイヤーでファイルを再生できるように

</Update>

<Update label="v0.34.1" description="2026年8月26日">

**パートナーノードの更新**
* [**WAN3-Prime**](https://github.com/Comfy-Org/ComfyUI/pull/15894): Wan 3.0ノードにPrimeモデルオプションを追加しました（秒あたりのレートはより高額です）
* [**Recraft V4 Styles**](https://github.com/Comfy-Org/ComfyUI/pull/15903): スタイルIDまたは参照画像を必須とする`recraftv4_styles`モデルと、Recraft V4 Create Styleノードを追加しました
* [**Google Veo**](https://github.com/Comfy-Org/ComfyUI/pull/15883): 廃止予定のVeo 2とVeo 3.0モデルをVeoノードから削除しました
...
**新しいオープンソースモデルのサポート**
* [**Pixal3D & TRELLIS2**](https://github.com/Comfy-Org/ComfyUI/pull/14718): リメッシュ、デシメート、UVアンラップ、テクスチャベイクの後処理を備えた3Dメッシュとテクスチャの生成
* [**SAM 3D Body**](https://github.com/Comfy-Org/ComfyUI/pull/14370): 依存関係なしの3Dボディ検出とセグメンテーション、ポーズレンダリングとアニメーションエクスポートをサポート
* [**TAESD H3**](https://github.com/Comfy-Org/ComfyUI/pull/15695): プレビューを高速化する軽量VAEデコーダー

**新しいノードの更新**
* [**MiniMax-H3 prompt embeddings**](https://github.com/Comfy-Org/ComfyUI/pull/15697): プロンプト内の`embedding:`構文でMiniMax-H3エンベディングを読み込みます
* [**CreateVideo colorspace**](https://github.com/Comfy-Org/ComfyUI/pull/15810): カラースペースオプションとビット深度をコンボとして追加しました
...
**パフォーマンスと安定性**
* [**HDRビデオの保存**](https://github.com/Comfy-Org/ComfyUI/pull/15741): AV1コーデックとmkv/webmコンテナ対応のHDRビデオ保存を追加しました
...
**新たなオープンソースモデルのサポート**
* [**LTX 2.5**](https://links.comfy.org/docLTX2_5): STG、デュアルCFG、再生時間予測を備えたネイティブLTX 2.5サポート

**パートナーノードの更新**
* [**Qwen Image 3.0**](https://github.com/Comfy-Org/ComfyUI/pull/15327): Qwen-Image 3.0および3.0 Proのテキストから画像への変換ノードと編集ノードを追加しました
* [**LTX 2.5**](https://github.com/Comfy-Org/ComfyUI/pull/15501): LTX 2.5のテキスト/画像/オーディオからビデオへのパートナーノードを追加しました
* [**Grok Imagine Image 2.0**](https://github.com/Comfy-Org/ComfyUI/pull/15496): grok-imagine-image-2.0モデルのサポートを追加しました

**新規ノード**
* [**LTXV Spatio-Temporal Guidance**](https://github.com/Comfy-Org/ComfyUI/pull/15499): LTXビデオ生成向けのSTGガイダンス
* [**LTXV Modality Guidance**](https://github.com/Comfy-Org/ComfyUI/pull/15499): LTX用のオーディオ/ビデオ結合ガイダンス
* [**LTXV Dual CFG Guider**](https://github.com/Comfy-Org/ComfyUI/pull/15499): LTXワークフロー用のデュアルCFGガイダー
* [**LTXV Duration Predictor**](https://github.com/Comfy-Org/ComfyUI/pull/15499): キャプショントークンから自然なショットの再生時間を予測します

**パフォーマンスと安定性**
* [**PyTorch 2.7**](https://github.com/Comfy-Org/ComfyUI/pull/15413): 公式にサポートされる最小のPyTorchが2.7になりました
* [**MiniMax-H3 VAE**](https://github.com/Comfy-Org/ComfyUI/pull/15446): MiniMax-H3 VAEを最適化しました
* [**Comfy kitchen attention**](https://github.com/Comfy-Org/ComfyUI/pull/15479): comfy kitchenアテンションを実装しました
* [**MiniMax-H3 memory**](https://github.com/Comfy-Org/ComfyUI/pull/15486): MiniMax-H3のピークメモリの問題を修正しました
* [**ER-SDE scaler**](https://github.com/Comfy-Org/ComfyUI/pull/15428): h(t)のスケーリングによりER-SDEノイズスケーラーを拡張しました
* [**Tokenizers**](https://github.com/Comfy-Org/ComfyUI/pull/15503): MistralおよびLlamaのトークナイザーはtransformersに依存しなくなりました

**バグ修正**
* [**Upscale models**](https://github.com/Comfy-Org/ComfyUI/pull/15437): 非ダイナミックな低VRAM環境でアップスケールモデルが破損する問題を修正しました
* [**VAEDecodeTiled**](https://github.com/Comfy-Org/ComfyUI/pull/15477): NestedTensor latent（MiniMax H3）でのクラッシュを修正しました
* [**Tiled audio decode**](https://github.com/Comfy-Org/ComfyUI/pull/15502): 壊れたタイルオーディオデコードを修正しました
* [**CLIP Vision**](https://github.com/Comfy-Org/ComfyUI/pull/15506): CLIP Visionのリグレッションを修正しました
* [**Create Layered Image**](https://github.com/Comfy-Org/ComfyUI/pull/15429): より明確なフラグでCreate Layered Imageを発見しやすくしました
...
**新規オープンソースモデルサポート**
* [**Wan-Animate2**](https://github.com/Comfy-Org/ComfyUI/pull/15362): ポーズ/参照コントロールとオプションのポーズブランチキャッシュを備えたWan-Animate2のネイティブサポート (CORE-358)

**パートナーノードの更新**
* [**ByteDance SeeDance 2.5**](https://links.comfy.org/4gkNSa4): SeeDance 2.5モデルサポートを追加
* [**Seedream 5.0レイヤー分離**](https://github.com/Comfy-Org/ComfyUI/pull/15317): ByteDance Seedream 5.0 Proのレイヤー分離サポート
* [**Reve非推奨化**](https://github.com/Comfy-Org/ComfyUI/pull/15331): Reveパートナーノードを非推奨にしました

**新しいノード**
* [**Create Layered Image**](https://github.com/Comfy-Org/ComfyUI/pull/15317): ブレンドモードとレイヤー状態を備えたPSDスタイルのレイヤー合成
* [**Add Layer**](https://github.com/Comfy-Org/ComfyUI/pull/15317): コンポジターレイヤースタックにレイヤーを追加
* [**Layers From Bounding Boxes**](https://github.com/Comfy-Org/ComfyUI/pull/15317): バウンディングボックスからコンポジターレイヤーを構築
* [**WanAnimate2ToVideo**](https://github.com/Comfy-Org/ComfyUI/pull/15362): ポーズ/参照コントロールを備えたWan-Animate2の条件付け
* [**WanAnimate2Cache**](https://github.com/Comfy-Org/ComfyUI/pull/15362): Wan-Animate2を高速化するオプションのポーズブランチキャッシュ

**フロントエンドの更新**
* [**フロントエンド**](https://github.com/Comfy-Org/ComfyUI/pull/15403): comfyui-frontend-packageを1.48.7に更新
* [**画像コンポジターエディター**](https://github.com/Comfy-Org/ComfyUI_frontend/pull/14901): ImageCompositor用のPSDスタイルレイヤーエディター
* [**3Dビューア（ベータ）**](https://github.com/Comfy-Org/ComfyUI_frontend/pull/14076): 3Dビューア（ベータ）をデフォルトで有効化
* [**Save 3D Advanced**](https://github.com/Comfy-Org/ComfyUI_frontend/pull/13330): Save 3D（高度な機能）ノードファミリーを接続 (CORE-329)
* [**HFゲート付きモデル**](https://github.com/Comfy-Org/ComfyUI_frontend/pull/14338): ゲート付きHugging Faceモデルへのアクセスヒント

**パフォーマンスと安定性**
* [**LTXとWan**](https://github.com/Comfy-Org/ComfyUI/pull/15138): LTXとWanの高速化
* [**asym w4a8_int**](https://github.com/Comfy-Org/ComfyUI/pull/15308): 非対称w4a8_int量子化サポート
* [**int8_convrot VAE**](https://github.com/Comfy-Org/ComfyUI/pull/15334): MiniMax-H3用のint8_convrot VAE
* [**Linuxメモリピニング**](https://github.com/Comfy-Org/ComfyUI/pull/15266): スワップなしのLinuxでメモリの過剰ピニングを回避

**バグ修正**
* [**MiniMax H3オーディオ**](https://github.com/Comfy-Org/ComfyUI/pull/15390): EasyCache使用時のMiniMax H3オーディオ破損を修正
* [**MiniMaxサンプラー**](https://github.com/Comfy-Org/ComfyUI/pull/15243): MiniMaxオーディオサンプラーの問題を修正し、サンプラーサポートを拡張
* [**MiniMaxオーディオVAEオフロード**](https://github.com/Comfy-Org/ComfyUI/pull/15377): MiniMaxオーディオVAEの完全オフロードを修正
* [**MiniMax H3マスク**](https://github.com/Comfy-Org/ComfyUI/pull/15322): MiniMax H3の潜在ノイズマスクサンプリングを修正
* [**res_multistep**](https://github.com/Comfy-Org/ComfyUI/pull/15339): res_multistepサンプラーで不要なノイズの生成をスキップ
...
**パートナーノードの更新**
* [**BFL Flux 3 Video**](https://links.comfy.org/3TVdf9N): Flux 3 ビデオモデルのサポートを追加しました
* [**TopazAI Bloom 2 & Wonder 3.5**](https://github.com/Comfy-Org/ComfyUI/pull/15294): Bloom 2 と Wonder 3.5 モデルのサポートを追加しました
* [**Kling EOL**](https://github.com/Comfy-Org/ComfyUI/pull/15249): 廃止されたレガシー Kling モデルとバーチャル試着 API を削除しました
...
**int8 モデルサポート**
このリリースでは、**int8 convrot モデル**のサポートが追加され、量子化モデルのパフォーマンスが大幅に向上しました。int8 サポートは Turing GPU 以降で動作し、最適化された LoRA 適用とメモリ管理を提供します。

**新規ノード**
* [**Seed ノード**](https://github.com/Comfy-Org/ComfyUI/pull/14616): ワークフロー内のシード値を管理する新しい Seed ノード (CORE-295)
* [**Advanced Krea 2 モデルマージ**](https://github.com/Comfy-Org/ComfyUI/pull/14621): Krea 2 モデルをマージするための高度な機能ノード
* [**バウンディングボックスキャンバス**](https://github.com/Comfy-Org/ComfyUI/pull/14537): バウンディングボックスキャンバスノードと Ideogram JSON プロンプトのサポート (CORE-292)
* [**ConditioningMultiply**](https://github.com/Comfy-Org/ComfyUI/pull/14686): 条件付け値を乗算する新しい条件付けノード
* [**GLSL 更新**](https://github.com/Comfy-Org/ComfyUI/pull/13195): GLSL ノードが ANGLE ライブラリを使用するよう更新 (CORE-162)

**パートナーノードの更新**
* [**Nano Banana 2 Lite**](https://github.com/Comfy-Org/ComfyUI/pull/14693): Google の Nano Banana 2 Lite モデルのサポートを追加
* [**Gemini Video Omni**](https://github.com/Comfy-Org/ComfyUI/pull/14695): ビデオ生成のための新しい Gemini Video Omni ノードを追加

**パフォーマンスと安定性**
* [**int8 モデル**](https://github.com/Comfy-Org/ComfyUI/pull/14636): int8 convrot モデルのサポートを追加し、より高速な推論を実現
* [**より高速な int8**](https://github.com/Comfy-Org/ComfyUI/pull/14641): int8 カーネルのパフォーマンスを最適化
* [**Turing GPU サポート**](https://github.com/Comfy-Org/ComfyUI/pull/14662): int8 サポートを Turing アーキテクチャの GPU に拡張
* [**より良い int8 LoRA**](https://github.com/Comfy-Org/ComfyUI/pull/14685): int8 LoRA 適用を改善し、品質と速度を向上
* [**メモリリーク修正**](https://github.com/Comfy-Org/ComfyUI/pull/14697): int8 操作に関連するメモリリークを修正
* [**アセットハッシュのオプトイン**](https://github.com/Comfy-Org/ComfyUI/pull/14663): アセットハッシュを `--enable-asset-hashing` フラグでオプトインに変更 (デフォルトは無効)

**バグ修正**
* [**int8 LoRA の requant**](https://github.com/Comfy-Org/ComfyUI/pull/14650): int8 LoRA で誤った設定を使用した際の低品質な requant を修正
* [**int8 mm offloaded**](https://github.com/Comfy-Org/ComfyUI/pull/14669): オフロードされた LoRA 重みで int8 行列乗算がスキップされる問題を修正
* [**ノードカテゴリ**](https://github.com/Comfy-Org/ComfyUI/pull/14674): ノードカテゴリを更新・再編成
* [**フロントエンド**](https://github.com/Comfy-Org/ComfyUI/pull/14684): comfyui-frontend-package を 1.45.20 にアップデート
...
**パートナーノードの更新**
* [**SeeDance 2.0 Mini**](https://links.comfy.org/4eOUnjJ): ByteDance SeeDance 2.0 MiniのサポートをText-to-Video、First-Last-Frame、Referenceノードに追加
