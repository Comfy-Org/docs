...
**パートナーノードの更新**
* [**Recraft V4.1 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16501): Recraft V4 テキストから画像へのノード上でより速く、より低コストな選択肢
* [**Claude Opus 5.5**](https://github.com/Comfy-Org/ComfyUI/pull/16479): Claude ノードに追加
* [**Quiver Arrow 2**](https://github.com/Comfy-Org/ComfyUI/pull/16478): SVG ノードの Arrow 2 モデル。推論エフォート制御付き

**新しいノードの更新**
* [**Generate Text**](https://github.com/Comfy-Org/ComfyUI/pull/16442): `system_prompt` がチャットテンプレートの system ターンを置き換え、thinking 出力を追加
