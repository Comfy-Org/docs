...
<Note>
The MCP server is hosted at `https://cloud.comfy.org/mcp` — there is nothing to run locally and no Node.js required.
</Note>
...
<Steps>
  <Step title="Add the server">
    ...
    This registers the `comfyui-cloud` server with no API key — Claude Code signs in with OAuth on first connect. Add `-s user` to make it available in all your projects.
  </Step>
