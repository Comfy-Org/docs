...
Support is currently scoped to **Claude Code** and **Claude Desktop**, which sign in with **OAuth** — a one-time browser sign-in. Other clients (Cursor, Amp, etc.) will return as their OAuth support lands.
