...
After the installer finishes, complete the one-time sign-in for your client:

<CardGroup cols={2}>
  <Card title="Claude Code" icon="terminal" href="#claude-code">
    Authenticate from the CLI with `/mcp`.
  </Card>
  <Card title="Claude Desktop" icon="window" href="#claude-desktop">
    Add a custom connector in the app.
  </Card>
</CardGroup>
