...
1. Go to [Comfy Cloud Settings](https://app.comfy.org/settings) and navigate to the **Secrets** section.
2. Add your API keys:
   - For Hugging Face: Add your Hugging Face API token with the key name `HF_TOKEN`
   - For Civitai: Add your Civitai API key with the key name `CIVITAI_API_TOKEN`
