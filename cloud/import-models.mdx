...
- **Civitai**: Log in and visit [https://civitai.com/user/account](https://civitai.com/user/account) to generate your API key.
- **Hugging Face**: Visit [https://huggingface.co/settings/tokens](https://huggingface.co/settings/tokens) to generate your API token.
