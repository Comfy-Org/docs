...
Nodes that provide access to third-party models (Nano Banana, Seedance, Kling, and others). They are included with ComfyUI, run on the provider's infrastructure, and cost [Comfy credits](/interface/credits) per run.
