...
function buildTranslationInstructions(lang: LangConfig): string {
  ...
  return [
    ...
    "DO translate the text of code comments inside ``` fenced blocks, both whole-line comments and trailing comments that follow code, keeping each comment on the same line and in the same position as the English source. Never translate or alter a shebang line (`#!...`), a string literal, a variable name, or any code token. Translate all other prose outside fenced blocks.",
