...
**파트너 노드 업데이트**
* [**Recraft V4.1 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16501): Recraft V4 텍스트 기반 이미지 생성 노드에서 더 빠르고 저렴한 옵션
* [**Claude Opus 5.5**](https://github.com/Comfy-Org/ComfyUI/pull/16479): Claude 노드에 추가됨
* [**Quiver Arrow 2**](https://github.com/Comfy-Org/ComfyUI/pull/16478): SVG 노드에서 추론 강도 제어를 지원하는 Arrow 2 모델
...
**파트너 노드 업데이트**
* [**HY Image 3.5 Preview**](https://github.com/Comfy-Org/ComfyUI/pull/16462): 텍스트 기반 이미지 생성 및 이미지 편집, 참조 5개, 네이티브 2K 출력
...
**새 오픈소스 모델 지원**
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight): 알파 채널 및 다중 이미지 참조를 사용한 네이티브 2K 생성 및 편집 ([텍스트-이미지](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_t2i.json), [이미지 편집](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_image_edit.json))
* [**MoGe 3**](https://github.com/Comfy-Org/ComfyUI/pull/16381): 단일 이미지로부터 미세 디테일 기하 추정; ViT-L 및 ViT-g 체크포인트

**파트너 노드 업데이트**
* [**GPT Image 2**](https://github.com/Comfy-Org/ComfyUI/pull/16366): 투명 배경 옵션 추가
* [**Meshy 7.1**](https://github.com/Comfy-Org/ComfyUI/pull/16412): Meshy 7.1이 이제 Meshy 3D 노드에서 사용 가능합니다
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369): 빈 GLB 또는 FBX를 출력하게 될 P2 실행을 거부합니다
...
**새로운 오픈 소스 모델 지원**
* [**FastVideo FastH3**](https://github.com/Comfy-Org/ComfyUI/pull/16072): 네이티브 오디오를 갖춘 텍스트 기반 비디오 생성 및 이미지 기반 비디오 생성용 8단계 증류 MiniMax H3
...
**파트너 노드 업데이트**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): 텍스트, 이미지, 멀티뷰 기반 3D 모델 생성
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): 텍스트 기반 비디오 생성 및 이미지 기반 비디오 생성, 720p/1080p 출력, 드래프트 모드
* [**FLUX Video Edit**](https://github.com/Comfy-Org/ComfyUI/pull/16259): 텍스트 지시 기반 비디오 편집: 객체 교체, 푸티지 스타일 변경, 대사 편집
* [**Bria edit suite**](https://github.com/Comfy-Org/ComfyUI/pull/16264): 새 이미지 편집 노드와 비디오 지우개 노드
...
**파트너 노드 업데이트**
* [**MiniMax H3 Max**](https://github.com/Comfy-Org/ComfyUI/pull/16025): 텍스트 기반 비디오 생성, 첫 번째/마지막 프레임, 참조 노드에 H3 Max 옵션을 추가합니다.
...
**파트너 노드 업데이트**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/4wZcACf): 더 빠른 비디오 생성 및 대화형 편집, 4K 출력 및 비디오 확장 지원
...
**새로운 오픈소스 모델 지원**
* [**Pixal3D & TRELLIS2**](https://github.com/Comfy-Org/ComfyUI/pull/14718): 리메시, 데시메이트, UV 언랩, 텍스처 베이크를 포함한 3D 메시 및 텍스처 생성
* [**SAM 3D Body**](https://github.com/Comfy-Org/ComfyUI/pull/14370): 의존성 없는 3D 바디 감지 및 세그멘테이션, 포즈 렌더링 및 애니메이션 내보내기 지원
* [**TAESD H3**](https://github.com/Comfy-Org/ComfyUI/pull/15695): 더 빠른 미리보기를 위한 경량 VAE 디코더

**파트너 노드 업데이트**
* [**PixVerse V6**](https://github.com/Comfy-Org/ComfyUI/pull/15880): 네이티브 오디오를 포함한 V6 텍스트 기반 비디오 생성, 이미지 기반 비디오 생성, first-last-frame, extend, fusion 노드가 추가되었습니다.
* [**Tripo**](https://github.com/Comfy-Org/ComfyUI/pull/15851): 폐기된 Refine Draft 모델 노드와 v2.0 모델 버전이 제거되었습니다.
...
**새로운 오픈소스 모델 지원**
* [**LTX 2.5**](https://links.comfy.org/relLTX2_5): STG, 이중 CFG, 재생 시간 예측을 포함한 네이티브 지원

**파트너 노드 업데이트**
* [**Qwen Image 3.0**](https://github.com/Comfy-Org/ComfyUI/pull/15327): 3.0 및 3.0 Pro 텍스트 기반 이미지 생성 및 편집 노드 추가
* [**LTX 2.5**](https://github.com/Comfy-Org/ComfyUI/pull/15501): 텍스트, 이미지, 오디오를 비디오로 변환하는 파트너 노드
* [**Grok Imagine Image 2.0**](https://github.com/Comfy-Org/ComfyUI/pull/15496): grok-imagine-image-2.0 모델 지원 추가
...
**새로운 오픈소스 모델 지원**
* [**Wan-Animate2**](https://github.com/Comfy-Org/ComfyUI/pull/15362): 네이티브 Wan-Animate2, 포즈/참조 컨트롤 및 선택적 포즈 브랜치 캐시 포함

**파트너 노드 업데이트**
* [**ByteDance SeeDance 2.5**](https://links.comfy.org/4hW2fmz): ByteDance SeeDance 2.5 모델 지원 추가
* [**Seedream 5.0 Layer Separation**](https://github.com/Comfy-Org/ComfyUI/pull/15317): ByteDance Seedream 5.0 Pro 레이어 분리 지원
* [**Reve 지원 중단됨**](https://github.com/Comfy-Org/ComfyUI/pull/15331): Reve 파트너 노드가 지원 중단되었습니다

**새로운 노드 업데이트**
* [**Create Layered Image**](https://github.com/Comfy-Org/ComfyUI/pull/15317): PSD 스타일 레이어 합성, 블렌드 모드 및 레이어 상태 지원
* [**Add Layer**](https://github.com/Comfy-Org/ComfyUI/pull/15317): 컴포지터 레이어 스택에 레이어 추가
* [**Layers From Bounding Boxes**](https://github.com/Comfy-Org/ComfyUI/pull/15317): 바운딩 박스 입력에서 컴포지터 레이어 구성
* [**WanAnimate2ToVideo**](https://github.com/Comfy-Org/ComfyUI/pull/15362): 포즈 및 참조 컨트롤이 포함된 Wan-Animate2 조건화
* [**WanAnimate2Cache**](https://github.com/Comfy-Org/ComfyUI/pull/15362): Wan-Animate2 속도를 높이기 위한 선택적 포즈 브랜치 캐시
...
**파트너 노드 업데이트**
* [**BFL Flux 3 Video**](https://links.comfy.org/3TVdfGP): Flux 3 비디오 모델 지원이 추가되었습니다.
