...
**파트너 노드 업데이트**
* [**PixVerse V6**](https://github.com/Comfy-Org/ComfyUI/pull/15880): V6 텍스트 기반 비디오 생성, 이미지 기반 비디오 생성, 확장(extend), 퓨전(fusion) 노드와 네이티브 오디오를 추가합니다
* [**Tripo**](https://github.com/Comfy-Org/ComfyUI/pull/15851): 지원 종료된 Refine Draft 노드와 v2.0 모델 버전을 제거합니다
