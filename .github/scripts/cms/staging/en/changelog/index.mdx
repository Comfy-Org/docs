...
* [**Recraft V4.1 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16501): Faster, lower-cost option on the Recraft V4 text-to-image node
* [**Claude Opus 5.5**](https://github.com/Comfy-Org/ComfyUI/pull/16479): Added to the Claude node
* [**Quiver Arrow 2**](https://github.com/Comfy-Org/ComfyUI/pull/16478): Arrow 2 models with reasoning effort control on SVG nodes
...
**Partner Node Updates**
* [**HY Image 3.5 Preview**](https://github.com/Comfy-Org/ComfyUI/pull/16462): Text-to-image and image edit, 5 references, native 2K output
...
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight): Native 2K generation and editing with alpha channel and multi-image references ([text to image](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_t2i.json), [image edit](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_image_edit.json))
* [**MoGe 3**](https://github.com/Comfy-Org/ComfyUI/pull/16381): Fine-detail geometry estimation from a single image; ViT-L and ViT-g checkpoints

**Partner Node Updates**
* [**GPT Image 2**](https://github.com/Comfy-Org/ComfyUI/pull/16366): Adds a transparent background option
* [**Meshy 7.1**](https://github.com/Comfy-Org/ComfyUI/pull/16412): Meshy 7.1 now available on Meshy 3D nodes
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369): Refuses P2 runs that would write empty GLB or FBX
...
**New Open-Source Model Support**
* [**FastVideo FastH3**](https://github.com/Comfy-Org/ComfyUI/pull/16072): 8-step distilled MiniMax H3 for text-to-video and image-to-video with native audio
...
**Partner Node Updates**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): Text, image, and multiview to 3D model generation
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): Text-to-video and image-to-video, 720p/1080p output, draft mode
* [**Flux Video Edit**](https://github.com/Comfy-Org/ComfyUI/pull/16259): Text-instruction video editing: replace objects, restyle footage, edit dialogue
* [**Bria edit suite**](https://github.com/Comfy-Org/ComfyUI/pull/16264): New image edit nodes plus a Video Eraser node
