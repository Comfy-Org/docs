...
* [**PixVerse V6**](https://github.com/Comfy-Org/ComfyUI/pull/15880): Adds V6 text-to-video, image-to-video, extend, and fusion nodes with native audio
* [**Tripo**](https://github.com/Comfy-Org/ComfyUI/pull/15851): Removes retired Refine Draft node and v2.0 model version
