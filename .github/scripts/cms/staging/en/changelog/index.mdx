...
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight): Native 2K generation and editing with alpha channel and multi-image references
