...
**パートナーノードの更新**
* [**Recraft V4.1 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16501): Recraft V4のテキストから画像へのノードで、より高速で低コストなオプション
* [**Claude Opus 5.5**](https://github.com/Comfy-Org/ComfyUI/pull/16479): Claudeノードに追加
* [**Quiver Arrow 2**](https://github.com/Comfy-Org/ComfyUI/pull/16478): SVGノードで推論エフォート制御を備えたArrow 2モデル
...
**パートナーノードの更新**
* [**HY Image 3.5 Preview**](https://github.com/Comfy-Org/ComfyUI/pull/16462): テキストから画像への生成と画像編集、参照5件、ネイティブ2K出力
...
**新しいオープンソースモデルのサポート**
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight): アルファチャンネルと複数画像参照に対応したネイティブ2K生成・編集（[テキストから画像](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_t2i.json)、[画像編集](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_image_edit.json)）
* [**MoGe 3**](https://github.com/Comfy-Org/ComfyUI/pull/16381): 単一画像からの高精細なジオメトリ推定。ViT-LおよびViT-gチェックポイント

**パートナーノードの更新**
* [**GPT Image 2**](https://github.com/Comfy-Org/ComfyUI/pull/16366): 背景を透明にするオプションを追加
* [**Meshy 7.1**](https://github.com/Comfy-Org/ComfyUI/pull/16412): Meshy 7.1がMeshy 3Dノードで利用可能に
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369): 空のGLBまたはFBXを書き込むP2実行を拒否
...
**新しいオープンソースモデルのサポート**
* [**FastVideo FastH3**](https://github.com/Comfy-Org/ComfyUI/pull/16072): テキストから動画へおよび画像から動画へ向けの、ネイティブオーディオ付き8ステップ蒸留MiniMax H3
* [**Marigold V2**](https://github.com/Comfy-Org/ComfyUI/pull/16232): 単一画像からの深度、サーフェスノーマル、アルベド推定
* [**YuE2**](https://github.com/Comfy-Org/ComfyUI/pull/16250): スタイルプロンプトと歌詞からの音楽生成

**パートナーノードの更新**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): テキスト、画像、マルチビューからの3Dモデル生成
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): テキストから動画へおよび画像から動画へ、720p/1080p出力、ドラフトモード
* [**Flux Video Edit**](https://github.com/Comfy-Org/ComfyUI/pull/16259): テキスト指示によるビデオ編集：オブジェクトの置換、映像のスタイル変更、セリフの編集
* [**Bria edit suite**](https://github.com/Comfy-Org/ComfyUI/pull/16264): 新しい画像編集ノードとビデオ消しゴムノード
...
**パートナーノードの更新**
* [**MiniMax H3 Max**](https://github.com/Comfy-Org/ComfyUI/pull/16025): テキストから動画、最初と最後のフレーム、および参照の各ノードに H3 Max オプションを追加します。
...
**パートナーノードの更新**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/4wZcACf): より高速なビデオ生成と対話型編集、4K出力とビデオ拡張に対応。
...
**新しいオープンソースモデルのサポート**
* [**Pixal3D & TRELLIS2**](https://github.com/Comfy-Org/ComfyUI/pull/14718): リメッシュ、デシメート、UV展開、テクスチャベイクを備えた3Dメッシュとテクスチャの生成
* [**SAM 3D Body**](https://github.com/Comfy-Org/ComfyUI/pull/14370): 依存関係のない3D人体検出とセグメンテーション（ポーズレンダリングとアニメーションエクスポート付き）
* [**TAESD H3**](https://github.com/Comfy-Org/ComfyUI/pull/15695): プレビューを高速化する軽量VAEデコーダー

**パートナーノードの更新**
* [**PixVerse V6**](https://github.com/Comfy-Org/ComfyUI/pull/15880): V6のテキストから動画、画像から動画、最初と最後のフレーム、延長、フュージョンの各ノードをネイティブオーディオ付きで追加
* [**Tripo**](https://github.com/Comfy-Org/ComfyUI/pull/15851): 廃止されたRefine Draftモデルノードとv2.0モデルバージョンを削除
...
**新規オープンソースモデルサポート**
* [**LTX 2.5**](https://links.comfy.org/relLTX2_5): STG、デュアルCFG、再生時間予測を備えたネイティブサポート

**パートナーノードの更新**
* [**Qwen Image 3.0**](https://github.com/Comfy-Org/ComfyUI/pull/15327): 3.0および3.0 Proのテキストから画像への変換ノードと編集ノードを追加
* [**LTX 2.5**](https://github.com/Comfy-Org/ComfyUI/pull/15501): テキスト、画像、オーディオからビデオへのパートナーノード
...
**新規オープンソースモデルのサポート**
* [**Wan-Animate2**](https://github.com/Comfy-Org/ComfyUI/pull/15362): Wan-Animate2をネイティブにサポートし、ポーズ/リファレンスコントロールとオプションのポーズブランチキャッシュを備えています。

**パートナーノードの更新**
* [**ByteDance SeeDance 2.5**](https://links.comfy.org/4hW2fmz): ByteDance SeeDance 2.5モデルのサポートを追加しました。
* [**Seedream 5.0 Layer Separation**](https://github.com/Comfy-Org/ComfyUI/pull/15317): ByteDance Seedream 5.0 Pro のレイヤー分離サポート。
