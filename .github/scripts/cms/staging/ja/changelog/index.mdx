...
**パートナーノードの更新**
* [**PixVerse V6**](https://github.com/Comfy-Org/ComfyUI/pull/15880): V6のテキストから動画、画像から動画、extend、fusionノードをネイティブオーディオ対応で追加
* [**Tripo**](https://github.com/Comfy-Org/ComfyUI/pull/15851): 廃止されたRefine Draftノードとv2.0モデルバージョンを削除
