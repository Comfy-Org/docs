...
**合作伙伴节点更新**
* [**PixVerse V6**](https://github.com/Comfy-Org/ComfyUI/pull/15880)：新增 V6 文生视频、图生视频、扩展和融合节点，并支持原生音频
* [**Tripo**](https://github.com/Comfy-Org/ComfyUI/pull/15851)：移除已退役的 Refine Draft 节点和 v2.0 模型版本
