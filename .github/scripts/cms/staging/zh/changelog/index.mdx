...
**合作伙伴节点更新**
* [**Recraft V4.1 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16501)：Recraft V4 文生图节点上更快、成本更低的选项
* [**Claude Opus 5.5**](https://github.com/Comfy-Org/ComfyUI/pull/16479)：已添加至 Claude 节点
* [**Quiver Arrow 2**](https://github.com/Comfy-Org/ComfyUI/pull/16478)：在 SVG 节点上支持推理强度控制的 Arrow 2 模型
...
**合作伙伴节点更新**
* [**HY Image 3.5 Preview**](https://github.com/Comfy-Org/ComfyUI/pull/16462)：文生图和图像编辑，5 张参考图，原生 2K 输出
...
**新增开源模型支持**
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight)：原生 2K 生成与编辑，支持透明度通道和多图像参考（[文生图](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_t2i.json)、[图像编辑](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_image_edit.json)）
* [**MoGe 3**](https://github.com/Comfy-Org/ComfyUI/pull/16381)：从单张图像进行精细几何估算；ViT-L 和 ViT-g 模型

**合作伙伴节点更新**
* [**GPT Image 2**](https://github.com/Comfy-Org/ComfyUI/pull/16366)：新增透明背景选项
* [**Meshy 7.1**](https://github.com/Comfy-Org/ComfyUI/pull/16412)：Meshy 7.1 现已在 Meshy 3D 节点上可用
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369)：拒绝会写入空 GLB 或 FBX 的 P2 运行
...
**新增开源模型支持**
* [**FastVideo FastH3**](https://github.com/Comfy-Org/ComfyUI/pull/16072)：8 步蒸馏 MiniMax H3，用于文生视频和图生视频，并支持原生音频
* [**Marigold V2**](https://github.com/Comfy-Org/ComfyUI/pull/16232)：从单张图像估计深度、表面法线和反照率
* [**YuE2**](https://github.com/Comfy-Org/ComfyUI/pull/16250)：根据风格提示词和歌词生成音乐

**合作伙伴节点更新**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320)：文本、图像和多视图生成 3D 模型
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315)：文生视频和图生视频，720p/1080p 输出，草稿模式
* [**Flux Video Edit**](https://github.com/Comfy-Org/ComfyUI/pull/16259)：文本指令视频编辑：替换对象、重塑画面风格、编辑对话
* [**Bria edit suite**](https://github.com/Comfy-Org/ComfyUI/pull/16264)：新增图像编辑节点以及视频橡皮擦节点
...
* [**MiniMax-H3 Reference to Video**](https://github.com/Comfy-Org/ComfyUI/pull/16065): 支持无 VAE 的 `ref2va` 仅文本编码器参考
...
**合作伙伴节点更新**
* [**MiniMax H3 Max**](https://github.com/Comfy-Org/ComfyUI/pull/16025)：为文生视频、首尾帧和参考节点添加 H3 Max 选项。
...
**新增开源模型支持**
* [**Pixal3D & TRELLIS2**](https://github.com/Comfy-Org/ComfyUI/pull/14718)：3D 网格和纹理生成，支持重新网格化、减面、UV 展开和纹理烘焙
* [**SAM 3D Body**](https://github.com/Comfy-Org/ComfyUI/pull/14370)：零依赖的 3D 人体检测与分割，支持姿态渲染和动画导出
* [**TAESD H3**](https://github.com/Comfy-Org/ComfyUI/pull/15695)：轻量级 VAE 解码器，加快预览速度

**合作伙伴节点更新**
* [**PixVerse V6**](https://github.com/Comfy-Org/ComfyUI/pull/15880)：新增 V6 文生视频、图生视频、首尾帧、扩展和融合节点，并支持原生音频
* [**Tripo**](https://github.com/Comfy-Org/ComfyUI/pull/15851)：移除已退役的 Refine Draft 模型节点和 v2.0 模型版本
...
**新增开源模型支持**
* [**LTX 2.5**](https://links.comfy.org/relLTX2_5)：原生支持 STG、双 CFG 和时长预测

**合作节点更新**
* [**Qwen Image 3.0**](https://github.com/Comfy-Org/ComfyUI/pull/15327)：新增 3.0 和 3.0 Pro 的文生图与编辑节点
* [**LTX 2.5**](https://github.com/Comfy-Org/ComfyUI/pull/15501)：文本、图像和音频转视频合作节点
* [**Grok Imagine Image 2.0**](https://github.com/Comfy-Org/ComfyUI/pull/15496)：新增对 grok-imagine-image-2.0 模型的支持
