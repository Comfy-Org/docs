...
**新しいオープンソースモデルのサポート**
* [**Qwen-Image-2.1**](https://cloud.comfy.org/?template=image_qwen_image_2_1_t2i): Qwen-Image-2.1 のサポートを追加（[テキストから画像](https://cloud.comfy.org/?template=image_qwen_image_2_1_t2i)、[画像編集](https://cloud.comfy.org/?template=image_qwen_image_2_1_image_edit)）
...
* [**Meshy 7.1**](https://cloud.comfy.org/?template=api_meshy7_image_to_model): Meshy 7.1 を追加
