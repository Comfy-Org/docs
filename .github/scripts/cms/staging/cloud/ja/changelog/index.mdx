...
**パートナーノードの更新**
* [**Recraft V4.1 Flash**](https://links.comfy.org/4iLVIvb): より高速で低コストな Recraft V4 オプション
* [**Claude Opus 5.5**](https://links.comfy.org/4hvgrkS): Claude Opus 5.5 を追加
* [**Quiver Arrow 2**](https://links.comfy.org/4xFktgs): 推論エフォート制御を備えた Arrow 2
...
**パートナーノードの更新**
* [**HY Image 3.5 Preview**](https://cloud.comfy.org/?template=api_tencent_hy_image_3_5_preview_t2i): HY Image 3.5 Preview のサポートを追加
...
**新しいオープンソースモデルのサポート**
* [**Qwen-Image-2.1**](https://links.comfy.org/4iGUe5y): Qwen-Image-2.1 のサポートを追加
* [**MoGe 3**](https://cloud.comfy.org/?template=utility_moge3_geometry_estimation): MoGe 3 のサポートを追加

**パートナーノードの更新**
* [**GPT Image 2**](https://cloud.comfy.org/?template=api_openai_gpt_image_2_t2i): 背景透過オプションを追加
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369): Tripo P2 の空の GLB および FBX 出力をブロックしました
...
**新しいオープンソースモデルのサポート**
* [**FastVideo FastH3**](https://cloud.comfy.org/?template=video_fastvideo_fasth3_i2v): FastVideo FastH3のサポートを追加
* [**Marigold V2**](https://cloud.comfy.org/?template=image_marigold_v2_depth_estimation): Marigold V2のサポートを追加

**パートナーノードの更新**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): Tripo P2 3D生成を追加
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): Pruna P-Video-2のサポートを追加
* [**Flux Video Edit**](https://cloud.comfy.org/?template=api_flux_video_edit): Flux Video Editを追加
* [**Bria編集スイート**](https://cloud.comfy.org/?template=api_bria_image_edit): Briaの画像編集とVideo Eraserを追加
...
**パートナーノードの更新**
* [**MiniMax H3 Max**](https://cloud.comfy.org/?template=api_minimax_h3_max_r2v)：H3 Max モデルのサポートが追加されました
...
**パートナーノードの更新**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/4qIN5DH): より高速なビデオ生成と対話型編集、4K出力とビデオ拡張に対応。
...
**新しいオープンソースモデルのサポート**
* [**Pixal3D & TRELLIS2**](https://cloud.comfy.org/?template=3d_pixal3d_trellis2_image_to_model): リメッシュ、デシメート、UV展開、テクスチャベイクを備えた3Dメッシュとテクスチャの生成
* [**SAM 3D Body**](https://cloud.comfy.org/?template=utility_sam3d_body): 依存関係のない3D人体検出とセグメンテーション（ポーズレンダリングとアニメーションエクスポート付き）
