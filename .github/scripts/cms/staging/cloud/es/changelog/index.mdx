...
* [**Recraft V4.1 Flash**](https://links.comfy.org/4iLVIvb): Opción Recraft V4 más rápida y de menor costo
* [**Claude Opus 5.5**](https://links.comfy.org/4hvgrkS): Se agregó Claude Opus 5.5
* [**Quiver Arrow 2**](https://links.comfy.org/4xFktgs): Arrow 2 con control del esfuerzo de razonamiento
...
**Actualizaciones de nodos de socios**
* [**HY Image 3.5 Preview**](https://cloud.comfy.org/?template=api_tencent_hy_image_3_5_preview_t2i): Se añadió compatibilidad con HY Image 3.5 Preview
...
* [**Qwen-Image-2.1**](https://links.comfy.org/4iGUe5y): Se agregó soporte para Qwen-Image-2.1
* [**MoGe 3**](https://cloud.comfy.org/?template=utility_moge3_geometry_estimation): Se agregó soporte para MoGe 3

**Actualizaciones de nodos de socios**
* [**GPT Image 2**](https://cloud.comfy.org/?template=api_openai_gpt_image_2_t2i): Se agregó una opción de fondo transparente
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369): Se bloquearon las salidas GLB y FBX vacías de Tripo P2
...
**Nuevo soporte para modelos de código abierto**
* [**FastVideo FastH3**](https://cloud.comfy.org/?template=video_fastvideo_fasth3_i2v): Se agregó soporte para FastVideo FastH3
* [**Marigold V2**](https://cloud.comfy.org/?template=image_marigold_v2_depth_estimation): Se agregó soporte para Marigold V2

**Actualizaciones de nodos de socios**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): Se agregó generación 3D de Tripo P2
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): Se agregó soporte para Pruna P-Video-2
* [**Flux Video Edit**](https://cloud.comfy.org/?template=api_flux_video_edit): Se agregó Flux Video Edit
* [**Bria edit suite**](https://cloud.comfy.org/?template=api_bria_image_edit): Se agregó edición de imagen de Bria y Video Eraser
...
**Actualizaciones de nodos de socios**
* [**MiniMax H3 Max**](https://cloud.comfy.org/?template=api_minimax_h3_max_r2v): Se ha añadido compatibilidad con el modelo H3 Max
...
**Actualizaciones de nodos de socios**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/4qIN5DH): Generación de video más rápida y edición conversacional, con salida 4K y extensión de video
...
**Nuevo soporte para modelos de código abierto**
* [**Pixal3D y TRELLIS2**](https://cloud.comfy.org/?template=3d_pixal3d_trellis2_image_to_model): Generación de mallas y texturas 3D con remallado, decimación, desarrollo UV y horneado de texturas
* [**SAM 3D Body**](https://cloud.comfy.org/?template=utility_sam3d_body): Detección y segmentación de cuerpo 3D sin dependencias, con renderizado de pose y exportación de animaciones
...
**Actualizaciones de nodos asociados**
* [**Qwen Image 3.0**](https://links.comfy.org/45W0b6L): Añade nodos de texto a imagen y edición para 3.0 y 3.0 Pro
* [**LTX 2.5**](https://links.comfy.org/3TV1HDB): Nodos asociados de texto, imagen y audio a video
...
**Nuevo soporte para modelos de código abierto**
* [**Wan-Animate2**](https://links.comfy.org/3TAWMHV): Wan-Animate2 nativo con controles de pose/referencia y caché opcional de rama de pose

**Actualizaciones de nodos partner**
* [**ByteDance SeeDance 2.5**](https://links.comfy.org/3RPYzbv): Se añadió soporte para el modelo ByteDance SeeDance 2.5
* [**Seedream 5.0 Layer Separation**](https://links.comfy.org/4hgRB9L): Soporte de separación de capas de ByteDance Seedream 5.0 Pro
