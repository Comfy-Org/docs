...
**新增开源模型支持**
* [**Qwen-Image-2.1**](https://cloud.comfy.org/?template=image_qwen_image_2_1_t2i)：新增 Qwen-Image-2.1 支持（[文生图](https://cloud.comfy.org/?template=image_qwen_image_2_1_t2i)、[图像编辑](https://cloud.comfy.org/?template=image_qwen_image_2_1_image_edit)）
...
* [**Meshy 7.1**](https://cloud.comfy.org/?template=api_meshy7_image_to_model)：新增 Meshy 7.1
