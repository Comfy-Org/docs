...
**合作伙伴节点更新**
* [**Recraft V4.1 Flash**](https://links.comfy.org/4iLVIvb)：更快速、成本更低的 Recraft V4 选项
* [**Claude Opus 5.5**](https://links.comfy.org/4hvgrkS)：新增 Claude Opus 5.5
* [**Quiver Arrow 2**](https://links.comfy.org/4xFktgs)：带推理力度控制的 Arrow 2
...
**合作伙伴节点更新**
* [**HY Image 3.5 Preview**](https://cloud.comfy.org/?template=api_tencent_hy_image_3_5_preview_t2i)：新增对 HY Image 3.5 Preview 的支持
...
**新增开源模型支持**
* [**Qwen-Image-2.1**](https://links.comfy.org/4iGUe5y)：新增 Qwen-Image-2.1 支持
* [**MoGe 3**](https://cloud.comfy.org/?template=utility_moge3_geometry_estimation)：新增 MoGe 3 支持

**合作伙伴节点更新**
* [**GPT Image 2**](https://cloud.comfy.org/?template=api_openai_gpt_image_2_t2i)：新增透明背景选项
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369)：阻止了空的 Tripo P2 GLB 和 FBX 输出
...
**新增开源模型支持**
* [**FastVideo FastH3**](https://cloud.comfy.org/?template=video_fastvideo_fasth3_i2v)：新增 FastVideo FastH3 支持
* [**Marigold V2**](https://cloud.comfy.org/?template=image_marigold_v2_depth_estimation)：新增 Marigold V2 支持

**合作伙伴节点更新**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320)：新增 Tripo P2 3D 生成
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315)：新增 Pruna P-Video-2 支持
* [**Flux Video Edit**](https://cloud.comfy.org/?template=api_flux_video_edit)：新增 Flux Video Edit
* [**Bria edit suite**](https://cloud.comfy.org/?template=api_bria_image_edit)：新增 Bria 图像编辑和视频橡皮擦
...
**合作伙伴节点更新**
* [**MiniMax H3 Max**](https://cloud.comfy.org/?template=api_minimax_h3_max_r2v)：添加了 H3 Max 模型支持
...
**合作伙伴节点更新**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/4qIN5DH)：更快的视频生成和对话式编辑，支持4K输出和视频扩展
...
**新增开源模型支持**
* [**Pixal3D & TRELLIS2**](https://cloud.comfy.org/?template=3d_pixal3d_trellis2_image_to_model)：3D 网格和纹理生成，支持重新网格化、减面、UV 展开和纹理烘焙
* [**SAM 3D Body**](https://cloud.comfy.org/?template=utility_sam3d_body)：零依赖的 3D 人体检测与分割，支持姿态渲染和动画导出
...
**新增开源模型支持**
* [**LTX 2.5**](https://links.comfy.org/cloLTX2_5)：原生支持 STG、双 CFG 和时长预测

**合作节点更新**
* [**Qwen Image 3.0**](https://links.comfy.org/45W0b6L)：新增 3.0 和 3.0 Pro 的文生图与编辑节点
...
**新增开源模型支持**
* [**Wan-Animate2**](https://links.comfy.org/3TAWMHV): 原生 Wan-Animate2，带姿势/参考控制和可选姿势分支缓存

**合作节点更新**
* [**ByteDance SeeDance 2.5**](https://links.comfy.org/3RPYzbv): 新增字节跳动 SeeDance 2.5 模型支持
* [**Seedream 5.0 Layer Separation**](https://links.comfy.org/4hgRB9L): 字节跳动 Seedream 5.0 Pro 图层分离支持
