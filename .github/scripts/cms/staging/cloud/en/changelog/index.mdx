...
* [**Recraft V4.1 Flash**](https://links.comfy.org/4iLVIvb): Faster, lower-cost Recraft V4 option
* [**Claude Opus 5.5**](https://links.comfy.org/4hvgrkS): Added Claude Opus 5.5
* [**Quiver Arrow 2**](https://links.comfy.org/4xFktgs): Arrow 2 with reasoning effort control
...
**Partner Node Updates**
* [**HY Image 3.5 Preview**](https://cloud.comfy.org/?template=api_tencent_hy_image_3_5_preview_t2i): Added HY Image 3.5 Preview support
...
* [**Qwen-Image-2.1**](https://links.comfy.org/4iGUe5y): Added Qwen-Image-2.1 support
* [**MoGe 3**](https://cloud.comfy.org/?template=utility_moge3_geometry_estimation): Added MoGe 3 support

**Partner Node Updates**
* [**GPT Image 2**](https://cloud.comfy.org/?template=api_openai_gpt_image_2_t2i): Added a transparent background option
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369): Blocked empty Tripo P2 GLB and FBX outputs
...
**New Open-Source Model Support**
* [**FastVideo FastH3**](https://cloud.comfy.org/?template=video_fastvideo_fasth3_i2v): Added FastVideo FastH3 support
* [**Marigold V2**](https://cloud.comfy.org/?template=image_marigold_v2_depth_estimation): Added Marigold V2 support

**Partner Node Updates**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): Added Tripo P2 3D generation
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): Added Pruna P-Video-2 support
* [**Flux Video Edit**](https://cloud.comfy.org/?template=api_flux_video_edit): Added Flux Video Edit
* [**Bria edit suite**](https://cloud.comfy.org/?template=api_bria_image_edit): Added Bria image edit and Video Eraser
...
**Partner Node Updates**
* [**MiniMax H3 Max**](https://cloud.comfy.org/?template=api_minimax_h3_max_r2v): Added H3 Max model support
...
**New Open-Source Model Support**
* [**Pixal3D & TRELLIS2**](https://cloud.comfy.org/?template=3d_pixal3d_trellis2_image_to_model): 3D mesh and texture generation with remesh, decimate, UV unwrap, texture bake
* [**SAM 3D Body**](https://cloud.comfy.org/?template=utility_sam3d_body): Dependency-free 3D body detection and segmentation with pose rendering and animation export
...
**New Open-Source Model Support**
* [**LTX 2.5**](https://links.comfy.org/cloLTX2_5): Native support with STG, dual CFG, duration prediction

**Partner Node Updates**
* [**Qwen Image 3.0**](https://links.comfy.org/45W0b6L): Adds 3.0 and 3.0 Pro text-to-image and edit nodes
* [**LTX 2.5**](https://links.comfy.org/3TV1HDB): Text, image, and audio to video partner nodes
...
**New Open-Source Model Support**
* [**Wan-Animate2**](https://links.comfy.org/3TAWMHV): Native Wan-Animate2 with pose/reference controls and optional pose-branch cache

**Partner Node Updates**
* [**ByteDance SeeDance 2.5**](https://links.comfy.org/3RPYzbv): Added ByteDance SeeDance 2.5 model support
* [**Seedream 5.0 Layer Separation**](https://links.comfy.org/4hgRB9L): ByteDance Seedream 5.0 Pro Layer Separation Support
