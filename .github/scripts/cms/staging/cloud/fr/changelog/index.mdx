...
* [**Recraft V4.1 Flash**](https://links.comfy.org/4iLVIvb) : Option Recraft V4 plus rapide et moins coûteuse
* [**Claude Opus 5.5**](https://links.comfy.org/4hvgrkS) : Ajout de Claude Opus 5.5
* [**Quiver Arrow 2**](https://links.comfy.org/4xFktgs) : Arrow 2 avec contrôle de l'effort de raisonnement
...
**Mises à jour des nœuds partenaires**
* [**HY Image 3.5 Preview**](https://cloud.comfy.org/?template=api_tencent_hy_image_3_5_preview_t2i) : Ajout de la prise en charge de HY Image 3.5 Preview
...
* [**Qwen-Image-2.1**](https://links.comfy.org/4iGUe5y) : Ajout du support de Qwen-Image-2.1
* [**MoGe 3**](https://cloud.comfy.org/?template=utility_moge3_geometry_estimation) : Ajout du support de MoGe 3

**Mises à jour des nodes partenaires**
* [**GPT Image 2**](https://cloud.comfy.org/?template=api_openai_gpt_image_2_t2i) : Ajout d'une option d'arrière-plan transparent
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369) : Blocage des sorties GLB et FBX vides de Tripo P2
...
**Prise en charge de nouveaux modèles open source**
* [**FastVideo FastH3**](https://cloud.comfy.org/?template=video_fastvideo_fasth3_i2v) : Ajout de la prise en charge de FastVideo FastH3
* [**Marigold V2**](https://cloud.comfy.org/?template=image_marigold_v2_depth_estimation) : Ajout de la prise en charge de Marigold V2

**Mises à jour des nœuds partenaires**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320) : Ajout de la génération 3D Tripo P2
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315) : Ajout de la prise en charge de Pruna P-Video-2
* [**Flux Video Edit**](https://cloud.comfy.org/?template=api_flux_video_edit) : Ajout de Flux Video Edit
* [**Bria edit suite**](https://cloud.comfy.org/?template=api_bria_image_edit) : Ajout de Bria image edit et Video Eraser
...
**Mises à jour des nœuds partenaires**
* [**MiniMax H3 Max**](https://cloud.comfy.org/?template=api_minimax_h3_max_r2v) : Ajout de la prise en charge du modèle H3 Max
...
**Mises à jour des nœuds partenaires**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/4qIN5DH) : Génération vidéo plus rapide et édition conversationnelle, avec sortie 4K et extension vidéo
...
* [**Pixal3D & TRELLIS2**](https://cloud.comfy.org/?template=3d_pixal3d_trellis2_image_to_model) : Génération de maillages 3D et de textures avec remaillage, décimation, dépliage UV, cuisson de textures
* [**SAM 3D Body**](https://cloud.comfy.org/?template=utility_sam3d_body) : Détection et segmentation du corps 3D sans dépendance, avec rendu de pose et export d'animation
...
**Nouveau support de modèles open-source**
* [**LTX 2.5**](https://links.comfy.org/cloLTX2_5): Prise en charge native avec STG, double CFG, prédiction de durée

**Mises à jour des nœuds partenaires**
* [**Qwen Image 3.0**](https://links.comfy.org/45W0b6L): Ajoute les nœuds 3.0 et 3.0 Pro de texte-vers-image et d'édition
* [**LTX 2.5**](https://links.comfy.org/3TV1HDB): Nœuds partenaires texte, image et audio vers vidéo
...
**Nouveau support de modèles open source**
* [**Wan-Animate2**](https://links.comfy.org/3TAWMHV) : Wan-Animate2 natif avec contrôles de pose/référence et cache de branche de pose optionnel

**Mises à jour des nœuds partenaires**
* [**ByteDance SeeDance 2.5**](https://links.comfy.org/3RPYzbv) : Ajout du support du modèle ByteDance SeeDance 2.5
* [**Seedream 5.0 Layer Separation**](https://links.comfy.org/4hgRB9L) : Support de la séparation des calques ByteDance Seedream 5.0 Pro
