...
* [**Qwen-Image-2.1**](https://cloud.comfy.org/?template=image_qwen_image_2_1_t2i): Добавлена поддержка Qwen-Image-2.1 ([текст в изображение](https://cloud.comfy.org/?template=image_qwen_image_2_1_t2i), [редактирование](https://cloud.comfy.org/?template=image_qwen_image_2_1_image_edit))
...
* [**Meshy 7.1**](https://cloud.comfy.org/?template=api_meshy7_image_to_model): Добавлен Meshy 7.1
