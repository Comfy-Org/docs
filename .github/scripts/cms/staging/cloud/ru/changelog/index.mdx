...
<Update label="v0.37.2" description="23 сентября 2026">

**Обновления партнёрских узлов**
* [**Recraft V4.1 Flash**](https://links.comfy.org/4iLVIvb): Более быстрый и экономичный вариант Recraft V4
* [**Claude Opus 5.5**](https://links.comfy.org/4hvgrkS): Добавлен Claude Opus 5.5
* [**Quiver Arrow 2**](https://links.comfy.org/4xFktgs): Arrow 2 с управлением уровнем рассуждений

</Update>

<Update label="v0.37.1" description="22 сентября 2026">

**Обновления партнёрских узлов**
* [**HY Image 3.5 Preview**](https://cloud.comfy.org/?template=api_tencent_hy_image_3_5_preview_t2i): Добавлена поддержка HY Image 3.5 Preview
...
* [**Qwen-Image-2.1**](https://links.comfy.org/4iGUe5y): Добавлена поддержка Qwen-Image-2.1
* [**MoGe 3**](https://cloud.comfy.org/?template=utility_moge3_geometry_estimation): Добавлена поддержка MoGe 3

**Обновления партнёрских нод**
* [**GPT Image 2**](https://cloud.comfy.org/?template=api_openai_gpt_image_2_t2i): Добавлена опция прозрачного фона
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369): Заблокированы пустые выходные данные GLB и FBX Tripo P2

</Update>

<Update label="v0.36.0" description="15 сентября 2026 г.">

**Поддержка новых моделей с открытым исходным кодом**
* [**FastVideo FastH3**](https://cloud.comfy.org/?template=video_fastvideo_fasth3_i2v): Добавлена поддержка FastVideo FastH3
* [**Marigold V2**](https://cloud.comfy.org/?template=image_marigold_v2_depth_estimation): Добавлена поддержка Marigold V2

**Обновления партнёрских нод**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): Добавлена 3D-генерация Tripo P2
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): Добавлена поддержка Pruna P-Video-2
* [**Flux Video Edit**](https://cloud.comfy.org/?template=api_flux_video_edit): Добавлен Flux Video Edit
* [**Bria edit suite**](https://cloud.comfy.org/?template=api_bria_image_edit): Добавлены Bria image edit и Video Eraser
...
**Обновления партнёрских узлов**
* [**MiniMax H3 Max**](https://cloud.comfy.org/?template=api_minimax_h3_max_r2v): Добавлена поддержка модели H3 Max
...
**Обновления партнёрских нод**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/4qIN5DH): Более быстрая генерация видео и диалоговое редактирование, с выводом в 4K и расширением видео
...
**Поддержка новых моделей с открытым исходным кодом**
* [**Pixal3D и TRELLIS2**](https://cloud.comfy.org/?template=3d_pixal3d_trellis2_image_to_model): генерация 3D-сеток и текстур с ремешингом, децимацией, развёрткой UV и запеканием текстур
* [**SAM 3D Body**](https://cloud.comfy.org/?template=utility_sam3d_body): обнаружение и сегментация 3D-тела без внешних зависимостей с рендерингом позы и экспортом анимации
