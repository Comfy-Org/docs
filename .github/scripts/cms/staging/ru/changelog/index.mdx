...
<Update label="v0.37.2" description="23 сентября 2026 г.">

**Обновления партнёрских нод**
* [**Recraft V4.1 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16501): Более быстрый и экономичный вариант для ноды Recraft V4 text-to-image
* [**Claude Opus 5.5**](https://github.com/Comfy-Org/ComfyUI/pull/16479): Добавлено в ноду Claude
* [**Quiver Arrow 2**](https://github.com/Comfy-Org/ComfyUI/pull/16478): Модели Arrow 2 с управлением уровнем рассуждений на нодах SVG

</Update>

<Update label="v0.37.1" description="22 сентября 2026 г.">

**Обновления партнёрских узлов**
* [**HY Image 3.5 Preview**](https://github.com/Comfy-Org/ComfyUI/pull/16462): Преобразование текста в изображение и редактирование изображений, 5 референсов, нативный вывод 2K

</Update>

<Update label="v0.37.0" description="21 сентября 2026">

**Поддержка новых открытых моделей**
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight): Нативная генерация и редактирование в 2K с альфа-каналом и поддержкой нескольких референсных изображений ([текст в изображение](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_t2i.json), [редактирование](https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_2_1_image_edit.json))
* [**MoGe 3**](https://github.com/Comfy-Org/ComfyUI/pull/16381): Оценка геометрии с высокой детализацией по одному изображению; чекпоинты ViT-L и ViT-g

**Обновления партнёрских нод**
* [**GPT Image 2**](https://github.com/Comfy-Org/ComfyUI/pull/16366): Добавляет опцию прозрачного фона
* [**Meshy 7.1**](https://github.com/Comfy-Org/ComfyUI/pull/16412): Meshy 7.1 теперь доступна в нодах Meshy 3D
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16369): Отклоняет запуски P2, которые записали бы пустые GLB или FBX
...
* [**Marigold V2**](https://github.com/Comfy-Org/ComfyUI/pull/16232): Оценка глубины, нормалей поверхности и альбедо по одному изображению
* [**YuE2**](https://github.com/Comfy-Org/ComfyUI/pull/16250): Генерация музыки по стилевым промптам и тексту песни

**Обновления партнёрских нод**
* [**Tripo P2**](https://github.com/Comfy-Org/ComfyUI/pull/16320): Генерация 3D-моделей по тексту, изображению и многовью
* [**Pruna P-Video-2**](https://github.com/Comfy-Org/ComfyUI/pull/16315): Преобразование текста в видео и изображения в видео, вывод 720p/1080p, режим черновика
* [**Flux Video Edit**](https://github.com/Comfy-Org/ComfyUI/pull/16259): Редактирование видео по текстовой инструкции: замена объектов, изменение стиля материала, редактирование диалогов
* [**Bria edit suite**](https://github.com/Comfy-Org/ComfyUI/pull/16264): Новые ноды редактирования изображений плюс нода Video Eraser
...
**Обновления партнёрских узлов**
* [**MiniMax H3 Max**](https://github.com/Comfy-Org/ComfyUI/pull/16025): Добавлена опция H3 Max для узлов text-to-video, first-last-frame и reference.

</Update>

<Update label="v0.34.2" description="27 августа 2026 г.">

**Обновления партнёрских нод**
* [**Gemini Omni 1.1 Flash**](https://links.comfy.org/4wZcACf): Более быстрая генерация видео и диалоговое редактирование, с выводом в 4K и расширением видео
...
**Поддержка новых моделей с открытым исходным кодом**
* [**LTX 2.5**](https://links.comfy.org/relLTX2_5): Нативная поддержка с STG, двойным CFG и предсказанием длительности

**Обновления партнёрских узлов**
* [**Qwen Image 3.0**](https://github.com/Comfy-Org/ComfyUI/pull/15327): Добавляет узлы для генерации изображений по тексту и редактирования для 3.0 и 3.0 Pro
* [**LTX 2.5**](https://github.com/Comfy-Org/ComfyUI/pull/15501): Партнёрские узлы для преобразования текста, изображения и аудио в видео
...
**Поддержка новых моделей с открытым исходным кодом**
* [**Wan-Animate2**](https://github.com/Comfy-Org/ComfyUI/pull/15362): Нативная поддержка Wan-Animate2 с управлением позой/референсами и опциональным кэшем ветви позы

**Обновления партнёрских узлов**
* [**ByteDance SeeDance 2.5**](https://links.comfy.org/4hW2fmz): Добавлена поддержка модели ByteDance SeeDance 2.5
* [**Seedream 5.0 Layer Separation**](https://github.com/Comfy-Org/ComfyUI/pull/15317): Поддержка разделения слоёв ByteDance Seedream 5.0 Pro
