...
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight): Нативная генерация и редактирование в 2K с альфа-каналом и поддержкой нескольких референсных изображений
