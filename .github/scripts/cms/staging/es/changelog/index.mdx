...
* [**Qwen-Image-2.1**](https://blog.comfy.org/p/qwen-image-21-in-comfyui-open-weight): Generación y edición nativas en 2K con canal alfa y referencias de múltiples imágenes
