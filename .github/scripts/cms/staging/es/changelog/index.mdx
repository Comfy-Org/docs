...
* [**PixVerse V6**](https://github.com/Comfy-Org/ComfyUI/pull/15880): Añade nodos V6 de texto a video, imagen a video, extensión y fusión con audio nativo
* [**Tripo**](https://github.com/Comfy-Org/ComfyUI/pull/15851): Elimina el nodo Refine Draft retirado y la versión v2.0 del modelo
