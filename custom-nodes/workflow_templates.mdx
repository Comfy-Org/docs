...
description: "Learn how to include example workflow JSON files and thumbnails in your ComfyUI custom nodes using the example_workflows directory for the Template Browser."
---
