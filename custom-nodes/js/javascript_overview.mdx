...
description: "Learn how to extend ComfyUI with JavaScript extensions by exporting WEB_DIRECTORY, adding .js files, and registering an extension with app.registerExtension."
---
