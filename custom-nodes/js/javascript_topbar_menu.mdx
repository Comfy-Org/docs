---
title: "Topbar Menu"
description: "Add custom commands to ComfyUI's topbar menu, including adding to existing menus, creating submenus, and placing one command in multiple locations."
---
