...
description: "Add custom badges with labels, URLs, and icons to the ComfyUI About Panel using the About Panel Badges API, linking to docs, GitHub, or extension resources."
---
