...
description: "Learn how to use ComfyUI's About Panel Badges API to add custom badges with labels, URLs, and icons to the ComfyUI about page, linking to documentation, GitHub, or other extension resources."
---
