...
description: "Add custom tabs to ComfyUI's bottom panel using the Bottom Panel Tabs API, including interactive elements, React components, and standalone registration."
---
