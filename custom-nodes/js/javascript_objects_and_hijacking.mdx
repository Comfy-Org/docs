...
Custom widget types can be added by providing a `getCustomWidgets` method in your extension. See the [Custom Widgets Examples](./javascript_examples.mdx#custom-widgets) for detailed implementation examples.
