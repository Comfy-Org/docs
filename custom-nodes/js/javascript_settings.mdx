---
title: "Settings API"
description: "Add, read, write, and react to ComfyUI extension settings with app.registerExtension, covering boolean, text, number, slider, combo, color, and image types."
---
