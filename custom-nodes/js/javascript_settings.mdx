---
title: "Settings"
description: "Learn how to add, read, write, and react to changes in ComfyUI extension settings using app.registerExtension. Covers all setting types, including boolean, text, number, slider, combo, color, image"
---
