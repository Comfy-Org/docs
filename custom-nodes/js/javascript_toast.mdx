---
title: "ComfyUI Toast API"
description: "Use ComfyUI's Toast API to show non-blocking notifications. Covers toast types (success, warning, error), the alert helper, and the full API reference."
---
