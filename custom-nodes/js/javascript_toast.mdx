---
title: "Toast API"
description: "Use ComfyUI's Toast API to show non-blocking notification messages to users. Covers basic usage, toast types (success, warning, error), the alert helper, and the full API reference."
---
