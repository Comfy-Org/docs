...
description: "Annotated code examples for ComfyUI custom nodes: load and save images, invert masks, convert mask shapes, use masks as transparency layers, and create noise."
---
