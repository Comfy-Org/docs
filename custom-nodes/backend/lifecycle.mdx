---
title: "ComfyUI Custom Node Lifecycle"
description: "Understand how ComfyUI loads custom nodes: __init__.py imports, NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS, and WEB_DIRECTORY for client-side JavaScript."
---
