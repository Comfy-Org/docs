...
description: "Learn how to use ComfyUI's hidden inputs (UNIQUE_ID, PROMPT, EXTRA_PNGINFO, DYNPROMPT) and flexible inputs, including custom datatypes, wildcard inputs, and dynamically created inputs, when building custom nodes."
---
