...
Useful for synonyms, abbreviations, common misspellings, or old names after renaming a node.
...
<Tip>
If you rename a node, add the old name to `SEARCH_ALIASES` to help users find the renamed node.
</Tip>
