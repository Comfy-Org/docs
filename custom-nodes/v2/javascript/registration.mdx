---
title: "Register extensions and lifecycle hooks"
description: "Import the API, declare capabilities, register behavior, define frontend nodes and widgets, and clean up owned resources."
---
...
```js
console.info(comfy.version)
console.info(comfy.major)
...
[Execution and resolution](/custom-nodes/v2/javascript/execution) before defining execution behavior.
