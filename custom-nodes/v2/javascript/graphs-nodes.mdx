---
title: "Edit graphs and nodes"
description: "Work with root and subgraph scopes, create and replace nodes, batch edits, manage groups, and observe graph behavior."
---
...
See [Execution and resolution](/custom-nodes/v2/javascript/execution) for supplier semantics.
