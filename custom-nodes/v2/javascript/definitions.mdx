---
title: "Extend node definitions"
description: "Read definitions, register composable type behavior, define frontend-owned nodes, and work with live node handles."
---
...
[Slots and links](/custom-nodes/v2/javascript/slots-links) and [Widgets](/custom-nodes/v2/javascript/widgets-ui).
