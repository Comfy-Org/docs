---
title: "Add widgets and custom UI"
description: "Manage widget values, events, ordering, serialization, mounted controls, canvas surfaces, and custom widget types."
---
