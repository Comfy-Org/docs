---
title: "Publishing to the Manager (V3)"
description: "Understand how to publish a custom node to the ComfyUI Manager database, including git requirements and the custom-node-list.json registration process (V3 schema)."
---
