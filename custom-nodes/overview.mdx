---
title: "Overview"
description: "Learn how ComfyUI custom nodes work, the client-server model, and the four node categories: server side only, client side only, independent, and connected."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Package & Publish" icon="box" href="/registry/publishing">
    Ship your node to the Comfy Registry.
  </Card>
</CardGroup>
