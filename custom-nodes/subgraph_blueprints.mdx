---
title: "Subgraph blueprints"
description: "Learn how to create reusable subgraph blueprints for custom nodes in Comfy. Follow this guide to expose pre-built node groups and start building today."
---
