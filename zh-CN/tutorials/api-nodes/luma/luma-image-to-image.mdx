---
title: "Luma Image to Image API 节点 ComfyUI 官方示例"
description: "本文将介绍如何在 ComfyUI 中使用 Luma Image to Image API 节点的相关功能"
...
<Card title="Luma Image to Image 节点文档" icon="book" href="/zh-CN/built-in-nodes/api-node/image/luma/luma-image-to-image">
