...
[Stability Stable Image Ultra](/zh-CN/built-in-nodes/api-node/image/stability/stability-stable-image-ultra) 节点允许你使用 Stability AI 的 Stable Image Ultra 模型，通过文本提示词或参考图像创建高质量、细节丰富的图像内容。
...
<Card title="Stability Stable Image Ultra 节点文档" icon="book" href="/zh-CN/built-in-nodes/api-node/image/stability/stability-stable-image-ultra">
