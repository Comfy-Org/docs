...
对应的示例非常简单
![ComfyUI openai-dall-e-2 工作流示例](/images/tutorial/api_nodes/openai-dall-e-2/text2image.jpg)
...
![ComfyUI openai-dall-e-2 工作流示例](/images/tutorial/api_nodes/openai-dall-e-2/inpainting.jpg)
