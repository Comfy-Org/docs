...
1. 请更新 ComfyUI 到最新的 Commit, 而不是stable 版本，桌面端需要更新到最新版。
2. 拥有已登录的 Comfy Org 账户
3. 保证账户中有足够的积分余额

如果您尚未设置，请参考：
- [用户登录指南](/zh-CN/interface/user)
- [积分购买指南](/zh-CN/interface/credits)
...
对应的工作流非常简单：
![ComfyUI openai-gpt-image-1 工作流示例](/images/tutorial/api_nodes/gpt-image-1/text2image.jpg)
...
![ComfyUI openai-gpt-image-1 工作流示例](/images/tutorial/api_nodes/gpt-image-1/image2image.jpg)
...
对应工作流如下图所示：
![多张图片输入示例](/images/tutorial/api_nodes/gpt-image-1/multi_images_input.png)
...
对应工作流入图所示
![ComfyUI openai-gpt-image-1 工作流示例](/images/tutorial/api_nodes/gpt-image-1/inpaint.jpg)
