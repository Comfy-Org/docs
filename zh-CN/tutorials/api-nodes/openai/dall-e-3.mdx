...
description: "了解如何在 ComfyUI 中使用 OpenAI DALL·E 3 API 节点生成图像"
...
![ComfyUI openai-dall-e-3 工作流](/images/tutorial/api_nodes/openai/openai/openai-dall-e-3/text2image.jpg)
