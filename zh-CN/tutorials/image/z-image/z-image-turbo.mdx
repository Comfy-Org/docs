...
<Tip>
您可以[在此下载](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_z_image_turbo.json)工作流 JSON 文件，或直接在 [ComfyUI Cloud](https://cloud.comfy.org/?template=image_z_image_turbo&utm_source=docs) 上运行。
</Tip>
