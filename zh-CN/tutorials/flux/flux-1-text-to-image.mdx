...
<CardGroup cols={2}>
  ...
  <Card title="下载工作流" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/flux/text-to-image/flux_dev_t5fp16.png">
    下载 JSON 工作流文件用于本地使用
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="下载工作流" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/flux/text-to-image/flux_schnell_t5fp8.png">
    下载 JSON 工作流文件用于本地使用
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="下载工作流" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/flux/text-to-image/flux_dev_fp8.png">
    下载 JSON 工作流文件用于本地使用
  </Card>
</CardGroup>
