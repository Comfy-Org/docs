...
description: "本文将使用 Flux.1 fill dev 来完成 Inpainting 和 Outpainting 的工作流示例。"
...
Flux.1 fill dev 是 [Black Forest Labs](https://blackforestlabs.ai/) 推出的 ​[FLUX.1 Tools 套件](https://blackforestlabs.ai/flux-1-tools/) 中的核心工具之一。
