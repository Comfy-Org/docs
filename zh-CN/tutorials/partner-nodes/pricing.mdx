...
| 产品名称 | 配置 | 积分 | 类别 |
| :--- | :--- | :--- | :--- |
| Kling V3-Omni Video Product | mode: std, model: kling-v3-omni, video_input: off, audio: off | 17.72 / 秒 | 视频 |
| Kling V3-Omni Video Product | mode: std, model: kling-v3-omni, video_input: off, audio: on | 23.63 / 秒 | 视频 |
| Kling V3-Omni Video Product | mode: std, model: kling-v3-omni, video_input: on | 26.59 / 秒 | 视频 |
| Kling V3-Omni Video Product | mode: pro, model: kling-v3-omni, video_input: off, audio: off | 23.63 / 秒 | 视频 |
| Kling V3-Omni Video Product | mode: pro, model: kling-v3-omni, video_input: off, audio: on | 29.54 / 秒 | 视频 |
| Kling V3-Omni Video Product | mode: pro, model: kling-v3-omni, video_input: on | 35.45 / 秒 | 视频 |
| Kling Omni Video Product | generate_with_video: false, mode: std, model: kling-video-o1 | 17.72 / 秒 | 视频 |
| Kling Omni Video Product | generate_with_video: true, mode: std, model: kling-video-o1 | 26.59 / 秒 | 视频 |
| Kling Omni Video Product | generate_with_video: false, mode: pro, model: kling-video-o1 | 23.63 / 秒 | 视频 |
| Kling Omni Video Product | generate_with_video: true, mode: pro, model: kling-video-o1 | 35.45 / 秒 | 视频 |
| Kling Video Generation Product | audio: off, mode: std, model: kling-v3 | 17.72 / 秒 | 视频 |
| Kling Video Generation Product | audio: on, mode: std, model: kling-v3 | 26.59 / 秒 | 视频 |
| Kling Video Generation Product | audio: off, mode: pro, model: kling-v3 | 23.63 / 秒 | 视频 |
| Kling Video Generation Product | audio: on, mode: pro, model: kling-v3 | 35.45 / 秒 | 视频 |
| Kling Motion Control Product | mode: std, model: kling-v3 | 14.77 / 秒 | 视频 |
| Kling Motion Control Product | mode: pro, model: kling-v3 | 23.63 / 秒 | 视频 |
| Kling Motion Control Product | mode: std, model: kling-v2-6 | 14.77 / 秒 | 视频 |
| Kling Motion Control Product | mode: pro, model: kling-v2-6 | 23.63 / 秒 | 视频 |
| Kling Avatar Product | mode: std | 11.82 / 秒 | 视频 |
| Kling Avatar Product | mode: pro | 23.63 / 秒 | 视频 |
| Kling Video Generation with Sound Product | mode: std, model: kling-v2-6, sound: off | 8.86 / 秒 | 视频 |
| Kling Video Generation with Sound Product | mode: pro, model: kling-v2-6, sound: off | 14.77 / 秒 | 视频 |
| Kling Video Generation with Sound Product | mode: pro, model: kling-v2-6, sound: on, no voice | 29.54 / 秒 | 视频 |
| Kling Video Generation with Sound Product | mode: pro, model: kling-v2-6, sound: on, voice control | 35.45 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: std, model: kling-v2-5-turbo | 8.86 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: pro, model: kling-v2-5-turbo | 14.77 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: std, model: kling-v2-1 | 11.82 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: pro, model: kling-v2-1 | 20.68 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: std, model: kling-v1-6 | 11.82 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: pro, model: kling-v1-6 | 20.68 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: std, model: kling-v1-6, type: multi-elements | 17.72 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: pro, model: kling-v1-6, type: multi-elements | 29.54 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: std, model: kling-v1-5 | 11.82 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: pro, model: kling-v1-5 | 20.68 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: std, model: kling-v1 | 5.91 / 秒 | 视频 |
| prod-v1-Kling Video Generation Product | mode: pro, model: kling-v1 | 20.68 / 秒 | 视频 |
| Kling Video Extension Product | mode: std, model: kling-v1-6 | 11.82 / 秒 | 视频 |
| Kling Video Extension Product | mode: pro, model: kling-v1-6 | 20.68 / 秒 | 视频 |
| Kling Video Extension Product | mode: std, model: kling-v1-5 | 11.82 / 秒 | 视频 |
| Kling Video Extension Product | mode: pro, model: kling-v1-5 | 20.68 / 秒 | 视频 |
| Kling Video Extension Product | mode: std, model: kling-v1 | 5.91 / 秒 | 视频 |
| Kling Video Extension Product | mode: pro, model: kling-v1 | 20.68 / 秒 | 视频 |
| Kling Motion Control Product | mode: pro, model: kling-v1-5 | 103.39 / 次 | 视频 |
| Kling Camera Control Product | mode: std, model: kling-v1 | 29.54 / 次 | 视频 |
| Kling Motion Brush Product | mode: pro, model: kling-v1 | 103.39 / 次 | 视频 |
| Kling Omni Image Product | model: kling-image-o1, operation: text_to_image | 5.91 / 次 | 图像 |
| Kling Omni Image Product | model: kling-image-o1, operation: image_to_image | 5.91 / 次 | 图像 |
| Kling Omni Image Product | model: kling-image-o1, operation: image_editing | 5.91 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v2-1, operation: text_to_image | 2.95 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v2, operation: text_to_image | 2.95 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v2, operation: multi_image_to_image | 11.82 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v2, operation: image_restyle | 5.91 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v1-5, operation: text_to_image | 2.95 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v1-5, operation: image_to_image_subject | 5.91 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v1-5, operation: image_to_image_face | 5.91 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v1, operation: text_to_image | 0.74 / 次 | 图像 |
| Kling Image Generation Product | model: kling-v1, operation: image_to_image | 0.74 / 次 | 图像 |
| Kling Image Expansion Product | NA | 5.91 / 次 | 图像 |
| Kling AI Multi-Shot Product | NA | 14.77 / 次 | 图像 |
| Kling Virtual Try On | model: kolors-virtual-try-on-v1 | 147.7 / 次 | 图像 |
| Kling Virtual Try On | model: kolors-virtual-try-on-v1-5 | 147.7 / 次 | 图像 |
| Kling Lip Sync Product | NA | ~21.1 / 次 | 视频 |
| Kling Audio Product | type: text_to_audio | 7.39 / 次 | 音频 |
| Kling Audio Product | type: video_to_audio | 7.39 / 次 | 音频 |
