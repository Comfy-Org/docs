...
<Card title="Recraft V4 文本到图像工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_recraft_v4_t2i.json">
  下载工作流或在模板库中搜索 "Recraft V4 Text to Image"
</Card>
...
<Card title="Recraft V4 文本到矢量工作流" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_recraft_v4_text_to_vector.json">
  下载工作流或在模板库中搜索 "Recraft V4 Text to Vector"
</Card>
