...
<Card title="下载工作流" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/audio/ace-step/ace_step_1_t2m.json">
  下载 JSON 工作流文件用于本地使用
</Card>
...
<CardGroup cols={2}>
  <Card title="下载工作流" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/audio/ace-step/ace_step_1_m2m_editing.json">
    下载 JSON 工作流文件用于本地使用
  </Card>
  <Card title="下载音频" icon="download" href="https://github.com/Comfy-Org/example_workflows/raw/refs/heads/main/audio/ace-step/input.mp3">
    下载示例音频文件用于输入
  </Card>
</CardGroup>
