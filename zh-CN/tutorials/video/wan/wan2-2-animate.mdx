...
<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_animate&utm_source=docs">
    直接在 Comfy Cloud 中打开此工作流
  </Card>
  <Card title="下载工作流" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/video_wan2_2_14B_animate.json">
    下载 JSON 工作流文件用于本地使用
  </Card>
</CardGroup>
