...
<Note>
目前 ComfyUI 已原生支持 Hunyuan3D-2mv ，请在开始之前确保你已升级到最新版本的 [ComfyUI](https://github.com/comfyanonymous/ComfyUI)。
</Note>
...
![多视角输入](/images/tutorial/3d/hunyuan3d-2mv/hunyuan_3d_v2_mv_muti_input.jpg)
