...
1. 前往 [Comfy Cloud 设置](https://app.comfy.org/settings)，进入 **Secrets** 部分。
2. 添加你的 API 密钥：
   - Hugging Face：添加你的 Hugging Face API token，密钥名称为 `HF_TOKEN`
   - Civitai：添加你的 Civitai API key，密钥名称为 `CIVITAI_API_TOKEN`
