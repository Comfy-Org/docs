...
在中文区早期有社区作者 [秋葉aaaki](https://space.bilibili.com/12566101) 制作过独立分发的版本-秋叶整合包，有被广泛使用。

如果你是在中国大陆使用，这个版本更改了github 的源地址，并配置了 PYPI 的相关镜像，这让你在开始上手时可以避免一些因为网络导致的下载问题。

<Card
  title="秋叶 ComfyUI 整合包"
  icon="video-play"
  href="https://www.bilibili.com/video/BV1Ew411776J"
>
 访问秋叶整合包原始发布地址
</Card>
