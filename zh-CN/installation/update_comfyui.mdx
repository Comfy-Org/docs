...
ComfyUI 桌面版采用自动更新机制，确保你始终使用最新版本。
...
<Warning>
**重要原则：**ComfyUI 的核心依赖版本通常和当前的 ComfyUI 版本是兼容的，对应的 ComfyUI 也需要对应的依赖的功能支持保证相关功能正常使用。
</Warning>
...
<Steps>
  ...
  <Step title="逐个安装核心包">
    ...
    **然后按照指定版本安装：**
    ...
    <Warning>
    建议使用 requirements.txt 中指定的确切版本号，不要自行升级到最新版本，这可能导致兼容性问题。
    </Warning>
  </Step>
</Steps>
...
你也可以直接查看在线的 [ComfyUI/requirements.txt](https://github.com/comfyanonymous/ComfyUI/blob/master/requirements.txt) 来确认最新的版本要求。
...
<Warning>
如果你总是使用稳定版本更新，那么你可能需要等待较长时间才能体验到我们最新发布的功能。
</Warning>
...
<Card title="问题排查" icon="text" href="/zh-CN/troubleshooting/overview">
  查看如何排查问题
</Card>
