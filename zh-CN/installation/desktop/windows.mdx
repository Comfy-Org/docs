...
log_path_screenshoot="![ComfyUI 日志文件输出位置](/images/desktop/win-comfyui-desktop-10-logs.jpg)"
config_path="C:/Users/<你的用户名>/AppData/Roaming/ComfyUI"
config_path_screenshoot="![ComfyUI 配置文件位置](/images/desktop/win-comfyui-desktop-11-config.jpg)"
/>
