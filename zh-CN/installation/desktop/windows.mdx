...
**ComfyUI 桌面版（Desktop）** 是一个独立的安装版本，可以像常规软件一样进行安装，支持快捷安装自动配置 **Python环境及依赖** ，支持一件导入已有的 ComfyUI 设置、模型、工作流和文件，可以快速从已有的[ComfyUI 便携版](/zh-CN/installation/comfyui_portable_windows)迁移到桌面版
...
- 请更换使用支持的设备
- 或者考虑使用 [ComfyUI便携版](/zh-CN/installation/comfyui_portable_windows) 来使用 ComfyUI
