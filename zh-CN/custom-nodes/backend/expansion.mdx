...
- [Subgraphs (Python)](/zh-CN/custom-nodes/backend/subgraphs) — How `UNIQUE_ID` behaves inside subgraphs
- [Subgraphs (Developer Guide)](/zh-CN/custom-nodes/js/subgraphs) — Frontend guide for extension authors
