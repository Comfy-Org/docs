...
ComfyUI 核心使用节点替换进行内置节点迁移。以下是 [`comfy_extras/nodes_replacements.py`](https://github.com/Comfy-Org/ComfyUI/blob/main/comfy_extras/nodes_replacements.py) 中的实际示例：
