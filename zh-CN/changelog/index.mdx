...
**工作流安全与权限管理**
- **工作流权限修复**: 解决了影响工作流分享和协作功能的关键权限问题

**文档与资源更新**
- **更新便携式链接**: 在说明文件中添加了新的便携式安装链接，方便在不同平台上进行设置和分发

**API 节点增强**
- **Rodin3D-Gen2 参数修复**: 修复了 Rodin3D-Gen2 节点中缺失的"task_uuid"参数，确保 3D 生成的正确追踪和完成
- **Seedance Pro 模型支持**: 增强了 FirstLastFrame 节点，使其与 Seedance Pro 模型兼容，扩展了帧插值和动画工作流选项
</Update>
