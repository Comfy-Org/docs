...
**新模型支持**
- Qwen Image Layered 扩散模型，配备专用空潜在向量节点
- 改进 Wan/Qwen 模型的 VAE 兼容性，支持自动通道处理
- 增强 Jina CLIP v2 和 NewBie 双 CLIP 文本编码器支持

**新功能**
- LatentCutToBatch 节点，用于批处理工作流
- Flux2MaxImage API 节点，用于高分辨率图像生成
- 统一作业 API，提供 /api/jobs 端点进行工作流监控
- Gemma3 模型中的滑动注意力机制，改善长序列处理

**改进**
- 重构训练器，添加分辨率分桶功能提高训练效率
- 增强 AMD GPU 支持，提供可选的 MIOpen 加速
