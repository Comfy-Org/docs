...
**新的AI视频生成API**
- **Sora2 API节点**：新增对OpenAI Sora2视频生成API的支持，为ComfyUI工作流带来最先进的文本生成视频功能
- **PixVerse增强**：改进了PixVerse API节点，支持多行负向提示词，为视频生成质量提供更好的控制

**增强的文本编码支持**
- **Gemma 3集成**：将Gemma 3实现为文本编码器，为文本生成图像和多模态工作流扩展了语言模型选择

**节点架构迁移（V3）**
- **Pika和Kling更新**：将Pika和Kling视频生成节点转换为V3架构，提高了视频工作流的兼容性和一致性

**自定义节点兼容性**
- **LTXV节点修复**：为LTXV自定义节点应用临时修复，解决工作流中断问题并维持稳定的视频生成管道

**API基础设施改进**
- **ReCraft API增强**：修复了ReCraft API节点中的自定义多部分解析器，确保正确返回FormData，提高图像编辑工作流的可靠性
- **代码质量**：增强API节点的pylint规则，确保更好的代码一致性和可维护性

**前端更新**
- **版本更新**：将前端更新至版本1.27.10，包含最新的UI改进和性能优化
</Update>
