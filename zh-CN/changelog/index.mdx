...
- **新增 Seedream 节点**：新增 ByteDanceSeedream (4.0) 节点，增强了 AI 生成能力。这扩展了 ComfyUI 工作流中可用的生成模型，为用户提供了更多创意内容生成选项。

**模板系统更新**
- **模板版本 0.1.78**：将核心模板系统更新至版本 0.1.78，提升了工作流稳定性，并确保与最新节点实现的兼容性。
