...
<div style="text-align: center;">
  <video controls>
    <source src="https://github.com/user-attachments/assets/442afb73-3092-454f-bc46-02361c285930" type="video/mp4"/>
  </video>
  <p>视频来自<a href="https://github.com/Tencent/HunyuanVideo-I2V">HunyuanVideo</a></p>
</div>
...
<div class="flex justify-center space-x-4">
    <div class="text-center">
        <img src="https://comfyanonymous.github.io/ComfyUI_examples/hunyuan_video/hunyuan_video_image_to_video.webp" alt="HunyuanVideo v1" class="w-auto h-auto" />
        <p>v1 版本示例</p>
    </div>
    <div class="text-center">
        <img src="https://comfyanonymous.github.io/ComfyUI_examples/hunyuan_video/hunyuan_video_image_to_video_v2.webp" alt="HunyuanVideo v2" class="w-auto h-auto" />
        <p>v2 版本示例</p>
    </div>
</div>
...
3. 请在`Load Image Model`加载了`diffusion_model_name: hunyuan_video_image_to_video_720p_bf16.safetensors`
4. 确保`Load VAE`中加载了`vae_name: hunyuan_video_vae_bf16.safetensors`
