...
<Note>
**正在寻找注册表发布 API 密钥？** 如果您想要将自定义节点发布到 Comfy Registry，您需要不同的 API 密钥。请参阅[发布节点](/zh-CN/registry/publishing#创建用于发布的-api-密钥)文档了解如何创建注册表发布 API 密钥的详细信息。
</Note>
