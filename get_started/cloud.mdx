...
Cloud sessions only bill you while they are actively running. To stop a session and avoid further charges, simply close the browser tab or window. You can also stop sessions from your [Comfy Cloud dashboard](https://comfy.org/cloud).
