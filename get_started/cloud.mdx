...
<AccordionGroup>
  <Accordion title="Does Comfy Cloud have content moderation?">
    Comfy Cloud does not perform automated content moderation on generated outputs. Users are responsible for ensuring their use of the service complies with applicable laws and the [Terms of Service](https://comfy.org/terms).
  </Accordion>
</AccordionGroup>
