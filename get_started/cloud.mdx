...
Cloud sessions only bill you while the GPU is actively running. When you close the browser tab, the session stops automatically — you can close it anytime, just like a regular browser tab. You can also stop sessions from your [Comfy Cloud dashboard](https://comfy.org/cloud).
