...
<Note>
WeChat Pay is only available in specific regions. Check the [Stripe WeChat Pay documentation](https://docs.stripe.com/payments/wechat-pay#get-started) to verify availability in your country.

For Alipay, refer to the `Business locations` section in the [Stripe Alipay documentation](https://docs.stripe.com/payments/alipay) to confirm regional support.
</Note>
