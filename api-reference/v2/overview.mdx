...
Comfy API v2 runs workflows as durable jobs you submit and poll. For direct model calls (one partner model, one request, the model's native input and output), see the [Comfy Router](/api-reference/comfy-router/quickstart) instead.
