...
- [Comfy Router quickstart](/api-reference/comfy-router/quickstart): a first working call in Python or TypeScript.
- [Comfy Router API reference](/api-reference/comfy-router/reference): every endpoint, every parameter and every error bucket Router does send.
