...
|---|---|---|---|
| **What is it** | Run Comfy Cloud workflows with your own agent | Drive your own local ComfyUI from your own agent | Chatting with AI inside the app, see the AI build and run workflows for you |
| **Best for** | Beginners who don't want to set up ComfyUI locally.<br />People who want to share workflows. | People who have ComfyUI locally.<br />People who have private custom nodes.<br />Interact with the local file system. | From beginners to complicated workflows;<br />People who want to see the canvas and check the workflows visually |
| **Requires** | Your own agent;<br />Comfy Cloud subscription for paid runs. | Your own agent;<br />Local ComfyUI set up | No setup.<br />Comfy Cloud subscription for paid runs. |
