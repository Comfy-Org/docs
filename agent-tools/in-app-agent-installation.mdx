...
Open a blank workflow, then select **Agent** at the far right of the tab bar, next to your avatar. Read and accept the consent notice if prompted. Use **Choose a workflow** in the Agent panel to select the blank workflow.
