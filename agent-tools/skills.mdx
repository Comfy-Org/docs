...
[**Comfy Skills**](https://github.com/Comfy-Org/comfy-skills) is the home of agent skills and plugins for Comfy. Skills are packaged knowledge that compatible agents can load on demand: model guidance, workflow patterns, and ready-made commands. They provide reusable instructions for ComfyUI tasks, so you do not need to write the same guidance from scratch.
