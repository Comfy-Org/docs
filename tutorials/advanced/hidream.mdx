...
You need to use City96's [ComfyUI-GGUF](https://github.com/city96/ComfyUI-GGUF) nodes to use the GGUF version models. For specific usage methods, please refer to the README documentation of [ComfyUI-GGUF](https://github.com/city96/ComfyUI-GGUF).
- [ComfyUI-GGUF](https://github.com/city96/ComfyUI-GGUF)

### NF4 Version Models
- [HiDream-I1-nf4](https://github.com/hykilpikonna/HiDream-I1-nf4) 
You can use the [ComfyUI-HiDream-Sampler](https://github.com/SanDiegoDude/ComfyUI-HiDream-Sampler) node to use the NF4 version model.
