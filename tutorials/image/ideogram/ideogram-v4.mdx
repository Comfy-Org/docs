...
![Ideogram 4.0 Workflow](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_ideogram4_t2i-1.webp)
*Ideogram 4.0 text-to-image workflow in ComfyUI using Subgraph nodes*

[![Ideogram 4.0 Example Output](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_ideogram4_t2i.png)](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_ideogram4_t2i.png)
*Click to view full-size example output*
...
For local use, download the following models and place them in the correct directories:
