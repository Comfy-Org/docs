...
This style reference workflow requires an additional diffusion model and a dedicated style reference LoRA. Text encoder (Qwen3VL-4B) and VAE are shared with the text-to-image workflow.
