...
<CardGroup cols={2}>
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=hidream_e1_1&utm_source=docs&utm_medium=referral&utm_campaign=hidream_e1">
    Open in Comfy Cloud
  </Card>
...
<CardGroup cols={2}>
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=hidream_e1_full&utm_source=docs&utm_medium=referral&utm_campaign=hidream_e1">
    Open in Comfy Cloud
  </Card>
