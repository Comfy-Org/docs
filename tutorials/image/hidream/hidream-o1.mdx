...
**Checkpoint (Full)** — re-packaged and quantized. All use bf16 for worst outliers, unused deepstack layers removed:
...
**Checkpoint (Dev)** — same re-packaging and quantization:
...
Checkpoints are listed above in the Full Workflow section — choose Dev variants (`hidream_o1_image_dev_*`).
