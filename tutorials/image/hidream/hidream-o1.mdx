...
- `fp8_scaled` — FP8 quantized, uses fp8 or mxfp8 matmuls on safe MLP layers on supported hardware for speedup
- `mxfp8` — MXFP8 quantized variant
- `bf16` — Full bf16 precision (largest file)
