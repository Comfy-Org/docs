...
description: "ERNIE-Image is Baidu's open 8B Diffusion Transformer text-to-image model for ComfyUI, with precise text rendering and a built-in Prompt Enhancer."
