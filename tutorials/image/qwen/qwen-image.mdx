...
<CardGroup cols={2}>
  ...
  <Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_qwen_image.json">
...
<CardGroup cols={2}>
  <Card title="Download Workflow for Qwen-Image Official Model" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_qwen_image.json">
    Download the JSON workflow file for local use
  </Card>
  <Card title="Download Workflow for Distilled Model" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/image/qwen/image_qwen_image_distill.json">
    Download the JSON workflow file for local use
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_qwen_image_instantx_controlnet.json">
    Download the JSON workflow file for local use
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_qwen_image_controlnet_patch.json">
    Download the JSON workflow file for local use
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_qwen_image_union_control_lora.json">
    Download the JSON workflow file for local use
  </Card>
</CardGroup>
