...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_qwen_image_edit-1.webp" alt="Qwen-Image-Edit workflow preview" />

<CardGroup cols={2}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=image_qwen_image_edit&utm_source=docs&utm_medium=referral&utm_campaign=qwen-image-edit">
    Run this workflow on Cloud GPUs with zero setup
  </Card>
  <Card title="Download Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_edit.json">
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '1rem', alignItems: 'start'}}>
  <img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/image_qwen_image_edit_input_image.png" alt="Input image" style={{width: '100%', height: 'auto', objectFit: 'contain'}} />
  <img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/output/image_qwen_image_edit.jpg" alt="Qwen-Image-Edit example output" style={{width: '100%', height: 'auto', objectFit: 'contain'}} />
</div>
...
Qwen-Image-Edit-2509 is the next iteration of Qwen-Image-Edit. It keeps the precise bilingual text editing of the original model and adds multi-image input, more consistent edits across a series of images, and ControlNet support, so you can edit one image while referencing others.

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/image_qwen_image_edit_2509-1.webp" alt="Qwen Image Edit 2509 workflow preview" />

<CardGroup cols={2}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=image_qwen_image_edit_2509&utm_source=docs&utm_medium=referral&utm_campaign=qwen-image-edit">
    Open in Comfy Cloud
  </Card>
  <Card title="Download Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/image_qwen_image_edit_2509.json">
    Download JSON or search &quot;Qwen Image Edit 2509&quot; in Template Library
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="image_qwen_image_edit_2509_input_image.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/image_qwen_image_edit_2509_input_image.png">
    `LoadImage` node 78 · `image_qwen_image_edit_2509_input_image.png`
  </Card>
</CardGroup>
