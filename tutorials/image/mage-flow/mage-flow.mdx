...
description: "Mage-Flow is a compact 4B-parameter generative stack from Microsoft for text-to-image generation and instruction-based image editing. It uses Mage-VAE and a Native-Resolution Multimodal Diffusion Transformer (NR-MMDiT) with rectified flow matching."
...
**License**: [Apache 2.0](https://github.com/microsoft/Mage/blob/main/LICENSE)
