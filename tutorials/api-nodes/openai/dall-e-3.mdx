...
description: "Learn how to use the OpenAI DALL·E 3 API node to generate images in ComfyUI"
...
![OpenAI DALL·E 3 node screenshot](/images/comfy_core/api_nodes/openai-dall-e-3.jpg)
...
![ComfyUI openai-dall-e-3 workflow](/images/tutorial/api_nodes/openai-dall-e-3/text2image.jpg)
