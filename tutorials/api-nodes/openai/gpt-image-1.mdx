...
- [User Login Guide](/interface/user)
- [Credits Purchase Guide](/interface/credits)
...
![ComfyUI openai-gpt-image-1 workflow example](/images/tutorial/api_nodes/gpt-image-1/text2image.jpg)
...
![ComfyUI openai-gpt-image-1 workflow example](/images/tutorial/api_nodes/gpt-image-1/image2image.jpg)
...
![Multiple Image Input Example](/images/tutorial/api_nodes/gpt-image-1/multi_images_input.png)
...
![ComfyUI openai-gpt-image-1 workflow example](/images/tutorial/api_nodes/gpt-image-1/inpaint.jpg)
