...
<Card title="API Key Integration" icon="link" href="/essentials/comfyui-server/api-key-integration">
...
如果你想通过程序或在无头模式下使用API节点（无需前端界面），ComfyUI提供了直接通过webserver API使用API Key的功能。

<Card title="无头模式API使用" icon="terminal" href="/tutorials/api-nodes/headless-api">
了解如何在无头模式或通过webserver API使用API节点
</Card>
