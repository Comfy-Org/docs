...
API Nodes use a token-based billing system, charging based on factors such as model, quality, and resolution. For example, the pricing structure for [GPT-Image-1](/tutorials/api-nodes/openai/gpt-image-1) is as follows:
