...
sidebarTitle: "API Nodes Overview"
---
...
<AccordionGroup>
  ...
  <Accordion title="Why can't I use / log in to the API Nodes?">
    Please refer to the prerequisites section of this article to ensure you meet the necessary conditions for use:
    - A secure network environment
    - Logged into your Comfy account
    - Sufficient credit balance
  </Accordion>
  
  <Accordion title="Can API Nodes be used for free?">
    API Nodes require credits because they call closed-source models through the API, so they cannot be used for free.
  </Accordion>

  <Accordion title="Can I get a refund for API Nodes?">
  Currently, we do not support refunds.
  </Accordion>

<Accordion title="Can I use my own API Key?">
  API Nodes are still in the testing phase and currently do not support using your own API Key. We may consider supporting this in the future.
  </Accordion>
