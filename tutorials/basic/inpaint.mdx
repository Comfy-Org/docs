...
In this tutorial, you can use any of the following models, or continue using the SD1.5 model we used in previous [Text-to-Image](/zh-CN/tutorials/basic/text-to-image) and [Image-to-Image](/zh-CN/tutorials/basic/image-to-image) tutorials:
...
Comparing this workflow with [Text-to-Image](/zh-CN/tutorials/basic/text-to-image) and [Image-to-Image](/zh-CN/tutorials/basic/image-to-image), you'll notice the main differences are in the VAE section's conditional inputs.
