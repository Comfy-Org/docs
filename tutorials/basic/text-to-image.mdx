...
Download the image below and drag it into the ComfyUI interface, or use the menu **Workflows** -> **Open** to open this image and load the corresponding workflow

![ComfyUI-Text to Image Workflow](/images/tutorial/gettingstarted/text-to-image-workflow.png)

You can also select the **Text to Image** workflow from **Workflows** -> **Browse example workflows**
...
```mermaid
graph LR
Random Noise[Latent Space] --> KSampler[Sampler]
CLIP Semantic Vectors --> KSampler
