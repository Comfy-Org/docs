...
<CardGroup cols={2}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=ltxv_image_to_video&utm_source=docs">
    Open in Comfy Cloud
  </Card>
  ...
  <Card title="Download Sample Image" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/ltxv_image_to_video_input_image.jpg">
...
<CardGroup cols={2}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=ltxv_text_to_video&utm_source=docs">
    Open in Comfy Cloud
  </Card>
