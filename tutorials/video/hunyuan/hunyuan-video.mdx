...
<Card title="Download CLIP-L" icon="download" href="https://huggingface.co/Comfy-Org/HunyuanVideo_repackaged/resolve/main/split_files/text_encoders/clip_l.safetensors?download=true">
  clip_l.safetensors &mdash; text encoder shared across all workflows
</Card>

<Card title="Download LLaVA LLaMA3" icon="download" href="https://huggingface.co/Comfy-Org/HunyuanVideo_repackaged/resolve/main/split_files/text_encoders/llava_llama3_fp8_scaled.safetensors?download=true">
  llava_llama3_fp8_scaled.safetensors &mdash; text encoder shared across all workflows
</Card>

<Card title="Download Hunyuan VAE" icon="download" href="https://huggingface.co/Comfy-Org/HunyuanVideo_repackaged/resolve/main/split_files/vae/hunyuan_video_vae_bf16.safetensors?download=true">
  hunyuan_video_vae_bf16.safetensors &mdash; VAE shared across all workflows
</Card>
...
<Card title="Download T2V Diffusion Model" icon="download" href="https://huggingface.co/Comfy-Org/HunyuanVideo_repackaged/resolve/main/split_files/diffusion_models/hunyuan_video_t2v_720p_bf16.safetensors?download=true">
  hunyuan_video_t2v_720p_bf16.safetensors &mdash; save to ComfyUI/models/diffusion_models
</Card>
...
<Card title="Download CLIP Vision" icon="download" href="https://huggingface.co/Comfy-Org/HunyuanVideo_repackaged/resolve/main/split_files/clip_vision/llava_llama3_vision.safetensors?download=true">
  llava_llama3_vision.safetensors &mdash; save to ComfyUI/models/clip_vision
</Card>
...
<Card title="Download I2V v1 Diffusion Model" icon="download" href="https://huggingface.co/Comfy-Org/HunyuanVideo_repackaged/resolve/main/split_files/diffusion_models/hunyuan_video_image_to_video_720p_bf16.safetensors?download=true">
  hunyuan_video_image_to_video_720p_bf16.safetensors &mdash; save to ComfyUI/models/diffusion_models
</Card>
...
<Card title="Download I2V v2 Diffusion Model" icon="download" href="https://huggingface.co/Comfy-Org/HunyuanVideo_repackaged/resolve/main/split_files/diffusion_models/hunyuan_video_v2_replace_image_to_video_720p_bf16.safetensors?download=true">
  hunyuan_video_v2_replace_image_to_video_720p_bf16.safetensors &mdash; save to ComfyUI/models/diffusion_models
</Card>
