...
description: "Control the motion of MiniMax H3 videos in ComfyUI with Canny, Depth, HED, MLSD, or Pose control videos, or run video inpainting with the Fun ControlNet Union patch."
