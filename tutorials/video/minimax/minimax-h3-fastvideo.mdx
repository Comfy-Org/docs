...
description: "FastVideo FastH3 generates MiniMax H3 video with synchronized audio in 8 sampling steps in ComfyUI, for text-to-video and first/last-frame workflows."
