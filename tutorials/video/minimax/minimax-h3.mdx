---
title: "MiniMax H3 in ComfyUI: Overview"
description: "Overview of the open-weights MiniMax H3 in ComfyUI: capabilities, workflow index, prompt writing, and generation speedups for video with native stereo audio."
