...
### MiniMax H3 Image to Video continuation

A continuation variant of the I2V workflow: load an image, then describe the motion, shots, and audio you want. The workflow ships with an empty prompt and stays fully editable before execution.

<CardGroup cols={2}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_minimax_h3_i2v_continuation&utm_source=docs&utm_medium=referral&utm_campaign=minimax-h3">
    Open in Comfy Cloud
  </Card>
  <Card title="Download Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/video_minimax_h3_i2v_continuation.json">
    Download JSON or search "MiniMax H3 I2V Continuation" in Template Library
  </Card>
</CardGroup>

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/video_minimax_h3_i2v_continuation-1.webp" alt="MiniMax H3 Image to Video continuation workflow preview" />
...
It uses the same model downloads as the I2V workflow above.
