...
Community-trained example embeddings are available in the [silveroxides/MiniMax-H3_tests](https://huggingface.co/silveroxides/MiniMax-H3_tests/tree/main/embeddings) repository, such as `minimaxh3_art_is_explosion.safetensors` (used as `embedding:minimaxh3_art_is_explosion`).
