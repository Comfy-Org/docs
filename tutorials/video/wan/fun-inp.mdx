...
<CardGroup cols={2}>
  <Card title="wan2.1_fun_inp_1.3B_bf16.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/blob/main/split_files/diffusion_models/wan2.1_fun_inp_1.3B_bf16.safetensors">
    Wan2.1 Fun InP 1.3B diffusion model — lower VRAM requirements
  </Card>
  <Card title="Wan2.1-Fun-14B-InP" icon="download" href="https://huggingface.co/alibaba-pai/Wan2.1-Fun-14B-InP/blob/main/diffusion_pytorch_model.safetensors">
    Wan2.1 Fun InP 14B diffusion model — rename to Wan2.1-Fun-14B-InP.safetensors after downloading
  </Card>
</CardGroup>
