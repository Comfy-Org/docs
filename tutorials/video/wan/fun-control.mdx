...
<CardGroup cols={2}>
  <Card title="Reference Image: 01-portrait_remix.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/wan2.1_fun_control/input/01-portrait_remix.png">
    Input reference image for the native workflow. Download and use this image, or replace with your own.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Reference Image: 02-robot's_eye.png" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/wan2.1_fun_control/input/02-robot's_eye.png">
    Input reference image for the custom nodes workflow. Download and use this image, or replace with your own.
  </Card>
  <Card title="Control Video: 02-man's_eye.mp4" icon="video" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/wan2.1_fun_control/input/02-man's_eye.mp4">
