...
<CardGroup cols={2}>
  <Card title="wan2.1_fun_control_1.3B_bf16.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/diffusion_models/wan2.1_fun_control_1.3B_bf16.safetensors?download=true">
...
<CardGroup cols={2}>
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=wan2.1_fun_control&utm_source=docs&utm_medium=referral&utm_campaign=wan2-1-fun-control">
    Open in Comfy Cloud
  </Card>
