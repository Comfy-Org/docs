...
**Wan-Move** is a motion-controllable video generation framework developed by Alibaba's Tongyi Lab, presented at NeurIPS 2025. It brings SOTA fine-grained, point-level motion control to Wan I2V models.

**Key Features**:
- **High-Quality 5s 480p Motion Control**: Generates 5-second, 480p videos with SOTA motion controllability
