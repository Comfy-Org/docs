...
<CardGroup cols={2}>
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=image_to_video_wan&utm_source=docs&utm_medium=referral&utm_campaign=wan-video">
    Open in Comfy Cloud
  </Card>
