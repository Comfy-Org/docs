...
<CardGroup cols={2}>
  ...
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_5B_ti2v&utm_source=docs&utm_medium=referral&utm_campaign=wan2_2">
    Open in Comfy Cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_t2v&utm_source=docs&utm_medium=referral&utm_campaign=wan2_2">
    Open in Comfy Cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_i2v&utm_source=docs&utm_medium=referral&utm_campaign=wan2_2">
    Open in Comfy Cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_flf2v&utm_source=docs&utm_medium=referral&utm_campaign=wan2_2">
    Open in Comfy Cloud
  </Card>
</CardGroup>
