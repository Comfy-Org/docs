...
Wan FLF (full name Wan2.1-FLF2V-14B-720P) is an open-source video generation model developed by the Alibaba Tongyi Wanxiang team. Its open-source license is [Apache 2.0](https://github.com/Wan-Video/Wan2.1?tab=Apache-2.0-1-ov-file).
...
<Note>
We provide three versions of the model: fp16, fp8, and fp8_e4m3fn_scaled. In the workflow below, we use the fp8_e4m3fn_scaled version to ensure normal operation under lower VRAM, if you need a higher precision version, please refer to the manual model installation section to download other precision versions.
</Note>
...
![](https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/wan2.1_flf2v/input/start_image.png)
![](https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/wan2.1_flf2v/input/end_image.png)

### 2. Manual Model Installation

If corresponding

All models involved in this guide can be found [here](https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/tree/main/split_files), we provide fp16 and fp8 versions of the models, you can choose according to your device conditions.

**diffusion_models** Choose one version based on your hardware conditions
| Download Link | File Size |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|
| [wan2.1_flf2v_720p_14B_fp16.safetensors](https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/diffusion_models/wan2.1_flf2v_720p_14B_fp16.safetensors?download=true) | 32.8GB |
| [wan2.1_flf2v_720p_14B_fp8.safetensors](https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/diffusion_models/wan2.1_flf2v_720p_14B_fp8.safetensors?download=true) | 16.4GB |
| [wan2.1_flf2v_720p_14B_fp8_e4m3fn_scaled.safetensors](https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/diffusion_models/wan2.1_flf2v_720p_14B_fp8_e4m3fn_scaled.safetensors?download=true) | 16.4GB |
...
├── models/
│   ├── diffusion_models/
│   ├── wan2.1_flf2v_720p_14B_fp8_e4m3fn_scaled.safetensors   # or your chosen version
│   ├── text_encoders/
...
![Wan2.1 FLF2V 720P Native Workflow Steps](/images/tutorial/video/wan/Wan2.1_FLF2V_720P_step_guide.jpg)

1. Ensure the `Load Diffusion Model` node has loaded `wan2.1_flf2v_720p_14B_fp8_e4m3fn_scaled.safetensors`
