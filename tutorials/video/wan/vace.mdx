...
The model is open-sourced under the [Apache-2.0](https://github.com/ali-vilab/VACE?tab=Apache-2.0-1-ov-file) license and can be used for personal commercial purposes.
...
![fennec_girl](/images/tutorial/video/wan/wan-vace-fennec_girl.jpg)
...
<Card title="TrimVideoLatent Node Documentation" icon="book" href="/built-in-nodes/image/video/trim-video-lantent">
