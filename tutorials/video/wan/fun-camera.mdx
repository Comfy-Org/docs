...
<Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/video/wan/fun-camera/v1.1/wan2.1_fun_camera_1.3B.json">
...
<Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/video/wan/fun-camera/v1.1/wan2.1_fun_camera_14B.json">
  Download the JSON workflow file for local use
</Card>
