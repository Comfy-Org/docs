...
<CardGroup cols={2}>
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2.1_fun_camera_v1.1_1.3B&utm_source=docs&utm_medium=referral&utm_campaign=fun-camera">
    Open in Comfy Cloud
  </Card>
...
### 2. Download Input Material

<CardGroup cols={1}>
  <Card title="Input Reference Image" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/video_wan2.1_fun_camera_v1.1_1.3B_start_image.jpg">
    Download the image below to use as the starting frame for the 1.3B workflow
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Run in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2.1_fun_camera_v1.1_14B&utm_source=docs&utm_medium=referral&utm_campaign=fun-camera">
    Open in Comfy Cloud
  </Card>
...
<CardGroup cols={1}>
  <Card title="Input Reference Image" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/video_wan2.1_fun_camera_v1.1_14B_start_image.jpg">
    Download the image below to use as the starting frame for the 14B workflow
  </Card>
</CardGroup>
