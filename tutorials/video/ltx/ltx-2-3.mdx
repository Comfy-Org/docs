...
<CardGroup cols={2}>
  ...
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://links.comfy.org/4skdlDQ">
    Open in cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://links.comfy.org/4rZ1DyY">
    Open in cloud
  </Card>
</CardGroup>
