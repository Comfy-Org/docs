...
<CardGroup cols={2}>
  <Card title="Text-to-Video" icon="video" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/video_ltx2_t2v.json">
    Download workflow
  </Card>
...
<Card title="Text-to-Video Distilled" icon="bolt" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/video_ltx2_t2v_distilled.json">
  Download workflow
</Card>
...
<CardGroup cols={2}>
  <Card title="Image-to-Video" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/video_ltx2_i2v.json">
    Download workflow
  </Card>
...
**Distilled version** (faster, 8 steps):
<Card title="Image-to-Video Distilled" icon="bolt" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/video_ltx2_i2v_distilled.json">
  Download workflow
</Card>
...
**Depth control:**
<CardGroup cols={2}>
  <Card title="Depth-to-Video" icon="cube" href="https://github.com/Comfy-Org/workflow_templates/raw/refs/heads/main/templates/video_ltx2_depth_to_video.json">
    Download workflow
  </Card>
...
**Canny control:**
<CardGroup cols={2}>
  <Card title="Canny-to-Video" icon="border-all" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/video_ltx2_canny_to_video.json">
    Download workflow
  </Card>
...
**Pose control:**
<CardGroup cols={2}>
  <Card title="Pose-to-Video" icon="person" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/video_ltx2_pose_to_video.json">
    Download workflow
  </Card>
