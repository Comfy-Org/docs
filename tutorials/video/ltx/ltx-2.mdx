...
<CardGroup cols={2}>
  ...
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_ltx2_t2v&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_ltx2_i2v&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_ltx2_depth_to_video&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_ltx2_canny_to_video&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=video_ltx2_pose_to_video&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>
