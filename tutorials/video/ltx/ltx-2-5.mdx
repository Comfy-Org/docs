...
description: "Learn how to use LTX-2.5 in ComfyUI with native workflows for text-to-video, image-to-video, and first-last-frame-to-video, with pixel-diffusion quality, native multishot scenes, and synchronized audio."
