...
Billed per second of enhanced output. The rates below are per second at up to 30 fps. Frame rates up to 60 fps double the rate, and frame rates above 60 fps quadruple it. With **source** resolution or frame rate selected, the rate scales with the source video (approximately 1× to 4×).
