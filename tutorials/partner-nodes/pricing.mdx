...
| MiniMax H3 Reference to Video               | MiniMax H3 Max                       | 480P       | 60.36 / sec, plus 24.14 / 1K reference tokens beyond 4,096 free tokens |
| MiniMax H3 Reference to Video               | MiniMax H3 Max                       | 768P       | 96.58 / sec, plus 24.14 / 1K reference tokens beyond 4,096 free tokens |

**MiniMax Hailuo 02 Video** only supports **6s** at 1080P.

**MiniMax H3** bills per second (5–15s duration). **MiniMax H3 Reference to Video** adds 12.07 credits per reference image beyond 5, and bills reference videos at 27.16 credits/sec (768P) or 39.22 credits/sec (2K) (2s per video, up to 15s total, approximate). **MiniMax H3 Context IR** prices depend on attached media: text only, first/last frame, or reference media (approximate).

**MiniMax H3 Max** bills per second (5–15s duration) at the rates above.

**MiniMax H3 Max Reference to Video** reference billing is token-based. Reference tokens are pooled across every image, video, and audio clip in the request. The first 4,096 tokens are free; each 1K tokens beyond that costs 24.14 credits. Image tokens count as (width × height) / 1024.

| Reference image | Tokens | Free | Each additional |
| :-------------- | :----- | :--- | :-------------- |
| 1024 x 1024     | 1,024  | First 4 images | 24.14 credits |
| 2048 x 2048     | 4,096  | First image    | 96.58 credits |
...
| :---------------- | :--------------------- | :------------------- |
| 480P              | 2,886 / sec            | 69.68 credits / sec  |
| 768P              | 7,459 / sec            | 180.09 credits / sec |

Audio costs the same regardless of output resolution.

| Audio        | Tokens | Audio cost       |
| :----------- | :----- | :--------------- |
| Per second   | 80     | 1.93 credits / sec |
