...
The **GPT Image 2.5** models (`gpt-image-2.5-flare`, `gpt-image-2.5-sunburst`) bill from preset rates by `quality` and `size`, plus a per-reference-image charge; badge values are approximate. Costs below are credits / image at representative sizes:

| quality | 1024x1024 | 1536x1024 | 2048x2048 | Any other size |
| :------ | --------: | --------: | --------: | :------------- |
| low     | 1.77      | 1.44      | 3.59      | 0.49 to 5.97   |
| medium  | 3.97      | 3.10      | 8.08      | 1.18 to 13.42  |
| high    | 15.89     | 12.43     | 32.30     | 4.68 to 53.68  |
| xhigh   | 28.25     | 22.26     | 57.41     | 8.19 to 95.44  |
| max     | 63.57     | 49.67     | 129.20    | 18.72 to 214.69 |

Each reference image adds **2.47 to 3.71** credits. Multiplying images (`n`) scales the total.
