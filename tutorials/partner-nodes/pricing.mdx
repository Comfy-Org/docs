...
| MiniMax H3 Reference to Video               | MiniMax H3 Max                       | 480P       | 15.09 / sec, plus 6.03 / 1K reference tokens beyond 4,096 free tokens |
| MiniMax H3 Reference to Video               | MiniMax H3 Max                       | 768P       | 24.14 / sec, plus 6.03 / 1K reference tokens beyond 4,096 free tokens |
...
**MiniMax H3 Max Reference to Video** reference billing is token-based. Reference tokens are pooled across every image, video, and audio clip in the request. The first 4,096 tokens are free; each 1K tokens beyond that costs 6.03 credits. Image tokens count as (width × height) / 1024. The free image counts below apply only when no reference video or audio consumes the pooled 4,096-token allowance.

| Reference image | Tokens | Free | Each additional |
| :-------------- | :----- | :--- | :-------------- |
| 1024 x 1024     | 1,024  | First 4 images | 6.03 credits |
| 2048 x 2048     | 4,096  | First image    | 24.14 credits |

The reference video token rate follows the output resolution, not the resolution of the reference clip: the same reference clip costs the same whether it is 480P or 768P, and only the output resolution changes the rate.

| Output resolution | Reference video tokens | Reference video cost |
| :---------------- | :--------------------- | :------------------- |
| 480P              | 2,886 / sec            | 17.42 credits / sec  |
| 768P              | 7,459 / sec            | 45.01 credits / sec |

Audio costs the same regardless of output resolution.

| Audio        | Tokens | Audio cost       |
| :----------- | :----- | :--------------- |
| Per second   | 80     | 0.48 credits / sec |
