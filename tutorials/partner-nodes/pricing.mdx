...
The reference video token rate follows the output resolution, not the resolution of the reference clip: a 480P and a 768P reference of the same length cost the same.
