...
**MiniMax H3 Max Reference to Video** reference billing is token-based. Reference tokens are pooled across every image, video, and audio clip in the request. The first 4,096 tokens are free; each 1K tokens beyond that costs 6.03 credits. Image tokens count as (width × height) / 1024.
