...
Ultra Mode (available on Meshy 7.1, Meshy 7, and `latest` models) adds 60.3 credits: Text to Model 301.7 / run, Image to Model 422.4 / run (2K, 4K texture) or 482.7 / run (8K texture), Multi-Image to Model 422.4 / run (2K, 4K texture) or 482.7 / run (8K texture). The ultra pass resolution (`2k` or `4k`) does not change the price.
