...
| Node                                       | Credits    |
| :----------------------------------------- | :--------- |
| Bria Remove Video Background               | 1.06 / sec |
| Bria Video Green Screen                    | 1.06 / sec |
| Bria Video Replace Background              | 1.06 / sec |
| Bria Remove Video Background (Transparent) | 1.06 / sec |
...
#### Legacy (v2-5-turbo, v2-master, v1.x) — EOL September 15, 2026

<Warning>
  **End of life (EOL)**: Kling V1.5, V1.6, V2.1, V2.1 Master, and Kolors Virtual Try-On are scheduled for retirement on **September 15, 2026**. Pricing below is retained for reference until removal.
</Warning>
...
| kolors-virtual-try-on-v1, kolors-virtual-try-on-v1-5 | —          | —           | 147.7 / run (EOL Sep 15, 2026) |
...
**MiniMax H3** bills per second (5–15s duration). **MiniMax H3 Reference to Video** adds 12.07 credits per reference image beyond 5, and bills reference videos at 39.22 credits/sec (2s per video, up to 15s total, approximate).
