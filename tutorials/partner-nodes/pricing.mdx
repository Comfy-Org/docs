...
Prompt and completion rates (per token) match `comfy_api_nodes/nodes_openrouter.py`. Final charges follow metered token usage from the chat completion response.
