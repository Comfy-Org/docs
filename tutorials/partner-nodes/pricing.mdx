...
<Note>
  **August 7, 2026 pricing update**: Input and output rates for Nano Banana Pro, Nano Banana 2, Nano Banana 2 Lite, and GPT Image 2 increased by approximately 20% after introductory provider discounts ended. Other partner and open-source models are unchanged.
</Note>
...
Rates are **per output megapixel per second**: ~21.1 credits (precise) / ~30.2 credits (creative). Total credits = rate × output megapixels × duration. Output resolution ranges from 1080p (~2.1 MP) to 4K (~8.3 MP), so the per-second rate falls within:

| Node               | mode      | Credits / sec   |
| :----------------- | :-------- | :-------------- |
| Flux Video Upscale | creative  | ~62.67 – 250.67 |
| Flux Video Upscale | precise   | ~44.73 – 178.93 |
...
**Video input** means a reference video is connected. Text, image, and audio references count as no video input.
