...
**Reference to Video** with a reference video connected uses a lower per-frame rate. Reference videos must be at least 2 seconds long, and their total duration is limited to 15 seconds. Billing is based on the source clip length plus any generated extension, up to 30 seconds. The ranges below show the minimum charge for the source duration and the maximum charge with a full 30-second extension:

| Model                   | Resolution | Credits / 5s source | Credits / 10s source |
| :---------------------- | :--------- | :------------------ | :------------------- |
| Seedance 2.5 (video)    | 480p       | 93.5 – 650.1        | 186.3 – 742.9        |
| Seedance 2.5 (video)    | 720p       | 210.3 – 1461.6      | 418.8 – 1670.2       |
