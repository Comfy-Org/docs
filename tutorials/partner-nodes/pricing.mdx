...
| MiniMax H3 Reference to Video               | MiniMax H3 Max                       | 480P       | 15.09 / sec plus token-based reference surcharge (approximate) |
| MiniMax H3 Reference to Video               | MiniMax H3 Max                       | 768P       | 24.14 / sec plus token-based reference surcharge (approximate) |
...
**MiniMax H3 Max** bills per second (5–15s duration) at the rates above. **MiniMax H3 Max Reference to Video** adds a token-based surcharge for reference media beyond a free token allowance (approximate).
