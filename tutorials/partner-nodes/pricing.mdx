...
| :--------- | -----------------: | --------------------------: | --------------------------: | ---------------------: | :------------------ |
| Opus 5.5         |              1.207 |                     1.509 |                       2.414 |                 0.121 | 6.035               |
...
| seedream 5.0 flash (`seedream-5-0-flash-260915`)    | 5.43                 |
...
| Seedream 5.0 Flash Layer Separation                 | 5.43                 |

Seedream 5.0 Pro uses resolution-based billing: **1K** (≤2.61 MP, **9.50 credits**) and **2K** (>2.61 MP, **18.99 credits**). Seedream 5.0 Flash bills a flat **5.43 credits** per image at every resolution. The first image in each request is free. Each additional image beyond the first (including both output and input/reference images) adds **0.63 credits**.
...
| gpt-6-sol    |              603.46 | 3017.3               |
| gpt-6-luna   |               30.17 | 150.87               |
...
Per run. **Text to SVG** and **Image to SVG** use different token estimates, so their ranges differ.

| model         | Node                | Credits / run     |
| :------------ | :------------------ | :---------------- |
| arrow-1.1     | Quiver Text to SVG  | 60.35             |
| arrow-1.1     | Quiver Image to SVG | 45.26             |
| arrow-1.1-max | Quiver Text to SVG  | 75.43             |
| arrow-1.1-max | Quiver Image to SVG | 60.35             |
| arrow-preview | Quiver Text to SVG  | 90.52             |
| arrow-preview | Quiver Image to SVG | 90.52             |
| arrow-2       | Quiver Text to SVG  | 7.50 - 230.19     |
| arrow-2       | Quiver Image to SVG | 4.33 - 242.33     |
| arrow-2-telos | Quiver Text to SVG  | 10.82 - 960.86    |
| arrow-2-telos | Quiver Image to SVG | 3.43 - 1041.91    |

The **arrow-2** models bill by the tokens a request consumes, so the cost depends on the selected `reasoning_effort`. The ranges above span `low` through `xhigh`: higher effort levels reason for longer and cost more.
...
| model         | Node                                                                    | Credits               |
| :------------ | :---------------------------------------------------------------------- | :-------------------- |
| recraftv4_pro | Recraft V4 Text to Image                                                | 75.43 / image (× `n`) |
| recraftv4_pro | Recraft V4 Text to Vector                                               | 90.52 / image (× `n`) |
| recraftv4_1, recraftv4_1_utility | Recraft V4 Text to Image                              | 10.56 / image (× `n`) |
| recraftv4_1_flash | Recraft V4 Text to Image                                              | 2.11 / image (× `n`)  |
| recraftv4_1_pro, recraftv4_1_utility_pro | Recraft V4 Text to Image                              | 63.36 / image (× `n`) |
| recraftv4     | Recraft V4 Text to Image                                                | 12.07 / image (× `n`) |
| recraftv4     | Recraft V4 Text to Vector                                               | 24.14 / image (× `n`) |
| recraftv4_1_vector, recraftv4_1_utility_vector | Recraft V4 Text to Vector                        | 24.14 / image (× `n`) |
| recraftv4_1_pro_vector, recraftv4_1_utility_pro_vector | Recraft V4 Text to Vector                   | 90.52 / image (× `n`) |
| recraftv4_styles | Recraft V4 Text to Image                                               | 10.56 / image (× `n`) |
| recraftv4_styles_pro | Recraft V4 Text to Image                                            | 30.17 / image (× `n`) |
| recraftv4_styles_vector | Recraft V4 Text to Vector                                           | 15.09 / image (× `n`) |
| recraftv4_styles_pro_vector | Recraft V4 Text to Vector                                       | 36.21 / image (× `n`) |
| recraftv3     | Recraft Text to Image, Recraft Image to Image, Recraft Image Inpainting | 12.07 / image (× `n`) |
| recraftv3     | Recraft Text to Vector                                                  | 24.14 / image (× `n`) |
| —             | Recraft Create Style                                                    | 1.51 / run            |
| —             | Recraft V4 Create Style                                                 | 1.51 / run            |
| —             | Recraft Replace Background                                              | 12.07 / run           |
| —             | Recraft Vectorize Image, Recraft Remove Background                      | 3.02 / run            |
| —             | Recraft Crisp Upscale Image                                             | 1.21 / run            |
| —             | Recraft Creative Upscale Image                                          | 75.43 / run           |
...
**HY Image 3.5 Preview** bills one rate per generated image. `1K` and `2K` output, and `custom` sizes up to 4.19 megapixels, cost the base rate. `4K` output is rendered at 2K and then upscaled by the model, and costs more, as does a `custom` size above 4.19 megapixels.

| model | Node | Resolution | Input credits / image | Output credits / image |
| :---- | :--- | :--------- | :-------------------- | :--------------------- |
| hy-image-3.5-preview | Tencent HY Image: Text to Image | 1K, 2K, custom ≤ 4.19 MP | — | 7.24 |
| hy-image-3.5-preview | Tencent HY Image: Text to Image | 4K, custom > 4.19 MP | — | 9.66 |
| hy-image-3.5-preview | Tencent HY Image: Edit | 1K, 2K, custom ≤ 4.19 MP | — | 7.24 |
| hy-image-3.5-preview | Tencent HY Image: Edit | 4K, custom > 4.19 MP | — | 9.66 |
