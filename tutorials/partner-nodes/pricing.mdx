...
| xAI Image Generation                         | endpoint: v1/images/generations, model: grok-imagine-image-quality, resolution: 1k                      | 8.44 / run  | Image    |
| xAI Image Generation                         | endpoint: v1/images/generations, model: grok-imagine-image-quality, resolution: 2k                      | 10.55 / run | Image    |
| xAI Image Edit Output                        | endpoint: v1/images/edits, model: grok-imagine-image-beta, resolution: 1k                               | 6.96 / run  | Image    |
| xAI Image Edit Output                        | endpoint: v1/images/edits, model: grok-imagine-image-quality, resolution: 1k                            | 8.44 / run  | Image    |
| xAI Image Edit Output                        | endpoint: v1/images/edits, model: grok-imagine-image-quality, resolution: 2k                            | 10.55 / run | Image    |
