...
import PromoWindow from "/snippets/tutorials/partner-nodes/promo-window.mdx";
...
<PromoWindow>
**Limited-time offer**: Wan 3.0 is 30% off through September 30, 2026. Credits spent will be less than the displayed rate.
</PromoWindow>
