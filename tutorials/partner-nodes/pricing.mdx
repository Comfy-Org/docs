...
| BytePlus Video Generation Product (Per K tokens)     | model: dreamina-seedance-2-0, video_type: text-to-video (no video input: text or image)  | 1.477 / K tokens | Video    |
| BytePlus Video Generation Product (Per K tokens)     | model: dreamina-seedance-2-0, video_type: image-to-video (no video input: text or image) | 1.477 / K tokens | Video    |
| BytePlus Video Generation Product (Per K tokens)     | model: dreamina-seedance-2-0, video_type: video-to-video (with video input)              | 0.907 / K tokens | Video    |
| BytePlus Video Generation Product (Per K tokens)     | model: dreamina-seedance-2-0-fast, video_type: text-to-video (no video input: text or image)  | 1.182 / K tokens | Video    |
| BytePlus Video Generation Product (Per K tokens)     | model: dreamina-seedance-2-0-fast, video_type: image-to-video (no video input: text or image) | 1.182 / K tokens | Video    |
| BytePlus Video Generation Product (Per K tokens)     | model: dreamina-seedance-2-0-fast, video_type: video-to-video (with video input)              | 0.696 / K tokens | Video    |
