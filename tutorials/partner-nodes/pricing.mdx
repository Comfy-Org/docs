...
Seedream 5.0 Pro uses resolution-based billing: **1K** (≤2.36 MP, $0.045) and **2K** (>2.36 MP, $0.09). The first image in each request is free. Each additional image beyond the first (including both output and input/reference images) adds **$0.003** (**0.63 credits**).
