...
Output resolution is the only contributing factor to image API pricing for GAN models. Pricing shown for video is per second of video upscaled, assuming a maximum upscale resolution of 4K and a maximum frame interpolation of 60 FPS.

### Image

| Output MP (Megapixels) | Price $ |
| ---------------------- | ------- |
| 12                     | 0.08    |
| 24                     | 0.08    |
| 36                     | 0.16    |
...
| Operation                       | Wholesale Cost $ | Floor Price $ |
| ------------------------------- | ---------------- | ------------- |
