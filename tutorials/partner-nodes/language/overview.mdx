---
title: "LLMs in ComfyUI Workflows"
description: "Choose the right LLM for your use case: prompt writing, image understanding, chat, and agentic tasks in ComfyUI workflows"
sidebarTitle: "Overview"
---

ComfyUI Partner Nodes give you access to hosted large language models (LLMs) from providers such as Anthropic, Google, OpenAI, and OpenRouter. These nodes take text and images as input and return text, so you can use them for prompt writing, image captioning, and conversation alongside your generation nodes. This page helps you pick the right model for each task.
