...
description: "Generate speech, music, sound effects, and dialogue from a single prompt with Seed Audio 1.0 in ComfyUI, with voice cloning and character-driven audio."
