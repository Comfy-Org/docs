...
| Model | Strengths |
|-------|-----------|
| **Opus 5** | Anthropic's newest flagship, released July 24, 2026. Approaches the frontier intelligence of Claude Fable 5 at half the price, and is the new state-of-the-art on coding and knowledge work evaluations. |
