...
1. Install or update ComfyUI to the latest version
2. Locate the Bria Image Edit node in the node menu
3. Load one of the workflows above and start editing
