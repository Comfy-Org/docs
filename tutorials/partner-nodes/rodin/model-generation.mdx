...
<CardGroup cols={2}>
  ...
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_rodin_image_to_model&utm_source=docs">
    Open in Comfy Cloud
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_rodin_multiview_to_model&utm_source=docs">
    Open in Comfy Cloud
  </Card>
</CardGroup>
