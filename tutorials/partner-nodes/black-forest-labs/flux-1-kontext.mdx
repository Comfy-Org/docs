...
<Card title="Call it from code" icon="code" href="/development/comfy-router/models/black-forest-labs/flux-1-kontext/code">
  Call Kontext Pro or Max over HTTP through Comfy Router, with copy-paste Python, TypeScript, Swift and cURL snippets
</Card>
