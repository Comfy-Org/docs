...
<Tip>
  Calling this model from your own code? [Use Flux 1.1 Pro Ultra with Comfy Router](/development/comfy-router/models/black-forest-labs/flux-1-1-pro-ultra-image/code) has Python, TypeScript and cURL snippets, the request schema and the result shape.
</Tip>
