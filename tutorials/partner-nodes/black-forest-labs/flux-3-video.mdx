...
<Tip>
  Calling this model from your own code? [Use FLUX 3 Video with Comfy Router](/development/comfy-router/models/black-forest-labs/flux-3-video/code) has Python, TypeScript and cURL snippets, the request schema and the result shape.
</Tip>
