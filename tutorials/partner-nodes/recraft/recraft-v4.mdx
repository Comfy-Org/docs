...
<Card title="Recraft V4 Text to Image Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_recraft_v4_t2i.json">
  Download the workflow or find it in the Template Library by searching for "Recraft V4 Text to Image"
</Card>
...
<Card title="Recraft V4 Text to Vector Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_recraft_v4_text_to_vector.json">
  Download the workflow or find it in the Template Library by searching for "Recraft V4 Text to Vector"
</Card>
