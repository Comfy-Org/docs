...
<Tip>
  Calling this model from your own code? [Use Ideogram 4.0 with Comfy Router](/development/comfy-router/models/ideogram/ideogram-v4/code) has Python, TypeScript and cURL snippets, the request schema and the result shape.
</Tip>
...
<Card title="Call it from code" icon="code" href="/tutorials/partner-nodes/ideogram/ideogram-v4/code">
