...
- Currently supports 10-second video generations (longer durations coming soon)
- Audio references and scene extension are not yet supported in the API
- Character consistency has some limitations when changing scenes or panning movements
