...
### Text to Video (Omni Flash) {#api_google_gemini_omni_flash_t2v}

Generate video from a single text prompt with the preview-tier Gemini Omni Flash model. Describe the scene, the length, and the aspect ratio in one prompt, and the model renders the clip with a native audio track.

<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/api_google_gemini_omni_flash_t2v-1.webp" alt="Gemini Omni Flash Text to Video workflow preview" />
...
<CardGroup cols={2}>
  ...
  <Card title="Download Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_google_gemini_omni_flash_t2v.json">
    Download JSON or search "Gemini Omni" in Template Library
  </Card>
</CardGroup>

<Note>
The preview Omni Flash model is scheduled to retire on September 30, 2026. Use the Omni Flash 1.1 workflows below for the GA model.
</Note>
