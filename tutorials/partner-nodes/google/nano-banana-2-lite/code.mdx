...
API Reference for Nano Banana 2 Lite. Nano Banana 2 Lite (Gemini 3.1 Flash-Lite Image) is the fastest, most economical model in Google's Nano Banana image generation family.
