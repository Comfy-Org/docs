...
API Reference for Nano Banana Pro. Nano Banana Pro (Gemini 3 Pro Image) is the highest-fidelity model in Google's Nano Banana image generation family, strongest at complex scenes and legible text.
