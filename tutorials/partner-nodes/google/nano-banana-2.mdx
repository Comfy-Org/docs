...
The **Nano Banana 2 Lite** variant offers a budget-friendly alternative at $0.034/image, ideal for high-volume workflows with 1K resolution output.
...
|-------|----------|-------|
| **Nano Banana 2 Lite** | Budget-friendly option for high-volume 1K image generation | $0.034/image |
| **Nano Banana 2** | Most creators — fast enough to explore, smart enough to refine, polished enough to ship | From $0.0696/image |
| **Nano Banana Pro** | Maximum factual precision and high-stakes edge cases | From $0.15/image |
