...
<Card title="Call it from code" icon="code" href="/development/comfy-router/models/google/nano-banana-2/code">
...
<CardGroup cols={2}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_google_nano_banana_create_turnaround_sheet&utm_source=docs&utm_medium=referral&utm_campaign=nano-banana-2">
    Open in Comfy Cloud
  </Card>
  <Card title="Download Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_google_nano_banana_create_turnaround_sheet.json">
...
<Card title="Download Sample Input Image" icon="image" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/white_mech_front_ortho.png">
    Get the example input image for this workflow
  </Card>
