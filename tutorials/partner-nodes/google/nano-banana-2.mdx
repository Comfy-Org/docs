...
<Tip>
  Calling this model from your own code? [Use Nano Banana 2 with Comfy Router](/development/comfy-router/models/google/nano-banana-2/code) has Python, TypeScript and cURL snippets, the request schema and the result shape.
</Tip>
