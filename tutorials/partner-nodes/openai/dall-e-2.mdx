...
<Warning>
  **Deprecated**: OpenAI has discontinued the DALL·E 2 model. The **OpenAI DALL·E 2** node has been retired and removed from ComfyUI. Use the **GPT Image** node instead. This page is kept for reference only.
</Warning>
