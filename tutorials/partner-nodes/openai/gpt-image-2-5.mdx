...
description: "Generate and edit images in ComfyUI with the OpenAI GPT Image 2.5 Flare and Sunburst partner nodes: fast previews, high-fidelity edits, and workflow templates."
