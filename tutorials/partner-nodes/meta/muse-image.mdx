...
description: "Generate and edit images with Meta's Muse Image 1.0 in ComfyUI: agentic generation with web search and code execution, and editing with up to 10 references."
