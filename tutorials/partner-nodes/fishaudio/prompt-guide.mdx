...
description: "Write prompts for the Fish Audio partner nodes in ComfyUI: emotion tags, tone markers, audio effects, pauses, phoneme control, and multi-speaker dialogue."
