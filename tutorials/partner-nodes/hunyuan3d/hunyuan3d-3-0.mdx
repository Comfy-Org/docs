...
<CardGroup cols={2}>
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://links.comfy.org/4lelRlr">
    Run the workflow
  </Card>
...
<CardGroup cols={2}>
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://links.comfy.org/4lebCxy">
    Run the workflow
  </Card>
...
<CardGroup cols={2}>
  <Card title="Try on Comfy Cloud" icon="cloud" href="https://links.comfy.org/4rY6L67">
    Run the workflow
  </Card>
