...
<CardGroup cols={2}>
<Card title="Try on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_hunyuan3d_part&utm_source=docs&utm_medium=referral&utm_campaign=hunyuan3d-3-0">
    Run the workflow
  </Card>
...
<CardGroup cols={2}>
<Card title="Try on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_hunyuan3d_model2uv&utm_source=docs&utm_medium=referral&utm_campaign=hunyuan3d-3-0">
    Run the workflow
  </Card>
...
<CardGroup cols={2}>
<Card title="Try on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=api_hunyuan3d_smart_topology&utm_source=docs&utm_medium=referral&utm_campaign=hunyuan3d-3-0">
    Run the workflow
  </Card>
