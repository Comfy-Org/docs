...
description: "Use the MiniMax H3 API nodes in ComfyUI for text-to-video, first/last-frame, and reference-to-video cloud workflows with native stereo audio."
