...
<CardGroup cols={2}>
  <Card title="Image-to-Video Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_wan2_7_i2v.json">
    Wan2.7 Image-to-Video workflow.
  </Card>
  <Card title="Text-to-Video Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_wan2_7_t2v.json">
    Wan2.7 Text-to-Video workflow.
  </Card>
</CardGroup>

<CardGroup cols={2}>
  <Card title="Reference-to-Video Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_wan2_7_r2v.json">
    Wan2.7 Reference-to-Video workflow.
  </Card>
