...
Topaz Image Enhance is an industry-standard image upscaling and enhancement tool, now available in ComfyUI through the Topaz partner nodes. It offers two generative enhancement models: Wonder 3.5 and Bloom 2, each tuned for a different enhancement philosophy.

Wonder 3.5 is a generative enhancement model that adds fine detail, reduces noise, and sharpens text and structured graphics, with low, medium, and high enhancement strengths. Bloom 2 is a creative upscaling model that adds new detail, texture, and visual elements, with a creativity control from 1 to 9 for subtle refinement or bold reinterpretation. Both models preserve the input aspect ratio and support upscale factors from 1x to 6x.
