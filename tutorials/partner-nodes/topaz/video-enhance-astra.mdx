...
Topaz Astra Video Creative Upscale is available in ComfyUI through the Topaz partner nodes. It upscales and enhances video with the Starlight (Astra) Fast model, optionally combined with apo-8 frame interpolation to raise the frame rate. This workflow is the general-purpose Topaz video enhancement entry point, balancing speed and quality for typical footage. The workflow accepts MP4 input and produces enhanced MP4 output.
