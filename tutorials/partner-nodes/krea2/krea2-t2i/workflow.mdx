---
title: "Krea 2 Text to Image Workflows in ComfyUI"
description: "How to run the Krea 2 text-to-image and style reference workflows in ComfyUI, locally or on Comfy Cloud"
