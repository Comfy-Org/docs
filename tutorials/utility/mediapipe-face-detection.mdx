...
<Card title="Open Video Face Detection Blueprint" icon="book-open" href="https://github.com/Comfy-Org/ComfyUI/blob/master/blueprints/Video%20Face%20Detection%20(Mediapipe).json">
  Access the Video Face Detection blueprint from the ComfyUI repository
</Card>
