...
<CardGroup cols={2}>
  <Card title="Try in Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=utility-frame_interpolation-film.json&utm_source=docs&utm_medium=inhouse_social&utm_campaign=inhouse_feature_launches&utm_content=post&utm_niche=workflow_engineering&utm_creator=purz">
    Run on Comfy Cloud
  </Card>
  <Card title="Download JSON" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/utility-frame_interpolation-film.json">
