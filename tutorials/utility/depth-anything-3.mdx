...
description: "Run Depth Anything 3 in ComfyUI for monocular and multi-view depth estimation, camera pose recovery, and 3D reconstruction from images and video."
