...
SAM 3.1 is natively supported in ComfyUI (PR [#13408](https://github.com/Comfy-Org/ComfyUI/pull/13408)), and the model weights are available under the [Apache 2.0 License](https://github.com/facebookresearch/sam3/blob/main/LICENSE).
