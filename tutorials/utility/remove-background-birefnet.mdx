...
BiRefNet is natively supported in ComfyUI (PR [#12747](https://github.com/Comfy-Org/ComfyUI/pull/12747)). The model weights are available under a permissive license on Hugging Face.
