...
**Recommended**: Magnific Image Skin Enhancer, Nano Banana Pro Portrait, HitPaw Creative Portrait

<CardGroup cols={2}>
  <Card title="Magnific Skin Enhancer" icon="cloud" href="https://links.comfy.org/4cbvbE7">
    Portrait-specific skin enhancement
  </Card>
  <Card title="Nano Banana Pro Portrait" icon="cloud" href="https://links.comfy.org/3O9XtF7">
    Fast portrait upscaling
  </Card>
  <Card title="HitPaw Creative Portrait" icon="cloud" href="https://links.comfy.org/4kkoula">
    Creative portrait mode
  </Card>
</CardGroup>
...
**Recommended**: HitPaw, Magnific Precise, WaveSpeed SeedVR2, Nano Banana Pro Product
...
<CardGroup cols={2}>
  ...
  <Card title="SeedVR2 (Open Source)" icon="cloud" href="https://links.comfy.org/4ko2sOG">
    High fidelity conservative upscaling
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Topaz Landscape" icon="cloud" href="https://links.comfy.org/4r1utxS">
    Optimized for landscape and environment images
  </Card>
  <Card title="Topaz Creative" icon="cloud" href="https://links.comfy.org/4kjT12P">
    Creative upscaling with subject detection
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="SeedVR2 (Open Source)" icon="cloud" href="https://links.comfy.org/4ko2sOG">
    Conservative upscaling for AI images
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Traditional Non-AI Upscaling" icon="cloud" href="https://links.comfy.org/45Nu9um">
    Run the traditional non-AI upscaling workflow on Comfy Cloud
  </Card>
</CardGroup>
