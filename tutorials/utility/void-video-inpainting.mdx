...
VOID removes unwanted objects from video footage while maintaining natural motion, lighting, and scene coherence across frames. The example above shows the processed result after removing an object from the scene.
