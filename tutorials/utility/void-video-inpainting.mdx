...
- **SAM3 object prompt** — A short label for **what** to mask out. SAM3 uses semantic understanding to create a segmentation mask for the target object automatically. You do not need to draw or upload a mask manually.
