...
- **OCR and text extraction** — extract text rendered within images, useful for reading signs, labels, or UI elements in generated scenes.
...
<Card title="Qwen3.5 4B (bf16)" icon="download" href="https://huggingface.co/Comfy-Org/Qwen3.5/resolve/main/text_encoders/qwen3_5_4b_bf16.safetensors">
