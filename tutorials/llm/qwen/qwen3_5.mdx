...
description: "Run Qwen3.5 in ComfyUI, Alibaba Cloud's open multimodal LLM with image understanding and text generation for image captioning and reverse prompt engineering."
