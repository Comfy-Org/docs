...
description: "Run Stability AI's open-source Stable Audio 3 in ComfyUI for text-to-audio generation, with Qwen prompt expansion and category-aware reprompting."
