...
<img src="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/templates/3d_pixal3d_multi_views-1.webp" alt="Pixal3D Multi Views workflow preview" />

<CardGroup cols={2}>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.comfy.org/?template=3d_pixal3d_multi_views&utm_source=docs&utm_medium=referral&utm_campaign=pixal3d">
    Run this workflow instantly on Comfy Cloud
  </Card>
  <Card title="Download Workflow" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/3d_pixal3d_multi_views.json">
...
The workflow downloads these models. Place them in the corresponding `models/` subdirectories:

<CardGroup cols={2}>
  <Card title="Pixal3D Multiview UNet" icon="download" href="https://huggingface.co/Comfy-Org/Pixal3D/blob/main/diffusion_models/pixal3d_multiview_int8_convrot.safetensors">
