...
- The model checkpoint and the conditioning switch together

### RemoveBackground / ImageCropToMask
- Removes the background with BiRefNet and crops the subject to a centered canvas
...
- Save the result as a 3D file and preview it in 3D
