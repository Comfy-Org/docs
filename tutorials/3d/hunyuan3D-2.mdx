...
description: "This article will demonstrate 3D workflow examples using Hunyuan3D-2."
...
Hunyuan3D 2.0 is an open-source 3D asset generation model released by Tencent, capable of generating high-fidelity 3D models with high-resolution texture maps through text, images, or sketches. This system significantly lowers the barrier to 3D creation, providing efficient solutions for game development, industrial design, e-commerce, and other fields.
...
Currently, Hunyuan3D 2.0 has open-sourced multiple models covering the complete 3D generation process. Shape generation requires 6GB VRAM, and the complete process (shape + texture) requires a total of 12GB VRAM, with CPU offloading support.
...
| Model | Description | Date | Parameters | Huggingface |
|--------------------------|----------------------------------------------------|------------|-------|-----------------------------------------------------------------------------------------| 
| Hunyuan3D-DiT-v2-mv-Fast | Guidance Distillation Version, can halve DIT inference time | 2025-03-18 | 1.1B | [Download](https://huggingface.co/tencent/Hunyuan3D-2mv/tree/main/hunyuan3d-dit-v2-mv-fast) |
| Hunyuan3D-DiT-v2-mv | Multi-view Image to Shape Model, suitable for 3D creation requiring multiple angles to understand the scene | 2025-03-18 | 1.1B | [Download](https://huggingface.co/tencent/Hunyuan3D-2mv/tree/main/hunyuan3d-dit-v2-mv) |
...
Next, we will complete a 3D generation workflow in ComfyUI using Hunyuan3D-2 in this example.
...
## ComfyUI Hunyuan3D-2 Workflow Examples
