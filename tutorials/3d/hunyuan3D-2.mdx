...
<Note>
ComfyUI now natively supports Hunyuan3D-2mv. Please make sure you have upgraded to the latest version of [ComfyUI](https://github.com/comfyanonymous/ComfyUI) before starting.
</Note>

## ComfyUI Hunyuan3D-2mv Workflow Examples

### 1. Workflow
Please download the image below and drag it into ComfyUI to load the workflow. We will also use this image as the input.
...
![Multi-view Input](/images/tutorial/3d/hunyuan3d-2mv/hunyuan_3d_v2_mv_muti_input.jpg)
