...
|-------------|-------------|-----------|
| `positive` | Conditioning containing the text prompt with vision tokens from the reference images, plus reference latents when a VAE and reference images are provided | CONDITIONING |
| `negative` | Conditioning containing the negative text prompt, plus reference latents when a VAE and reference images are provided | CONDITIONING |
