...
description: "This node saves a 3D model to a file in the ComfyUI output directory, with advanced control over the output dimensions and camera/viewport settings."
