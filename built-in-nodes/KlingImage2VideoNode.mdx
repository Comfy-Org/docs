...
<Warning>
  **End of life (EOL)**: Legacy model options (`kling-v1-5`, `kling-v1-6`, `kling-v2-1`, `kling-v2-master`, and related variants) are scheduled for retirement on **September 15, 2026**. Use Kling 3.0 or 2.6 models instead. See [Kling 3.0 legacy retirement](/tutorials/partner-nodes/kling/kling-3-0#legacy-kling-models-eol).
</Warning>

The Kling Image to Video Node generates a video from a starting reference image using text prompts.
