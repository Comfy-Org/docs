...
| `model` | Model to use for generation. Selecting a model reveals additional settings for that model. (default: first option, `"uni-1"`) | DYNAMIC_COMBO | Yes | `"uni-1"`<br />`"uni-1-max"` |
