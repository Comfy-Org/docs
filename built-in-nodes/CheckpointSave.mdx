...
- Currently fully supported: SDXL, SD3, SVD and other mainstream architectures, see [source code](https://github.com/Comfy-Org/ComfyUI/blob/master/comfy_extras/nodes_model_merging.py#L176-L189)
- Basic support: Other architectures can be saved but without standardized metadata information

## Related Links

Related source code: [nodes_model_merging.py#L227](https://github.com/Comfy-Org/ComfyUI/blob/master/comfy_extras/nodes_model_merging.py#L227)
