...
| `auto_resize_images` | When enabled (default: True), input images are automatically resized before VAE encoding so their total pixel area is close to 1024x1024, with dimensions rounded to multiples of 8. | BOOLEAN | Yes | True<br />False |
