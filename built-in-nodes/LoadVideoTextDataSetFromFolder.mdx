...
description: "This node loads video files and their matching text captions from a folder inside the ComfyUI input directory, and returns them as two lists: videos and captions."
...
|-----------|-------------|-----------|----------|-------|
| `folder` | The folder containing video files and .txt captions. | COMBO | Yes | Dynamically lists all subfolders inside the ComfyUI input directory |
