...
description: "This node prepares an image-to-video generation setup for AR (Auto-Regressive) video models that use Causal Forcing or Self-Forcing."
...
| `length` | The total number of frames of the generated video (default: 81). | INT | Yes | 1 to 1024 (step: 4) |
