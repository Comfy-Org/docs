...
description: "This node automatically detects models located in the ComfyUI/models/clipvision folder, as well as any additional model paths configured in the extramodelpaths.yaml file."
