...
description: "The Split Image into List of Tiles node divides a single input image into a series of smaller, overlapping rectangular sections called tiles."
