...
<Warning>
  **End of life (EOL)**: This node reached end of life on **July 30, 2026** when Runway retired Gen-3 Alpha Turbo. Use [Runway Gen4 Turbo](/built-in-nodes/RunwayImageToVideoNodeGen4) or the [Gen4 Turbo workflow](/tutorials/partner-nodes/runway/video-generation) instead.
</Warning>
