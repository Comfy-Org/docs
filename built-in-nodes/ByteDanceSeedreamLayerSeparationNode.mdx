...
description: "ByteDance Seedream 5.0 Pro Layer Separation decomposes an image into a background plate plus up to 16 repositionable transparent layers, each with stacking order, bounding box, nam"
