...
description: "This node changes the aspect ratio of an existing video using Luma Ray 3.2, which fills the newly exposed canvas areas with generated content."
