...
description: "This node merges two models by blending their internal components at a fine-grained level, allowing you to control how much of each model's specific parts influence the final resul"
