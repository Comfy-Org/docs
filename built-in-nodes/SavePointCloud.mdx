...
| `model_3d_info` | Additional model information for the 3D viewer (advanced) | LOAD3D_MODEL_INFO | No | - |
| `camera_info` | Camera information for the 3D viewer (advanced) | LOAD3D_CAMERA | No | - |
