...
|-----------|-------------|-----------|----------|-------|
| `model` | Model to use (default: "qwen-image-3.0-pro"). This composite selector also provides the prompt, negative prompt, image width, and image height. | DYNAMIC_COMBO | Yes | "qwen-image-3.0-pro"<br />"qwen-image-3.0" |
