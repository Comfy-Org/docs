...
description: "MiniMax H3 Reference to Video creates the text conditioning and the empty video latent needed for MiniMax H3 reference-to-video generation."
