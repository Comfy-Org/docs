...
description: "Tripo P1 text-to-3D."
...
|-----------|-------------|-----------|----------|-------|
| `output_mode` | Controls whether the generated model contains only geometry or also color/PBR textures. "Geometry only" returns an untextured mesh. "Textured" adds color/PBR maps and reveals the texture options below. | DYNAMIC_COMBO | Yes | `"Geometry only"`<br />`"Textured"` |
