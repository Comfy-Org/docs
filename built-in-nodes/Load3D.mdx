...
description: "The Load3D node is used to load and process 3D model files from the `ComfyUI/input/3d` folder."
sidebarTitle: "Load3D"
icon: "circle"
---
...
[Settings Menu](/interface/settings/3d)
...
All corresponding log outputs
![View Operation Demo](/images/comfy_core/load3d/load3d_outputs.webp)
...
<video controls width="640" height="360">
  <source src="/images/comfy_core/load3d/view_operations.mp4" type="video/mp4">
...
![Menu](/images/comfy_core/menu.webp)
...
![scene menu](/images/comfy_core/load3d/menu_scene.webp)
...
![Menu_Scene](/images/comfy_core/load3d/menu_model.webp)
...
![menu_modelmenu_camera](/images/comfy_core/load3d/menu_modelmenu_camera.webp)
...
![menu_export](/images/comfy_core/load3d/menu_export.webp)
...
<video controls width="640" height="360">
  <source src="/images/comfy_core/load3d/recording.mp4" type="video/mp4">
  Your browser does not support video playback.
</video>
