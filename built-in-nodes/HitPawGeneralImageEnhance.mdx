...
description: "This node enhances low-resolution images by upscaling them to super-resolution while removing artifacts and noise."
sidebarTitle: "HitPawGeneralImageEnhance"
icon: "circle"
mode: wide
---

This node enhances low-resolution images by upscaling them to super-resolution while removing artifacts and noise. It sends the image to an external API for processing, and it can automatically adjust the input size to stay within the allowed output limit. The maximum allowed output size is 32 megapixels.
