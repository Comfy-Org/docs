...
description: "This node encodes an input image using DINOv3 and the Flux2 VAE to create positive and negative conditioning data for the TripoSplat model."
