...
description: "A node that generates high-quality images using Stability AI's Stable Diffusion 3.5 model"
...
<Card title="Stability AI Stable Diffusion 3.5 Image Workflow Example" icon="book" href="/tutorials/api-nodes/stability-ai/stability-ai-stable-diffusion-3-5-image">
