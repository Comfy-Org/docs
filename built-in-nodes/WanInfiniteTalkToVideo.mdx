...
| `motion_frame_count` | Number of previous frames to use as motion context. (default: 9; advanced parameter) | INT | Yes | 1 - 33 (step 1) |
| `audio_scale` | A scaling factor applied to the audio conditioning. (default: 1.0) | FLOAT | Yes | -10.0 - 10.0 (step 0.01) |
