...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `images` | Growable slot: connect 1 to N reference images to edit. The slots use the template names `image_1`, `image_2`, `image_3`; the maximum number of slots depends on the selected model. | IMAGE | Yes | 1 image for `grok-imagine-image-pro`<br />1 to 3 images for `grok-imagine-image-2.0`, `grok-imagine-image-quality`, and `grok-imagine-image` |
