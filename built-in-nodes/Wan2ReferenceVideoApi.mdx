...
* You must provide at least one reference video or reference image in the `reference_videos` or `reference_images` inputs. Otherwise the node raises an error.
