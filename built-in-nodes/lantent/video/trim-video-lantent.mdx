...
![ComfyUI TrimVideoLatent 节点](/images/built-in-nodes/lantent/video/trim-video-latent.jpg)
...
<Card title="Wan2.1 VACE 视频生成工作流示例" icon="book" href="/tutorials/video/wan/vace">
