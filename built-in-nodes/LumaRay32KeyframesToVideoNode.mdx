...
description: "This node generates a video that interpolates through a sequence of guide images, each anchored to a specific position on the timeline, using Luma Ray 3.2."
