...
| `cfg` | The classifier-free guidance scale that controls how strongly the conditioning influences the generation (default: 8.0) | FLOAT | Yes | 0.0 to 100.0 (step: 0.1) |
