...
description: "The Wan 2.7 Video Continuation node generates a new video segment that continues from the end of an input video clip."
...
|-----------|-------------|-----------|----------|-------|
| `model` | The video generation model to use. The selected option determines which additional settings appear below. | DYNAMIC_COMBO | Yes | `"wan2.7-i2v"` |
...
| `resolution` | The output resolution for the generated video. | COMBO | Yes | `"720P"`<br />`"1080P"` |
