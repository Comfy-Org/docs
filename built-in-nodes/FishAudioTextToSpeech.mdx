...
|-----------|-------------|-----------|----------|-------|
| `text` | The text to convert to speech. With two or more voices connected, mark speaker changes with @Voice1, @Voice2, etc. (default: empty) | STRING | Yes | Any non-empty text |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `voices` | Growable slot: connect 0 to 5 voice items (`voice_1`, `voice_2`, ...). Voices for synthesis. Leave empty for the default voice. With two or more voices, mark speaker changes in the text with @Voice1, @Voice2, etc. | FISHAUDIO_VOICE | No | 0 to 5 voices |
