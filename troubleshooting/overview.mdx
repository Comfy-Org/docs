...
**Symptoms:** You want to shut down the ComfyUI server or close the application.

**Solutions:**

**For ComfyUI Portable or Manual Install (command-line):**
- Press **Ctrl+C** in the terminal window where ComfyUI is running
- Alternatively, simply close the terminal window
...
**For Comfy Cloud:**
- Cloud sessions stop automatically when you close the browser tab
- You can also stop them from your [Comfy Cloud dashboard](https://comfy.org/cloud)
