...
If you see this error with an Intel GPU, this is **expected behavior** — Intel GPUs use the XPU backend, not CUDA. Do not follow the NVIDIA CUDA reinstallation steps above; they will not fix this for Intel hardware.
