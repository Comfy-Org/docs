...
* Implemented use_default_template functionality for LTX models in text generation nodes

**Partner Node Updates**
* Added new "arrow-1.1" and "arrow-1.1-max" SVG models for enhanced vector graphics capabilities
...
**Workflow Templates**
* Updated workflow templates to version 0.9.57 with latest improvements
