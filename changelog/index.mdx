...
* [**Recraft V4.1 Flash**](https://github.com/Comfy-Org/ComfyUI/pull/16501): A faster, lower-cost option on the Recraft V4 text-to-image node
* [**Claude Opus 5.5**](https://github.com/Comfy-Org/ComfyUI/pull/16479): Added to the Claude node
* [**Quiver Arrow 2**](https://github.com/Comfy-Org/ComfyUI/pull/16478): Arrow 2 models with reasoning effort control on the SVG nodes

**New Node Updates**
* [**Generate Text**](https://github.com/Comfy-Org/ComfyUI/pull/16442): `system_prompt` replaces the chat template system turn, plus a thinking output
