...
**Workflow Security & Permission Management**
- **Workflow Permission Fix**: Resolved critical workflow permission issues that were affecting workflow sharing and collaboration capabilities

**Documentation & Resource Updates**
- **Updated Portable Links**: Added new portable installation links to the readme for easier setup and distribution across different platforms

**API Node Enhancements**
- **Rodin3D-Gen2 Parameter Fix**: Fixed missing "task_uuid" parameter in Rodin3D-Gen2 nodes, ensuring proper 3D generation tracking and completion
- **Seedance Pro Model Support**: Enhanced FirstLastFrame node to enable compatibility with Seedance Pro models, expanding frame interpolation and animation workflow options
</Update>
