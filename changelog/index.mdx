...
* [**GPT-6 Astra**](https://github.com/Comfy-Org/ComfyUI/pull/16125): Added the `gpt-6-astra` model to the OpenAI Chat node with support for reasoning effort levels

**Partner Node Removals**
* [**Retired models**](https://github.com/Comfy-Org/ComfyUI/pull/16121): Removed nodes for models that vendors have shut down: OpenAI DALL·E 2 and DALL·E 3, LTX-2 (Fast and Pro), Seedream 3.0, Seedance 1.0 Lite, the Kling Video Extend node, and the ByteDance Reference Images to Video node
