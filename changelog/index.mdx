...
- **New Seedream Node**: Added ByteDanceSeedream (4.0) node for enhanced AI generation capabilities. This expands the available generation models within ComfyUI workflows, providing users with additional options for creative content generation.

**Template System Updates**
- **Template Version 0.1.78**: Updated core template system to version 0.1.78, improving workflow stability and ensuring compatibility with the latest node implementations.
