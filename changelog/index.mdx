...
* Bria Transparent Video Background: enabled alpha channel in SaveWEBM
* Seedance 2.0: fixed 1080p first/last-frame stretch jump
...
**Partner Node Updates**
* Added Rodin2.5 nodes with quality mesh options
...
**Partner Node Updates**
* Improved video reference uploading for SeeDance 2
* Added Krea2 Image nodes
* Updated workflow templates to v0.9.85
...
* Added Kling V3 price badge fixes

**Bug Fixes**
* Fixed ImageBlend with alpha channel
...
**Bug Fixes**
* Fixed Stable_Zero123 cc_projection weight assignment on Windows
...
**Stability Fixes**
* Fixed pinned memory accounting for Windows
* Fixed fp8 scaled checkpoints not working
...
**Stability**
* Reverted fp8 checkpoint fix, additional stability testing
