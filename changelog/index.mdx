...
**Bug Fixes & Model Compatibility**
- Fixed issue with Ernie image model compatibility and processing
- Resolved text generation compatibility with Ministral model for improved language generation workflows
- Fixed Ernie model compatibility on devices that don't support FP64 precision

**Node Enhancements**
- Added string output capability to Preview Text node, enabling better text workflow integration and output handling

**Partner Nodes & Template Updates**
- Added Sonilo Audio nodes for expanded audio processing capabilities
- Updated workflow templates to version 0.9.54 with improved functionality
- Bumped frontend package to version 1.42.11 for enhanced stability
