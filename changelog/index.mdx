...
**API Enhancements**
- Added GPT-Image-1.5 API nodes for enhanced image processing capabilities in workflows

**Bug Fixes & Stability**
- Fixed regression affecting V3 nodes processing that was impacting workflow execution
- Corrected SA-Solver to properly return the final predictor step result, improving solver accuracy
- Enhanced torch import handling for prestartup nodes to prevent initialization conflicts
