...
This is a maintenance release with minor updates and bug fixes. For complete technical details, see the [full changelog](https://github.com/Comfy-Org/ComfyUI/compare/v0.18.1...v0.18.2) on GitHub.
