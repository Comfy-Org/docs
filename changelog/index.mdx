...
* **Stable Audio 3:** Support for the latest Stable Audio 3 model with improved audio generation capabilities
...
**Partner Nodes Updates**
* **ByteDance Seed LLM:** New node added for enhanced language model capabilities
* **Opus 4.7:** Fixed deprecated temperature parameter for better model compatibility

**Node Functionality Enhancements**
